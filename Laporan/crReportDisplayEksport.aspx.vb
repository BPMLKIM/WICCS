...
Partial Class _Default
    ...
    Private Sub ConfigureCrystalReports()
        ...
        If Request("id") = 21 Then '--> Penyata Bayaran Caj Perkhidmatan Ikan Eksport (ICCS 01E)
            selectFormula = "{PENGISYTIHARAN_E.Status} = 'A' and ({PENDAFTARAN_PINTU.Tarikh_Masa_Masuk} >= date('" & aDate & "') and {PENDAFTARAN_PINTU.Tarikh_Masa_Masuk} <= date('" & bDate & "'))"
        ElseIf Request("id") = 27 Or Request("id") = 30 Then
