<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SalinanSKPI_MsSheet.aspx.vb" Inherits="Laporan_Papar_Laporan" %>
                ...
                <tr>
                    ...
                    <td style="width: 29px">
                        ...
                        <asp:RadioButtonList ID="pilihan" runat="server">
                            <asp:ListItem Selected="True">SKPIE</asp:ListItem>
