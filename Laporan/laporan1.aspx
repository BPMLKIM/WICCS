<%@ Page Language="VB" AutoEventWireup="false" CodeFile="laporan1.aspx.vb" Inherits="laporan1" %>
...
for (i=0;i<document.Form1.rblPilihan.length;i++) {
   ...
   {
     myurl="crlaporan1.aspx?id=" + user_input  + "&RptH=&Tarikh1="+ document.all.txtTarikh1.value +"&Tarikh2="+ document.all.txtTarikh1.value +"&type=H";
   }
   else if (user_input =="Bulanan")
   {
     myurl="crlaporan1.aspx?id=" + user_input  + "&RptB=&Bulan1="+ document.all.txtBulan1.value +"&Bulan2="+ document.all.txtBulan2.value +"&type=B";   
   }
   else if (user_input =="Tahunan")
   {
     myurl="crlaporan1.aspx?id=" + user_input  + "&RptT=&Tahun1="+ document.all.txtTahun1.value +"&Tahun2="+ document.all.txtTahun1.value +"&type=T";
   }
    ...
    <table width="841" border="0" cellpadding="1" cellspacing="1">
      <tr>
        <td colspan="3" style="height: 15px">
            ...
            <br />
            Log Pergerakan Kenderaan Keluar Masuk Kompleks Report</td>
                </tr>
                <tr>
                    <td width="36">&nbsp;</td>
            ...
            font-family: MS Shell Dlg,verdana,??; background-color: #f1f1f1" Text="Papar Laporan" OnClientClick="viewReport()" UseSubmitBehavior="False" /><input id="Button2" onclick="location.href='Laporankad.aspx' " Style="border-right: #333333 1px ridge; padding-right: 1px;
            border-top: #ffffff 1px ridge; padding-left: 1px; font-size: 10px; padding-bottom: 1px;
            border-left: #ffffff 1px ridge; color: #000000; padding-top: 1px; border-bottom: #000000 1px ridge;
