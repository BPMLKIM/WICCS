<%@ Page Language="VB" AutoEventWireup="false" CodeFile="daftar.aspx.vb" Inherits="laporan1" %>
...
for (i=0;i<document.Form1.rblPilihan.length;i++) {
   ...
   {
     myurl="crdaftar.aspx?id=" + user_input  + "&RptH=&Tarikh1="+ document.all.txtTarikh1.value +"&Tarikh2="+ document.all.txtTarikh1.value +"&type=H";
   }
   else if (user_input =="Bulanan")
   {
     myurl="crdaftar.aspx?id=" + user_input  + "&RptB=&Bulan1="+ document.all.txtBulan1.value +"&Bulan2="+ document.all.txtBulan1.value +"&type=B";   
   }
   else if (user_input =="Tahunan")
   {
     myurl="crdaftar.aspx?id=" + user_input  + "&RptT=&Tahun1="+ document.all.txtTahun1.value +"&Tahun2="+ document.all.txtTahun1.value +"&type=T";
   }
    ...
    <table width="841" border="0" cellpadding="1" cellspacing="1">
      <tr>
        <td colspan="3" style="height: 15px">
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="938">
                <tr>
                    <td style="width: 18%; height: 12px">
                        Laporan Daftar Barangan Bukan Ikan</td>
            ...
            font-family: MS Shell Dlg,verdana,??; background-color: #f1f1f1" Text="Papar Laporan" OnClientClick="viewReport()" UseSubmitBehavior="False" />
