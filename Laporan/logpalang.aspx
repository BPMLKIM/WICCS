<%@ Page Language="VB" AutoEventWireup="false" CodeFile="logpalang.aspx.vb" Inherits="laporan1" %>
...
for (i=0;i<document.Form1.rblPilihan.length;i++) {
   ...
   {
     myurl="crlog.aspx?id=" + user_input  + "&RptH=&Tarikh1="+ document.all.txtTarikh1.value +"&Tarikh2="+ document.all.txtTarikh1.value +"&type=H";
   }
   else if (user_input =="Bulanan")
   {
     myurl="crlog.aspx?id=" + user_input  + "&RptB=&Bulan1="+ document.all.txtBulan1.value +"&Bulan2="+ document.all.txtBulan2.value +"&type=B";   
   }
   else if (user_input =="Tahunan")
   {
     myurl="crlog.aspx?id=" + user_input  + "&RptT=&Tahun1="+ document.all.txtTahun1.value +"&Tahun2="+ document.all.txtTahun1.value +"&type=T";
   }
