...
Partial Class _Default
    ...
    Private Sub ConfigureCrystalReports()
        ...
        If Request("type") = "H" Then
            ...
            selectFormula = "{V_KAD.Status_Kad}='A' and {KAD_TRANSACTION_LOG.Kadbatal_id}=0 and {kad_transaction_log.transaction_date}= date(" & aDate & ")"
            ReportName = "Log_pergerakan_kenderaan_keluar_masuk_komplex_report.rpt"
        ElseIf Request("type") = "B" Then
            ...
            selectFormula = "{V_KAD.Status_Kad}='A' and {KAD_TRANSACTION_LOG.Kadbatal_id}=0 and {kad_transaction_log.transaction_date}>= date(" & aDate & ") and {kad_transaction_log.transaction_date}<= date(" & bDate & ")"
            ReportName = "Log_pergerakan_kenderaan_keluar_masuk_komplex_report(bulanan).rpt"
        ElseIf Request("type") = "T" Then
            ...
            'response.end()
            ReportName = "Log_pergerakan_kenderaan_keluar_masuk_komplex_report(tahun).rpt"
        End If
