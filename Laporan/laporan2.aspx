<%@ Page Language="VB" AutoEventWireup="false" CodeFile="laporan2.aspx.vb" Inherits="laporan1" %>
...
for (i=0;i<document.Form1.rblPilihan.length;i++) {
   ...
   {
     myurl="crlaporan2.aspx?id=" + user_input  + "&RptH=&Tarikh1="+ document.all.txtTarikh1.value +"&Tarikh2="+ document.all.txtTarikh1.value +"&type=H";
   }
   else if (user_input =="Bulanan")
   {
     myurl="crlaporan2.aspx?id=" + user_input  + "&RptH=&bulan1="+ document.all.txtBulan1.value +"&bulan2="+ document.all.txtBulan2.value +"&type=B";   
   }
   else if (user_input =="Tahunan")
   {
     myurl="crlaporan2.aspx?id=" + user_input  + "&RptH=&Tahun1="+ document.all.txtTahun1.value +"&Tahun2="+ document.all.txtTahun1.value +"&type=T";
   }
    ...
    <table width="841" border="0" cellpadding="1" cellspacing="1">
      <tr>
        <td colspan="3" style="height: 15px">
            ...
            <br />
            Log Transaksi Smart Card Report</td>
                </tr>
                <tr>
                    <td width="36">&nbsp;</td>
