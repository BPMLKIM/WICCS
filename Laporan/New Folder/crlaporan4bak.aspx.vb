...
Partial Class _Default
    ...
    Private Sub ConfigureCrystalReports()
        ...
        If Request("type") = "H" Then
            ...
            selectFormula = "{kad_transaction_log.transaction_desc}<>'caj pintu masuk' and {kad_transaction_log.transaction_desc}<>'isu kad baru' and {kad_transaction_log.transaction_desc}<>'reload prepaid' and {kad_transaction_log.transaction_desc}<>'pembelian kad baru' and{kad_transaction_log.transaction_date}= date(" & aDate & ")"
        ...
        ElseIf Request("type") = "B" Then
            ...
            selectFormula = "{kad_transaction_log.transaction_desc}<>'caj pintu masuk' and {kad_transaction_log.transaction_desc}<>'isu kad baru' and {kad_transaction_log.transaction_desc}<>'reload prepaid' and {kad_transaction_log.transaction_desc}<>'pembelian kad baru' and{kad_transaction_log.transaction_date}>= date(" & aDate & ") and {kad_transaction_log.transaction_date}<= date(" & bDate & ")"
        ...
        Dim reportPath As String = Server.MapPath("laporan kad prepaid report/rpt/senarai_smart_card_report.rpt")
