...
Partial Class _Default
    ...
    Private Sub ConfigureCrystalReports()
        ...
        If Request("type") = "H" Then
            ...
            selectFormula = "{kad_transaction_log.transaction_desc}<>'Isu Kad Baru' and {kad_transaction_log.transaction_desc}<>'Ganti Kad Baru' and {kad_transaction_log.transaction_date}>= date(" & aDate & ") and {kad_transaction_log.transaction_date}<= date(" & bDate & ")"
