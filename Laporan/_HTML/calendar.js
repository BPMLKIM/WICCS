...
tableBGColor    ="black";
cellColor       ="#ffffcc";
headingCellColor="#FFCC00";
headingTextColor="#000099";
dateColor       ="#996600";
focusColor      ="#ff0000";
hoverColor      ="darkred";
fontStyle       ="8pt arial, helvetica, bold";
...
//IF MALAY		
todayStr = "Hari_Ini";
weekdayList  = new Array('Ahad', 'Isnin', 'Selasa', 'Rabu', 'Khamis', 'Jumaat', 'Sabtu');
weekdayArray = new Array('Ah','Is','Se','Ra','Kh','Ju','Sa');
monthArray = new Array('Januari', 'Februari', 'Mac', 'April', 'Mei', 'Jun',
