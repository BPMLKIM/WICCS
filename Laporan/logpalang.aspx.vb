...
Partial Class laporan1
    ...
    Protected Sub redisplay_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles redisplay.Click
        ...
        If rblPilihan.SelectedIndex = 0 Then
            Response.Write("<script language=javascript>window.open('crlog.aspx?id=" & Request("rblPilihan") & "&RptH=" & Request("RptH") & "&Tarikh1=" & txtTarikh1.Text & "&Tarikh2=" & txtTarikh1.Text & "&type=H');</script>")

        ElseIf rblPilihan.SelectedIndex = 1 Then
            Response.Write("<script language=javascript>window.open('crlog.aspx?id=" & Request("rblPilihan") & "&RptB=" & Request("RptB") & "&Bulan1=" & txtBulan1.Text & "&Bulan2=" & txtBulan2.Text & "&type=B');</script>")

        ElseIf rblPilihan.SelectedIndex = 2 Then
            Response.Write("<script language=javascript>window.open('crlog.aspx?id=" & Request("rblPilihan") & "&RptT=" & Request("RptT") & "&Tahun1=" & txtTahun1.Text & "&Tahun2=" & txtTahun1.Text & "&type=T');</script>")
