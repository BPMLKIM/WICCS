    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Page.IsPostBack Then
            ...
            If Not SQLReader.HasRows Then
                ...
                Response.Write("<script languange=javascript>alert('Nombor barcode tidak wujud');self.location.href='verifikasi_periksa.aspx?urusan=" & Trim(Request("urusan")) & "';</script>")
                Response.End()
            ...
            Else
                ...
                Dim strSQL2 As String = " SELECT status from " & Trim(strTable1) & " WHERE No_Barcode = '" & Trim(Barcode.Text) & "'"
                ...
                If Not SQLReader2.HasRows Then
                    ...
                    Response.Write("<script languange=javascript>alert('Nombor barcode tersebut adalah bukan untuk pemeriksaan " & LCase(titleIkan.Text) & "');self.location.href='verifikasi_periksa.aspx?urusan=" & Trim(Request("urusan")) & "';</script>")
                    Response.End()
                ...
                Else
                    ...
                    While (SQLReader2.Read())
                        ...
                        If Trim(SQLReader2("status")) = "B" Then

                            SQLReader2.Close()
                            SQLReader2 = Nothing

                            Response.Write("<script languange=javascript>alert('Terdapat SKPI yang mempunyai status Tidak Sah. Sila isytihar semula.');self.location.href='verifikasi_periksa.aspx?urusan=" & Trim(Request("urusan")) & "';</script>")
                            Response.End()
                ...
                If periksa = True Then
                    ...
                    If Not SQLReader1.HasRows Then
                        ...
                        Response.Redirect("pemeriksaanNew.aspx?urusan=" & Trim(Request("urusan")) & "&strBarcode=" & Trim(Barcode.Text) & "")
                    ...
                    Else
                        ...
                        Response.Write("<script languange=javascript>alert('Nombor barcode tersebut telah membuat pemeriksaan');self.location.href='verifikasi_periksa.aspx?urusan=" & Trim(Request("urusan")) & "';</script>")
                        Response.End()
