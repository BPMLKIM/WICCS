...
#End Region
    ...
    Private Sub ConfigureCrystalReports()
        ...
        Dim rstemp As String = "select bil_siri,bil_siri_resit from no_siri_resit_nekad_eksport where no_barcode = '" & Trim(Request("barcode")) & "' and no_invois='0'"
       ...
       ' Response.Write("<br>StartEndReport 2 =" & Now())
        ...
        Dim reportPath As String = Server.MapPath("cetakrpt/iResitG2b1E.rpt")
        ...
        If Request("printer_name") <> "" Then
            ...
            Dim reportPath1 As String = Server.MapPath("cetakrpt/iResitG2b1SalinanE.rpt")
        ...
        selectFormula = "{ITEM_CAJ_EKSPORT.Kod_Service_Caj}<> 'Caj Pengisytiharan (Borang SKPI) - PNK SRI MUARA' AND {ITEM_CAJ_EKSPORT.Dicaj_Oleh} = 'PNK SRI MUARA' and {no_siri_resit_nekad_eksport.bil_siri_resit} = '" & serial_no & "'"
