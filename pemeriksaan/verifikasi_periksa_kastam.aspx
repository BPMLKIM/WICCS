<%@ Page Language="VB" AutoEventWireup="false" CodeFile="verifikasi_periksa_kastam.aspx.vb" Inherits="verifikasi_barcode" %>
  ...
  <div align=left> <br />
      ...
      <tr bgcolor="#33CC66"> 
        <td colspan="2" style="text-align: center"> <strong><span style="color: #ffffff"><font color="#000000">VERIFIKASI 
          BARCODE PEMERIKSAAN 
          <asp:Label ID="titleIkan" runat="server"></asp:Label>
          BARANGAN BUKAN IKAN KASTAM</font></span></strong></td>
            </tr>
            <tr>
