...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Button6.Attributes.Add("OnClick", "javascript: self.location.href='verifikasi_periksa_kastam.aspx?urusan=" & Trim(Request("urusan")) & "'")
        Button4.Attributes.Add("OnClick", "javascript: self.location.href='verifikasi_periksa_kastam.aspx?urusan=" & Trim(Request("urusan")) & "'")
        ...
        If (sender.Id) = "Simpan" Then
            ...
            If (opClass.ErrorSignal = False) Then
                ...
                If Not SQLReader.HasRows Then
                    ...
                    Response.Write("<script languange=javascript>alert('Sistem-Q tidak dapat mengemaskini status pemeriksaan kerana maklumat belum wujud.');self.location.href='verifikasi_periksa_kastam.aspx?urusan=" & Trim(urusan.Value) & "';</script>")
                    Response.End()
            ...
            Response.Write("<script languange=javascript>alert('Maklumat Untuk Pemeriksaan Telah Selamat Disimpan.');self.location.href='verifikasi_periksa_kastam.aspx?urusan=" & Trim(urusan.Value) & "';</script>")
            Response.End()
