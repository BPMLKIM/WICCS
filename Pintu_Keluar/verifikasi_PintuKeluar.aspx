<%@ Page Language="VB" AutoEventWireup="false" CodeFile="verifikasi_PintuKeluar.aspx.vb" Inherits="verifikasi_Keluar" %>
...
<body>
    ...
    <table style="width: 80%;" align="center">
      ...
      <tr bgcolor="#003333"> 
        <td colspan="2" style="text-align: center; border-right: black 1px solid; border-top: black 1px solid; border-left: black 1px solid; border-bottom: black 1px solid; height: 15px; background-color: #003333;"> 
          <strong><span style="color: #ffffff; height: 18px;">VERIFIKASI BARCODE 
          PINTU KELUAR</span></strong></td>
            </tr>
            <tr>
