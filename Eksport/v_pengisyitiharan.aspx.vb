    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            sqlText = "SELECT distinct PENGISYTIHARAN_E.Kod_Pengeksport + '|' + PENGEKSPORT.No_Lesen + '|' + CASE WHEN DAY(LESEN.Tarikh_Tamat) " & _
                             ...
                             " + '`' + PENGIMPORT_THAILAND.Nama_Pengimport + '`' + PENGISYTIHARAN_E.Destinasi_Negara_EU + '`' + PENGISYTIHARAN_E.No_Sijil + '`' + PENGISYTIHARAN_E.No_Kontena + '`' + NEGARA.Nama_Negara + '~' AS data, PENGISYTIHARAN_E.STATUS, PENGISYTIHARAN_E.KOD_URUSAN, JENIS_URUSAN.NAMA_URUSAN, PENGISYTIHARAN_E.ONLINESEND_BY " & _
