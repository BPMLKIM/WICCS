<%@ Page Language="VB" AutoEventWireup="false" CodeFile="v_pengisyitiharan.aspx.vb" Inherits="View_Export_pengisyitiharan" %>
    ...
    else
    {
        ...
        if (stat=="false")
        {
           ...
           //document.all.TextBox1.value = document.all.TextBox1.value + dataItem1.options.value + '`' +dataItem1.options[dataItem1.selectedIndex].text + '`' + dataItem2.options.value +'`'+ dataItem3.options.value + '`' + dataItem4.options.value + '`' +dataItem4.options[dataItem4.selectedIndex].text +'~';
	        ...
	        oCell.innerHTML =arrImporterInfoRow[6];
	         oCell = newRow.insertCell();
	        oCell.innerHTML =arrImporterInfoRow[7];
	        oCell = newRow.insertCell();
...
function addRow(myString)
{
	...
	oCell.innerHTML = document.all.Kod_BKH.value;			
	oCell = newRow.insertCell();
        ...
        <tr>
         ...
         <table id="tblGridImporter" border="0" style="border-right: gray thin groove;
             ...
             <tr>
                 ...
                 <td style="background-color:#f1f1f1; width:17%; height:22px">
                     Pengeksport</td>
                 ...
                 <td style="background-color:#f1f1f1; width:13%; height:22px">
                     No. Sijil</td>
                 <td style="background-color:#f1f1f1; width:16%; height:22px">
                     No. Kontena</td>
                 <td style="background-color:#f1f1f1; width:15%; height:22px">
             ...
             border-left: gray thin groove; width: 100%; border-bottom: gray thin groove">
              <tr>
                  <td style="background-color:#f1f1f1; width:7%; color: #f1f1f1;">
                      No.</td>
                  <td style="background-color:#f1f1f1; width:17%; height:22px; color: #f1f1f1;">
                      Pengeksport</td>
                  ...
                  <td style="background-color:#f1f1f1; width:16%; height:22px; color: #f1f1f1;">
                      Destinasi Negara EU</td>
                  <td style="background-color:#f1f1f1; width:13%; height:22px; color: #f1f1f1;">
                      No. Sijil</td>
                   <td style="background-color:#f1f1f1; width:13%; height:22px; color: #f1f1f1;">
                      No. Kontena</td>
                  <td style="background-color:#f1f1f1; width:13%; height:22px; color: #f1f1f1;">
        ...
        <table border="0" style="width: 100%;">
            <tbody>
                 <tr>
                    ...
                    <td rowspan="1" style="background-color:#ffffcc; border-top-style: solid; border-top-color: teal; border-bottom: teal thin solid; width: 150px;">
                ...
                <tr>
                    ...
                    <td  rowspan="1" style="background-color:#f1f1f1; color: #f1f1f1; height: 27px; width: 150px;">
                        <div style="text-align:center">
                            Ekor</div>
                    </td>
                    <td rowspan="1" style="background-color:#f1f1f1; color: #f1f1f1; height: 27px;">
