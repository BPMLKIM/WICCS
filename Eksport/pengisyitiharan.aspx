<%@ Page Language="VB" AutoEventWireup="false" CodeFile="pengisyitiharan.aspx.vb" Inherits="Export_pengisyitiharan" %>
...
var KodIkanLarangan = new Array();
var NamaIkanLarangan = new Array();


var TMula = new Array();
var TTamat = new Array();
var Catatan = new Array();
var Link = new Array();

var KodEksportLarangan = new Array();
...
function pastiKanData()
{
    ...
    {   
        ...
        if (document.all.JenisUrusan.options.value=="017" ||document.all.JenisUrusan.options.value=="009" || document.all.JenisUrusan.options.value=="019" || document.all.JenisUrusan.options.value=="020")
        {
...
function printReport(strCetak)
{
    ...
    var str ="eSKPe.aspx?barcode="+document.all.Barcodes.value+"&invois_id="+document.all.Invois_Id.value+"&cetak=" +strCetak +"&pname="+document.all.printer_name.value;

    if (strCetak==1)
    {
        if (document.all.printer_name.value!="")
        {    
             window.open(str,'eSKPE_prt','width=5,height=5,status=yes');
        }
        else
        {
...
function AddArray()
{
    ...
    var date2 = new Date();
    var diff  = new Date();
    if(document.all.Importer.value=="" || document.all.Exporter.value=="")
    {
          alert('Sila Masukkan Maklumat Pengeksport & Pengimport Untuk Meneruskan Operasi!!!');
    }
    else
    {
    ...
    var dataItem6 = document.all.No_Sijil
    
    var strTemp3 = document.all.EU.options.value;
    var strTemp4 = strTemp3.split("|");  
    ...
    date1temp.setDate(date1temp.getDate());
    
   // added by zue
    
    var datecheck = new Date(licDate + " " + "00:00:00AM");
    ...
    else
    {
        ...
        if (datecheck <=date2temp>0) 
        {alert("Lesen Pengeksport Akan Tamat Tempoh Dalam Masa Sebulan.");}
        ...
        if (stat=="false")
        {
            ...
            document.all.arrayVal.value = dataItem1 + '`' + document.all.searchKodExporter.value + '`' + dataItem2.options.value +'`'+ dataItem3.options.value + '`' + dataItem4 + '`' + document.all.searchKodImporter.value + '`' + strTemp4[1] + '`' + document.all.No_Sijil.value + '`' + strTemp4[0] + '`' + document.all.NoKontena.value + '~' + document.all.arrayVal.value ;
           //document.all.TextBox1.value = document.all.TextBox1.value + dataItem1.options.value + '`' +dataItem1.options[dataItem1.selectedIndex].text + '`' + dataItem2.options.value +'`'+ dataItem3.options.value + '`' + dataItem4.options.value + '`' +dataItem4.options[dataItem4.selectedIndex].text +'~';
            ...
            var myString = dataItem1 + '`' + document.all.searchKodExporter.value + '`' + dataItem2.options.value +'`'+ dataItem3.options.value + '`' + dataItem4 + '`' + document.all.searchKodImporter.value + '`' + strTemp4[1] +  '`' + document.all.No_Sijil.value + '`' + strTemp4[0] + '`' + document.all.NoKontena.value + '~';
            ...
            /* Remarks By Nizam On 11 July 2007
...
//            document.all.txtJumlahNilai.value=0;    
            ...
            //document.all.EU.value="";
            document.all.No_Sijil.value="";  
             document.all.NoKontena.value="";  
    ...
    for (i=0;i<arrImporter.length-1; i++)
        {
	       ...
	       oCell.innerHTML = arrImporterInfoDetails[6];
	        ...
	        oCell.innerHTML = arrImporterInfoDetails[7];  
	         ...
	         oCell = newRow.insertCell();
	        oCell.innerHTML = arrImporterInfoDetails[9];  
...
//    var ekspot=1;
//    var ikan=1;
if (document.all.currentImporter.value!="")//importer
{
    //alert("Ok!!!!"); 
    var svrDate = document.all.serverDate.value;
    var arrSvrDate = svrDate.split("/");
    document.all.arrayTMula.value= TMula; 
    var sDate = document.all.arrayTMula.value;
    var arrsDate = sDate.split("/");
    sDate = arrsDate[1]+"/"+arrsDate[0]+"/"+arrsDate[2];    
    var date1temp = new Date(sDate + " " + "00:00:00AM");
    date1temp.setDate(date1temp.getDate());
    
    document.all.arrayTTamat.value= TTamat;  
    var eDate = document.all.arrayTTamat.value;
    var arreDate = eDate.split("/");
    eDate = arreDate[1]+"/"+arreDate[0]+"/"+arreDate[2];    
    var date3temp = new Date(eDate + " " + "00:00:00AM");
    date3temp.setDate(date3temp.getDate());
    

    
        
    var date2temp = new Date(svrDate + " " + "00:00:00AM"); 
    if ((date2temp >=date1temp)&&(date2temp<=date3temp))
  
    {
       // alert("ok tarikh dalam range");
       if ((document.all.JenisUrusan.options.value!="004" )&&(document.all.JenisUrusan.options.value!="005" )&&(document.all.JenisUrusan.options.value!="006" )&&(document.all.JenisUrusan.options.value!="010" )&&(document.all.JenisUrusan.options.value!="011" )&&(document.all.JenisUrusan.options.value!="012" )&&(document.all.JenisUrusan.options.value!="014" )&&(document.all.JenisUrusan.options.value!="015" ))
       //if (urusan==1)//urusan
       {
           // alert("urusan bukan transit");
            var searchItem =document.all.Kod8_Digit.value;
            var found=0;
            document.all.arrayFishLarangan.value = KodIkanLarangan; 
            var strTemp= document.all.arrayFishLarangan.value
            var strTemp2 = strTemp.split(",");  
            
            //declare eksport
            var a = document.all.Exporter.value ;
            var b= a.split("|");
            var searchItem1 = b[0];
            var foundeksport=0;
            document.all.arrayEksportLarangan.value = KodEksportLarangan;  
            var strTempeksport= document.all.arrayEksportLarangan.value
            var strTempeksport2 = strTempeksport.split(","); 
            ...
            if (searchItem!="")//
            {
             for (i=0;i<strTemp2.length;i++)//loop ikan
                 {
                    if (searchItem==strTemp2[i])
                        {
                           // alert("ikan dilarangsyah"); 
                            i=strTemp2.length;
                            found=1;               
                        } 
                        else
                        {
                           // alert("ikan tidak dilarang terus");
                            found=0;
                            foundeksport=1;
                        }   
                  }//end of loop ikan
                 if (found==1)//pengeksport kecuali
                 {
                    for (i=0;i<strTempeksport2.length;i++)//loop eksport
                    {
                    var strTempeksport3 = strTempeksport2[i].split("|"); 
                    if ((searchItem1==strTempeksport3[0])&&(searchItem==strTempeksport3[1]))
                    {
                           // alert("pengeksport dikecualikan"); 
                            i=strTempeksport2.length;
                            foundeksport=1;  
                            found=0;              
                    } 
                    else
                    {
                            //alert("pengeksport tidak dikecualikan");
                            foundeksport=0;
                            found=1; 
                    }   
                   }//end of loop eksport
//                    
                 }//end of pengeksport kecuali
                       
             }//end of searchitem
        }//end of urusan
        else
        {
            //alert("urusan  transit terus");
            found=0;
            foundeksport=1;
        }
      }//end of tarikh
      ...
      {
       // alert("ok tarikh tak dalam range terus");
        found=0;
        foundeksport=1;
       }
    }//end of importer
    ...
    if ((found==0) && (foundeksport==1))
    {
        //insert coding teruskan istihar item ikan
         // calculateJumlah();---remark utk kira manual
    ...
    alert("Eksport Ikan Ini Tidak Dibenarkan Kerana "+Catatan+" Untuk Tempoh Bermula Dari "+TMula+" Sehingga "+TTamat+". " +Link+".");                
    }
}
   ...
   //alert(totalRows);
    ...
    if (currImporter!="")
    {
        ...
        for (i=0;i<arrIkanInfo.length; i++)
        {
            ...
            //alert("currentImporter -"+ currImporter +" == arrayKodImporter-"+ arrIkanInfoDetails[0]);
...
function calculateTxtQtyKecil()
{
    ...
    else 
    {
     ...
     document.all.txtKuantitiKecil.value = parseInt(txtKecil) * 50;     
    }
...
function calculateTxtQtyBesar()
{
    ...
    else 
    {
     ...
     document.all.txtKuantitiBesar.value = parseInt(txtBesar) * 100;
    }
    calculateJumlah();
}
   ...
   //alert("found");
    ...
    else
    {
       if (searchItem!="")
       {
          ...
          {
          var katIkan; //edited by kmz for caj eksport
		...
		//end of edited by kmz for caj eksport            
          ...
          if (found==0)               
          {
             ...
             MM_openBrWindow('Senarai-Ikan.aspx','test','width=350,height=700,status=yes');                   
          }
       }
...
//                document.all.txtNilai.disabled = true;
                ...
                document.all.txtKuantitiKecil.disabled = false;
                document.all.txtKuantitiBesar.disabled = false;
                document.all.txtPek.disabled = false;
...
{
 var strUrl="v_mastersheet.aspx";
 MM_openBrWindow(strUrl,'test','width=800,height=600,status=yes,scroll=yes');
}
...
function showFilteredCompanyIkanCaj(company_code,jenis_urusan_code,kategori_ikanSearch)
{
   ...
   // alert(company_c.length);
    for (i=0;i<company_c.length;i++)
    {
          ...
          //alert(jenis_urusan_code+"="+jenis_urusan_c[i]+" && "+ kategori_ikanSearch+"=="+ kategori_ikan_c[i] +" && "+ kod_ikanSearch+"=="+ kod_ikan_c[i]);
...
{
    //chargeFound=0;
    //alert(kategori_ikanSearch);
    for (i=0;i<jenis_urusan_g.length;i++)
    {
           //alert(jenis_urusan_code+"="+jenis_urusan_g[i]+" && "+ kategori_ikanSearch+"=="+ kategori_ikan_g[i]);
           if ((jenis_urusan_code==jenis_urusan_g[i]) && (kategori_ikanSearch==kategori_ikan_g[i]))
            {
               // alert("found="+i+"="+KeyKodAgen[i]);
                ...
                chargeFound =1; 
                /*alert("PK"+document.all.kpk.value);               
                alert("PB"+document.all.kpb.value);   
                alert("Kategori"+kategori_ikan_g[i]);               
                */
                break;
            }    
    }//end next    
...
<%
    ...
    Dim sqlText As String = "SELECT [Nama_BKH], [Kod_Ikan], [Kod_BKH],[Harga_BKH],RTRIM([Kod_Kategori_Ikan]) as Kod_Kategori_Ikan FROM [JENIS_IKAN]" 'edited by kmz for caj eksport
    ...
    Do While jsReader.Read
        ...
        Response.Write("MKodKategoriIkan[" & cntArray & "]='" & jsReader.GetValue(4) & "';" & vbCrLf) 'edited by kmz for caj eksport
    ...
    cntArray = 0
    sqlText = "SELECT [Nama_BKH],[Kod_Ikan], [Kod_BKH] FROM [JENIS_IKAN_larangan] where status='yes'"
    jsReader = opClass.DataReader(sqlText)
    Response.Write("<script>")
    Do While jsReader.Read
        Response.Write("KodIkanLarangan[" & cntArray & "]='" & jsReader.GetValue(1).ToString() & "';" & vbCrLf)
        'Response.Write("KodBKH[" & cntArray & "]='" & jsReader.GetValue(2) & "';" & vbCrLf)
        Response.Write("NamaIkanLarangan[" & cntArray & "]='" & jsReader.GetValue(0) & "';" & vbCrLf)
        'Response.Write("KodIkan[" & cntArray & "]='" & jsReader.GetValue(1) & "';" & vbCrLf)
        'Response.Write("txtNilaiKadar[" & cntArray & "]='" & jsReader.GetValue(3) & "';" & vbCrLf & vbCrLf)
        cntArray = cntArray + 1
    Loop
    ...
    cntArray = 0
    sqlText = "SELECT CAST(DAY(t_mula) AS nvarchar(200)) + '/' + CASE WHEN MONTH(t_mula) < 10 THEN '0' + CAST(month(t_mula) AS varchar(1)) ELSE CAST(month(t_mula) AS varchar(2)) END + '/' + CAST(YEAR(t_mula) AS nvarchar(4)) AS Val, CAST(DAY(t_tamat) AS nvarchar(200)) + '/' + CASE WHEN MONTH(t_tamat) < 10 THEN '0' + CAST(month(t_tamat) AS varchar(1)) ELSE CAST(month(t_tamat) AS varchar(2)) END + '/' + CAST(YEAR(t_tamat) AS nvarchar(4)) AS Val, [catatan],link FROM [tempoh_larangan] where status='A'"
    jsReader = opClass.DataReader(sqlText)
    Response.Write("<script>")
    Do While jsReader.Read
        Response.Write("TMula[" & cntArray & "]='" & jsReader.GetValue(0).ToString.Trim() & "';" & vbCrLf)
        Response.Write("TTamat[" & cntArray & "]='" & jsReader.GetValue(1).ToString.Trim() & "';" & vbCrLf)
        Response.Write("Catatan[" & cntArray & "]='" & jsReader.GetValue(2).Trim & "';" & vbCrLf)
        Response.Write("Link[" & cntArray & "]='" & jsReader.GetValue(3).Trim & "';" & vbCrLf)
        'Response.Write("KodIkan[" & cntArray & "]='" & jsReader.GetValue(1) & "';" & vbCrLf)
        'Response.Write("txtNilaiKadar[" & cntArray & "]='" & jsReader.GetValue(3) & "';" & vbCrLf & vbCrLf)
        cntArray = cntArray + 1
    Loop
    ...
    cntArray = 0
    sqlText = "SELECT rtrim(Kod_Pengeksport) + '|' + (Kod_ikan) as val from PENGEKSPORT_KECUALI where status='yes'" & _
              "ORDER BY LTRIM(Nama_Syarikat_Eksport)"
    jsReader = opClass.DataReader(sqlText)
    Response.Write("<script>")
    Do While jsReader.Read
        Response.Write("KodEksportLarangan[" & cntArray & "]='" & jsReader.GetValue(0).ToString & "';" & vbCrLf)
        cntArray = cntArray + 1
    Loop
    Response.Write("</script>")
    jsReader.Close()
    ...
    sqlText = "SELECT RTRIM(Kategori_Ikan) as Kategori_Ikan, RTRIM(Jenis_Urusan) as Jenis_Urusan, Kadar_Peti_Kecil, Kadar_Peti_Besar, Kadar_Ekor, Kadar_Kuantiti, Kod_Pengimport,id " & _
              "FROM COMPANY_IKAN_CAJ_EKSPORT WHERE (tarikh_tamat >= GETDATE())"
    jsReader = opClass.DataReader(sqlText)
    Response.Write("<script>")
    Do While jsReader.Read
        ...
        'Response.Write("kod_ikan_c[" & cntArray & "]='" & jsReader.GetValue(8) & "';" & vbCrLf & vbCrLf)
        cntArray = cntArray + 1
    Loop
    Response.Write("</script>")
    jsReader.Close()
...
<body>
        ...
        <table style="width: 100%">
            <tr>
                <td colspan="4" style="height: 18px; background-color:#0000cc;">
                    <strong>&nbsp;<span style="color: #ffffff">PENGISYTIHARAN EKSPORT </span></strong></td>
            </tr>
            <tr>
                <td>
                </td>
            ...
            <tr>
                <td >
                    <strong>&nbsp;No./Kapal/PenerbanganKenderaan</strong></td>
                <td >
                    <asp:TextBox ID="noKenderaan" runat="server" Width="256px" ReadOnly="True"></asp:TextBox></td>
                <td >
    ...
    <table style="width: 100%">
        <tr>
            ...
            <td style="height: 21px" >
                &nbsp;<asp:DropDownList ID="KompleksPPI" runat="server" DataSourceID="PPI" DataTextField="Nama_PPI" DataValueField="Kod_PPI">
                    </asp:DropDownList></td>
            <td style="height: 21px" >
        ...
        <tr>
             <td style="height: 21px" >
                <strong>Destinasi Negara EU</strong></td>
            <td style="height: 21px">
                <strong>&nbsp;<asp:DropDownList ID="EU" runat="server" DataSourceID="NegaraEU" DataTextField="Nama_Negara" DataValueField="Kod_Negara">
              </asp:DropDownList>
                    </strong></td>
              <td >
                    <strong>&nbsp;No. Sijil</strong></td>
                <td >
                    <asp:TextBox ID="No_Sijil" runat="server" Width="93px" ReadOnly="False"></asp:TextBox></td>
        </tr>           
        <tr>
            <td style="height: 21px" >
         ...
         <strong>No. Kontena &nbsp;:</strong>&nbsp;
         <asp:TextBox ID="NoKontena" runat="server" Width="93px"></asp:TextBox><br />
         <br />
         <input id="Button3" type="button" value="Tambah" style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1;" onclick="AddArray();refreshTableGridIkan();"  />
          <input id="Button4" type="button" value="Batal" style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1; width: 61px;" onclick="RemoveArray()" />          
          <div class="scrollingdatagrid" style="width:100%;height:110px; left: 0px; top: 0px;">
         <table id="tblGridImporter" border="0" width="100%" >
             <thead >
             <tr>
             
                 <th style="background-color:#f1f1f1; width:7%; height: 24px;">
                     No.</th>
                 <th style="background-color:#f1f1f1; width:22%; height:24px">
                     Pengeksport</th>
                 <th style="background-color:#f1f1f1; width:12%; height:24px">
                     No. Lesen</th>
                 <th style="background-color:#f1f1f1; width:11%; height:24px">
                     Tarikh Luput</th>
                 <th style="background-color:#f1f1f1; width:14%; height:24px">
                     Pengimport</th>
                 <th style="background-color:#f1f1f1; width:12%; height:24px">
                     Destinasi
                     Negara EU</th>
                ...
                <th style="background-color:#f1f1f1; width:12%; height:24px">
                     No. Kontena</th>
                <th style="background-color:#f1f1f1; width:10%; height:24px">
                     Kod Pengeksport</th>
         ...
         <br />
          <div><asp:HiddenField ID="arrayVal" runat="server" /><asp:HiddenField ID="arrayFishVal" runat="server" />
                <asp:HiddenField ID="currentImporter" runat="server" />
              <asp:HiddenField ID="serverDate" runat="server" />
              <asp:HiddenField ID="Invois_Id" runat="server" /><asp:HiddenField ID="printer_name" runat="server" />
             <asp:HiddenField ID="JenisUrusanLama" runat="server" /><asp:HiddenField ID="arrayFishLarangan" runat="server" />
             <asp:HiddenField ID="arrayEksportLarangan" runat="server" />
             <asp:HiddenField ID="arrayTMula" runat="server" />
             <asp:HiddenField ID="arrayTTamat" runat="server" />
             <asp:HiddenField ID="arrayCatatan" runat="server" />
             <asp:HiddenField ID="arrayLink" runat="server" />
             <!--edited by kmz for caj eksport -->
             <asp:HiddenField ID="CajMasuk" runat="server" />
             <asp:HiddenField ID="kpk" runat="server" />
             <asp:HiddenField ID="HiddenField1" runat="server" />
              <asp:HiddenField ID="kpb" runat="server" />
              <asp:HiddenField ID="ke" runat="server" />
              <asp:HiddenField ID="kq" runat="server" />
              <asp:HiddenField ID="kod_id" runat="server" />
              <asp:HiddenField ID="ju" runat="server" />
	<!--end of edited by kmz for caj eksport -->
          </div>
    
        <table style="width: 100%;FONT-SIZE: 8pt; FONT-FAMILY: Arial,Verdana, Tahoma; ">
               <thead>
               <tr>
                <th style="width: 55px">
                    <strong>Kod</strong></th>
                <th style="width:20%;">
                    <strong>Nama</strong></th>
                <th style="width: 58px">
                    <div style="text-align:center">
                        <strong>Kod 8 Digit</strong></div></th>
                <th style="width:15%">
                    <div style="text-align:center">
                        <strong>Destinasi</strong></div></th>
                 <th style="height: 15px; text-align: center;">
                  <span style="color: black"><strong>Peti Kecil</strong></span></th>
              <th style="height: 15px; text-align: center; color: black;">
                  <strong>Kuantiti<br />Kecil (kg)</strong></th>
              <th style="height: 15px; text-align: center;">
              ...
              <th style="height: 15px; text-align: center;" >
				 ...
				 <th  style="width: 27px" >
                    <div style="text-align:center">
                        <strong>Pek</strong></div></th>
				 <th >
                    <div style="text-align:center">
                        <strong>Ekor</strong></div></th>	
					 <th  style="width: 68px; text-align: center;">
                         <strong>Kadar (RM/KG)</strong></th>
                <th  style="width: 68px; text-align: center">
                    <strong>Nilai (RM)</strong></th>
            </tr>
            
            <tr>
                <th style="height: 23px; width: 55px;" >
                    <asp:TextBox ID="Kod_BKH" runat="server" Width="100%"></asp:TextBox></th>
                <th style="height: 23px;" >
                    <asp:TextBox ID="Nama_Ikan" runat="server" Width="100%"></asp:TextBox></th>
                <th style="height: 23px; width: 58px;" >
                    <asp:TextBox ID="Kod8_Digit" runat="server" Width="100%"></asp:TextBox></th>
                <th style="height: 23px" >
                    <asp:DropDownList ID="Destination" runat="server" DataSourceID="Destinasi" DataTextField="Nama_Negara"
                        DataValueField="Kod_Negara" Width="100%">
                    </asp:DropDownList></th>
                <th style="height: 23px" ><asp:TextBox ID="txtPetiKecil" runat="server" Width="100%"></asp:TextBox></th>
                 <th style="height: 23px" ><asp:TextBox ID="txtKuantitiKecil" runat="server" Width="100%"></asp:TextBox></th>
                 <th style="height: 23px" ><asp:TextBox ID="txtPetiBesar" runat="server" Width="100%"></asp:TextBox></th>
                 <th style="height: 23px" ><asp:TextBox ID="txtKuantitiBesar" runat="server" Width="100%"></asp:TextBox></th>
                 <th style="height: 23px; width: 27px;" >
                     <asp:TextBox ID="txtPek" runat="server" Width="100%"></asp:TextBox></th>
                <th style="height: 23px;" >
                    <asp:TextBox ID="txtEkor" runat="server" Width="100%"></asp:TextBox></th>
                <th style="height: 23px; width: 68px;">
                    <asp:TextBox ID="txtNilai" runat="server" Width="100%"></asp:TextBox></th>
                <th style="width: 68px; height: 23px">
                    <asp:TextBox ID="txtJumlahNilai" runat="server" Width="100%"></asp:TextBox></th>
            </tr>
           </thead>
        </table>        
        <Input style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1" id="Button2" onclick="AddFishArray();" type="button" value="Tambah" />
         <br />
         <br />
         <div class="scrollingdatagrid" style="width:100%;height:110px; left: 0px; top: 0px;">
        <table id="tblGrid" border="0" style="width: 100%;">
            <thead>
            <tr>
                <th style="background-color:#f1f1f1; height: 30px;">
                    Kod</th>
                <th  style="background-color:#f1f1f1;width: 20%; height: 30px;">
                    Nama</th>
                <th style=" background-color:#f1f1f1; height: 30px;">
                    <div style="text-align:center">
                        Kod 8 Digit</div>
                </th>
                <th style="background-color:#f1f1f1;width: 15%; height: 30px;">
                    <div style="text-align:center">
              ...
              <th style="background-color:#f1f1f1; height: 30px;" >
                ...
                <th style="background-color:#f1f1f1;text-align: center; height: 30px;">
                    Nilai (RM)</th>
            </tr>            
            </thead>
            <tbody>
            ...
            </div><table id="Table3" border="0" style="width: 100%;FONT-SIZE: 8pt;FONT-FAMILY: Arial,Verdana, Tahoma;">
                <thead>
                    <tr>
                        <th style="height: 30px; background-color: #ffffcc">
                        </th>
                        <th style="width: 20%; height: 30px; background-color: #ffffcc">
                        </th>
                        <th style="height: 30px; background-color: #ffffcc">
                        </th>
                        <th style="width: 15%; height: 30px; background-color: #ffffcc">
                        </th>
                        <th style="border-top-style: solid; border-top-color: teal; border-bottom: teal thin solid;
                            background-color: #ffffcc">
                    <asp:Label ID="Label1" runat="server" Width="100%">0</asp:Label></th>
                        <th style="border-top-style: solid; border-top-color: teal; border-bottom: teal thin solid;
                            background-color: #ffffcc">
                    <asp:Label ID="Label2" runat="server" Width="100%">0</asp:Label></th>
                        <th style="border-top-style: solid; border-top-color: teal; border-bottom: teal thin solid;
                            background-color: #ffffcc">
                    <asp:Label ID="Label3" runat="server" Width="100%">0</asp:Label></th>
                        <th style="border-top-style: solid; border-top-color: teal; border-bottom: teal thin solid;
                            background-color: #ffffcc">
                    <asp:Label ID="Label4" runat="server" Width="100%">0</asp:Label></th>
                        <th style="border-top-style: solid; border-top-color: teal; border-bottom: teal thin solid;
                            background-color: #ffffcc">
                    <asp:Label ID="Label5" runat="server" Width="100%">0</asp:Label></th>
                        <th style="border-top-style: solid; border-top-color: teal; border-bottom: teal thin solid;
                            background-color: #ffffcc">
                    <asp:Label ID="Label6" runat="server" Width="100%">0</asp:Label></th>
                        <th style="border-top-style: solid; border-top-color: teal; border-bottom: teal thin solid;
                            background-color: #ffffcc">
                    <asp:Label ID="Label7" runat="server" Width="100%">0</asp:Label></th>
                    </tr>
                    <tr>
                        <th style="background-color:#f1f1f1; height: 30px;color:#f1f1f1">
                            Kod BKH</th>
                        <th  style="background-color:#f1f1f1;width: 20%; height: 30px;color:#f1f1f1">
                            Nama</th>
                        <th style=" background-color:#f1f1f1; height: 30px;color:#f1f1f1">
                            <div style="text-align:center">
                                Kod 8 Digit</div>
                        </th>
                        <th style="background-color:#f1f1f1;width: 15%; height: 30px;color:#f1f1f1">
                            <div style="text-align:center">
                                <span >Destinasi</span></div>
                        </th>
                        <th style="background-color:#f1f1f1; height: 30px;color:#f1f1f1">
                            <span ><strong>Peti Kecil</strong></span></th>
                        <th style="background-color:#f1f1f1; height: 30px;color:#f1f1f1">
                            <strong>Kuantiti Kecil (kg)</strong></th>
                        <th style="background-color:#f1f1f1; height: 30px;color:#f1f1f1;">
                            <strong>Peti Besar</strong></th>
                        ...
                        <th style="background-color:#f1f1f1;text-align: center; height: 30px;color:#f1f1f1">
                            Nilai (RM)</th>
                    </tr>
                </thead>
                <tbody>
        ...
        <hr />
         <input id="Button6" onclick="newForm();" style="border-right: #333333 1px ridge;
             ...
             type="button" value="BARU" />
               <!-- edited by kmz for caj eksport -->
         <asp:Button ID="Button8" runat="server" CausesValidation="False" OnClientClick="openMasterSheet();"
             ...
             background-color: #f1f1f1" Text="PAPAR MASTERSHEET" UseSubmitBehavior="False" Enabled="False" />
<!-- end of edited by kmz for caj eksport -->
         <asp:Button ID="Simpan" runat="server" Text="SIMPAN" style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1;" OnClientClick="return pastiKanData();"/><input
             id="Button10" runat="server" disabled="disabled" onclick="printReport('1');"
             style="border-right: #333333 1px ridge; padding-right: 1px; border-top: #ffffff 1px ridge;
             padding-left: 1px; font-size: 10px; padding-bottom: 1px; border-left: #ffffff 1px ridge;
             color: #000000; padding-top: 1px; border-bottom: #000000 1px ridge; font-family: MS Shell Dlg,verdana,??;
             background-color: #f1f1f1" type="button" value="CETAK SKPI" /><input id="Button9"
                 runat="server" disabled="disabled" onclick="printReport('0');" style="border-right: #333333 1px ridge;
                 padding-right: 1px; border-top: #ffffff 1px ridge; padding-left: 1px; font-size: 10px;
                 padding-bottom: 1px; border-left: #ffffff 1px ridge; color: #000000; padding-top: 1px;
                 border-bottom: #000000 1px ridge; font-family: MS Shell Dlg,verdana,??; background-color: #f1f1f1"
                 type="button" value="PAPAR CETAKKAN" />
         <input
             id="Button1" runat="server" onclick="showSenaraiprinter();" style="border-right: #333333 1px ridge;
             padding-right: 1px; border-top: #ffffff 1px ridge; padding-left: 1px; font-size: 10px;
             padding-bottom: 1px; border-left: #ffffff 1px ridge; color: #000000; padding-top: 1px;
             border-bottom: #000000 1px ridge; font-family: MS Shell Dlg,verdana,??; background-color: #f1f1f1"
             type="button" value="PILIH PRINTER" disabled="disabled" /><asp:Button ID="Keluar" runat="server" Text="KELUAR" style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1;"/>
         &nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;<br />
        ...
        <asp:SqlDataSource ID="JenisPengangkutan" runat="server" ConnectionString="<%$ ConnectionStrings:W-ICCS_Conn %>"
            SelectCommand="SELECT RTRIM(Kod_Cara_Pengangkutan) AS Kod_Pengangkutan, Nama_Cara_Pengangkutan AS Nama_Pengangkutan FROM CARA_PENGANGKUTAN where status ='yes' ORDER BY Nama_Cara_Pengangkutan">
        </asp:SqlDataSource>
        <asp:SqlDataSource ID="SumberBekalan" runat="server" ConnectionString="<%$ ConnectionStrings:W-ICCS_Conn %>"
            SelectCommand="SELECT [Kod_Negara], [Nama_Negara] FROM [NEGARA] where kumpulan_negara<>'EU' "></asp:SqlDataSource>
        <asp:SqlDataSource ID="NegaraEU" runat="server" ConnectionString="<%$ ConnectionStrings:W-ICCS_Conn %>"
            SelectCommand="SELECT [Kod_Negara]+'|'+[Nama_Negara] as [Kod_Negara], [Nama_Negara] FROM [NEGARA] where kumpulan_negara='EU' order by kod_negara "></asp:SqlDataSource>
        ...
        <asp:SqlDataSource ID="Destinasi" runat="server" ConnectionString="<%$ ConnectionStrings:W-ICCS_Conn %>"
            SelectCommand="SELECT [Kod_Negara]+'|'+[Nama_Negara] as [Kod_Negara], [Nama_Negara] FROM [NEGARA] where kumpulan_negara<>'EU' ">
        </asp:SqlDataSource>
        <asp:SqlDataSource ID="Urusan" runat="server" ConnectionString="<%$ ConnectionStrings:W-ICCS_Conn %>"
            SelectCommand="SELECT [Kod_Urusan], [Nama_Urusan] FROM [JENIS_URUSAN] WHERE KOD_URUSAN IN('003', '018')"></asp:SqlDataSource>
