<%@ Page Language="VB" AutoEventWireup="false" CodeFile="pengisyitiharanasal.aspx.vb" Inherits="Export_pengisyitiharanasal" %>
	...
	<!--end of edited by kmz for caj eksport -->
        ...
        <hr />
         ...
         <asp:Button ID="Button8" runat="server" CausesValidation="False" OnClientClick="openMasterSheet();"
             ...
             background-color: #f1f1f1" Text="PAPAR MASTERSHEET" UseSubmitBehavior="False" />
<!-- end of edited by kmz for caj eksport -->
