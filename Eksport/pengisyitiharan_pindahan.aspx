<%@ Page Language="VB" AutoEventWireup="false" CodeFile="pengisyitiharan_pindahan.aspx.vb" Inherits="Export_pengisyitiharan_pindahan" %>
...
function AddArray()
{
    ...
    {    
        ...
        var dataItem1 = document.all.Exporter;    
        var strTemp = dataItem1.options.value;
        ...
        var dataItem4 = document.all.Importer;
        ...
        else
        {
            ...
            {    
                ...
                for(i=0;i<arrImporterInfoRow.length;i++)
                {
                    ...
                    if(arrImporterInfoCol[0] == dataItem1.options.value)
                    {
                        stat="true";
                    }        
                } 
            ...
            if (stat=="false")
            {
                ...
                document.all.arrayVal.value = document.all.arrayVal.value + dataItem1.options.value + '`' +dataItem1.options[dataItem1.selectedIndex].text + '`' + dataItem2.options.value +'`'+ dataItem3.options.value + '`' + dataItem4.options.value + '`' +dataItem4.options[dataItem4.selectedIndex].text +'`'+ document.all.nama_pemandu_pindahan.value +'`'+ document.all.no_kenderaan_pindahan.value +'~';
               //document.all.TextBox1.value = document.all.TextBox1.value + dataItem1.options.value + '`' +dataItem1.options[dataItem1.selectedIndex].text + '`' + dataItem2.options.value +'`'+ dataItem3.options.value + '`' + dataItem4.options.value + '`' +dataItem4.options[dataItem4.selectedIndex].text +'~';
                ...
                var myString =dataItem1.options.value + '`' +dataItem1.options[dataItem1.selectedIndex].text + '`' + dataItem2.options.value +'`'+ dataItem3.options.value + '`' + dataItem4.options.value + '`' +dataItem4.options[dataItem4.selectedIndex].text +'`'+ document.all.nama_pemandu_pindahan.value +'`'+ document.all.no_kenderaan_pindahan.value +'~';
	            ...
	            oCell = newRow.insertCell();
	            oCell.innerHTML = dataItem4.options[dataItem4.selectedIndex].text ;
	            oCell = newRow.insertCell();
            ...
            {
                alert('Pengeksport '+ dataItem1.options[dataItem1.selectedIndex].text +' telah wujud di dalam senarai!!!');
            }
       }
    }     
}
...
function AddFishArray()
{
    ...
    for (i=0;i<arrTempDetailsIkan.length;i++)
    {
        ...
        {
            cnt = cnt + 1;
            tpk = tpk + parseFloat(arrTempIkanInfo[5]);           
            tkk = tkk + parseFloat(arrTempIkanInfo[6]);
            tpb = tpb + parseFloat(arrTempIkanInfo[7]);
            tkb = tkb + parseFloat(arrTempIkanInfo[8]);
            tpek = tpek + parseFloat(arrTempIkanInfo[9]);                                             
            tekor = tekor + parseFloat(arrTempIkanInfo[10]);
            nilai = nilai + parseFloat(arrTempIkanInfo[11]);                        
        }
    }
    //
    
    tpk = tpk + parseFloat(document.all.txtPetiKecil.value);           
    tkk = tkk + parseFloat(document.all.txtKuantitiKecil.value);
    tpb = tpb + parseFloat(document.all.txtPetiBesar.value);
    tkb = tkb + parseFloat(document.all.txtKuantitiBesar.value);
    tpek = tpek + parseFloat(document.all.txtPek.value);                                             
    tekor = tekor + parseFloat(document.all.txtEkor.value);
    nilai = nilai + parseFloat(document.all.txtJumlahNilai.value);
    
    //Checking whether existing items already reach maximum limit    
    if (cnt==8)
    {
        alert('Hanya 8 item sahaja yg boleh diisytiharkan dalam satu e-SKPE');
    }
    else
    {    
        ...
        document.getElementById("Label8").innerHTML= tpk + tpb ;
        
        var strTemp = document.all.Destination.options.value;
        var strTemp2 = strTemp.split("|");  
        var arrVal = document.all.currentImporter.value + '`' + document.all.Kod_BKH.value + '`' + document.all.Nama_Ikan.value + '`' + document.all.Kod8_Digit.value + '`' + strTemp2[0] + '`' + document.all.txtPetiKecil.value + '`' + document.all.txtKuantitiKecil.value + '`' + document.all.txtPetiBesar.value + '`' + document.all.txtKuantitiBesar.value + '`' + document.all.txtPek.value + '`' + document.all.txtEkor.value + '`' + document.all.txtJumlahNilai.value + '`' + strTemp2[1] +'~';
        //alert(arrVal);
...
function refreshTableGridIkan()
{
   ...
   // alert("currImporter="+currImporter);
        ...
        for (i=0;i<arrIkanInfo.length; i++)
        {
           ...
           // alert(currImporter+"=="+arrIkanInfoDetails[0]);
            ...
            {         	
                ...
                var oCell = newRow.insertCell();
                oCell.innerHTML = "<img src=\"../images/del..gif\"  onclick=\"+RemoveFishArray('"+arrIkanInfo[i]+"');removeRow(this);\" />"+ arrIkanInfoDetails[1];			
                oCell = newRow.insertCell();
                ...
                tpk = tpk + parseFloat(arrIkanInfoDetails[5]);           
                tkk = tkk + parseFloat(arrIkanInfoDetails[6]);
                tpb = tpb + parseFloat(arrIkanInfoDetails[7]);
                tkb = tkb + parseFloat(arrIkanInfoDetails[8]);
                tpek = tpek + parseFloat(arrIkanInfoDetails[9]);                                             
                tekor = tekor + parseFloat(arrIkanInfoDetails[10]);
                nilai = nilai + parseFloat(arrIkanInfoDetails[11]);                   
...
{
  if (parseFloat(document.all.txtNilai.value)>0)
  {
   if(document.all.txtKuantitiKecil.value!="" && document.all.txtKuantitiBesar.value!="")
   {
       document.all.txtJumlahNilai.value = (parseFloat(document.all.txtKuantitiKecil.value) + parseFloat(document.all.txtKuantitiBesar.value)) * parseFloat(document.all.txtNilai.value); 
...
<body>
    ...
    <table style="width: 100%">
        ...
        <tr>
            ...
            <td style="height: 21px" >
                &nbsp;<asp:DropDownList ID="Exporter" runat="server" DataTextField="Nama_Syarikat_Eksport" DataValueField="Val" DataSourceID="Pengeksport">
              </asp:DropDownList></td>
            <td style="height: 21px" >
                <strong>Pengimport</strong></td>
            <td style="height: 21px"><asp:DropDownList ID="Importer" runat="server" DataSourceID="Pengimport" DataTextField="Nama_Syarikat_Pengimport" DataValueField="Kod_Pengimport">
              </asp:DropDownList></td>
        </tr>        
        <tr>
            <td colspan="4">
        ...
        <table style="width: 100%; border-top-width: thin; border-left-width: thin; border-bottom-width: thin; border-right-width: thin;" border="0">
            ...
            <tr>
                ...
                <td style="height: 23px" ><asp:TextBox ID="txtPetiKecil" runat="server" Width="100%">0</asp:TextBox></td>
                 <td style="height: 23px" ><asp:TextBox ID="txtKuantitiKecil" runat="server" Width="100%">0</asp:TextBox></td>
                 <td style="height: 23px" ><asp:TextBox ID="txtPetiBesar" runat="server" Width="100%">0</asp:TextBox></td>
                 <td style="height: 23px" ><asp:TextBox ID="txtKuantitiBesar" runat="server" Width="100%">0</asp:TextBox></td>
                 <td style="height: 23px; width: 27px;" >
                     <asp:TextBox ID="txtPek" runat="server" Width="100%">0</asp:TextBox></td>
                <td style="height: 23px;" >
                    <asp:TextBox ID="txtEkor" runat="server" Width="100%">0</asp:TextBox></td>
                <td style="height: 23px; width: 68px;">
                    <asp:TextBox ID="txtNilai" runat="server" Width="100%">0</asp:TextBox></td>
                <td style="width: 68px; height: 23px">
                    <asp:TextBox ID="txtJumlahNilai" runat="server" Width="100%">0</asp:TextBox></td>
            </tr>
        ...
        <hr />
         ...
         <input id="Button5" type="button" value="RESET" style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1;" onclick="resetForms();"  />
        <asp:Button ID="Simpan" runat="server" Text="SIMPAN" style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1;" OnClick="SIMPAN_Click"/>
         <input id="Button7" type="button" value="CETAK SKPI" style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1;" onclick="printReport();"  />
        <asp:Button ID="CetakSKPI" runat="server" Text="CETAK SKPI" style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1;"/>
        ...
        <asp:CheckBox ID="paparCetak" runat="server" Text="Paparkan Cetakan" Width="140px" />
        &nbsp;&nbsp;
        <br />
        <br />
        <br />
