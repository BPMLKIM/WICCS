...
Partial Class Export_pengisyitiharanasal
        ...
        If Simpan.Page.IsPostBack Then
            ...
            If arrayVal.Value <> "" And arrayFishVal.Value <> "" Then
                ...
                Else
                    ...
                    opClass.Proses_Pengisytiharan(arrayVal.Value, Barcodes.Text, no_daftar, noKenderaan.Text, JenisUrusan.SelectedItem.Value, cara_pengangkutan.SelectedItem.Value, Bekalan.SelectedItem.Value, KompleksPPI.SelectedItem.Value, Nothing) 'EU.SelectedItem.Value, No_Sijil.Text,
                    ...
                    If (opClass.ErrorSignalE = False) Then
                        ...
                        sqltext = "UPDATE SISTEM_Q Set status='Isytihar',Bil_SKPI='" & opClass.eSKPEArray.Count() & "',pegawai='" & Session("namaPegawai") & "' WHERE No_Barcode = '" & Trim(Barcodes.Text) & "'"
                        opClass.InsertData(sqltext)
