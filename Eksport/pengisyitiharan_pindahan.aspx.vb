...
Partial Class Export_pengisyitiharan_pindahan
...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        txtPetiKecil.Attributes.Add("onBlur", "calculateTxtQtyKecil();")
        txtKuantitiKecil.Attributes.Add("onBlur", "calculateTxtQtyKecil();")
        txtPetiBesar.Attributes.Add("onBlur", "calculateTxtQtyBesar();")
        txtPetiBesar.Attributes.Add("onBlur", "calculateTxtQtyBesar();")
        txtKuantitiBesar.Attributes.Add("onBlur", "calculateTxtQtyBesar();")
