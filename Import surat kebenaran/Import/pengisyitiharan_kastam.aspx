<%@ Page Language="VB" AutoEventWireup="false" CodeFile="pengisyitiharan_kastam.aspx.vb" Inherits="Import_pengisyitiharan_kastam" %>
...
function newForm()
{
    ...
    if (input_box==true) 
    {
        location.href='../pintu_masuk/verifikasi_PintuMasuk_kastam.aspx';    
    }    
}
...
function pastiKanData()
{
    ...
    {   
        ...
        if (document.all.JenisUrusan.options.value=="001" ||document.all.JenisUrusan.options.value=="009" || document.all.JenisUrusan.options.value=="019" || document.all.JenisUrusan.options.value=="020")
        {
...
function resetForms()
{
    ...
    location.href="pengisyitiharan_kastam.aspx?barcode="+document.all.Barcodes.value;
}
...
<body >
  ...
  <table style="width: 100%">
    <tr> 
      <td colspan="4" style="height: 18px; background-color:#0000cc;"> <strong>&nbsp;<span style="color: #ffffff">(KASTAM)
          PENGISYTIHARAN 
    ...
    <tr> 
      <td style="height: 23px" > <strong>Agen Pengangkutan</strong></td>
      <td style="height: 23px" > <asp:TextBox ID="NamaAgen" runat="server" Width="260px" ReadOnly="True"></asp:TextBox></td>
      <td style="height: 23px" > <strong>#Barcode</strong></td>
      <td style="width: 125px; height: 23px;" > <asp:TextBox ID="Barcodes" runat="server" Width="156px" ReadOnly="True"></asp:TextBox></td>
    </tr>
    <tr> 
    ...
    <tr> 
      <td style="height: 23px" > <strong>No. Kenderaan</strong></td>
