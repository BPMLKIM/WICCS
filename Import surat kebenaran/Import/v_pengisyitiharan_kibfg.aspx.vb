...
Partial Class View_Import_pengisyitiharan_kibfg
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            sqlText = "SELECT DISTINCT RTRIM(PENGISYTIHARAN_I_KIBFG.Kod_Pengimport) + '|' + RTRIM(PENGIMPORT.No_Lesen) + '|' + " & _
                      ...
                      "+ '`' + PENGEKSPORT_THAILAND.Nama_Pengeksport + '~'" & _
                      " AS data, PENGISYTIHARAN_I_KIBFG.STATUS, PENGISYTIHARAN_I_KIBFG.KOD_URUSAN,JENIS_URUSAN.NAMA_URUSAN,PENGISYTIHARAN_I_KIBFG.ONLINESEND_BY " & _
                      ...
                      "Where  PENGISYTIHARAN_I_KIBFG.NO_BARCODE ='" & rujukan.Text & "'"
            ...
            strVal = ""
            sqlText = "SELECT     PENGISYTIHARAN_I_KIBFG.Kod_Pengimport + '`' + JENIS_IKAN.Kod_BKH + '`' + JENIS_IKAN.Nama_BKH + '`' + ITEM_ISYTIHAR_I_KIBFG.Kod_Ikan + '`' + ITEM_ISYTIHAR_I_KIBFG.Destinasi_Pasar " & _
                      "+ '`' + CAST(ITEM_ISYTIHAR_I_KIBFG.PetiKecil AS varchar(20)) + '`' + CAST(ITEM_ISYTIHAR_I_KIBFG.KuantitiKecil AS varchar(20)) " & _
                      "+ '`' + CAST(ITEM_ISYTIHAR_I_KIBFG.PetiBesar AS varchar(20)) + '`' + CAST(ITEM_ISYTIHAR_I_KIBFG.KuantitiBesar AS varchar(20)) " & _
                      "+ '`' + CAST(ITEM_ISYTIHAR_I_KIBFG.Pek AS varchar(20)) + '`' + CAST(ITEM_ISYTIHAR_I_KIBFG.Ekor AS varchar(20)) " & _
                      "+ '`' + CAST(ITEM_ISYTIHAR_I_KIBFG.Nilai AS varchar(20)) + '`' + DESTINASI_PASAR.Nama_Pasar + '~' AS Data " & _
                      ...
                      "INNER JOIN JENIS_IKAN ON ITEM_ISYTIHAR_I_KIBFG.Kod_Ikan = JENIS_IKAN.Kod_Ikan " & _
                      "INNER JOIN DESTINASI_PASAR ON ITEM_ISYTIHAR_I_KIBFG.Destinasi_Pasar = DESTINASI_PASAR.Kod_Pasar " & _
                      "WHERE (ITEM_ISYTIHAR_I_KIBFG.Nombor_Barcode = '" & Request("barcode") & "')"
        ...
        If Simpan.Page.IsPostBack Then
            ...
            If NamaPemandu.Text <> "" And arrayVal.Value <> "" And arrayFishVal.Value <> "" And Barcodes.Text <> "" Then
                ...
                Else
                    ...
                    sqlText = "delete from ITEM_ISYTIHAR_I_KIBFG where [Nombor_Barcode]='" & rujukan.Text & "'"
                    ...
                    sqlText = "delete from PENGISYTIHARAN_I_KIBFG where [No_Barcode]='" & rujukan.Text & "'"
                    opClass.InsertData(sqlText)
                    ...
                    sqlText = "delete  from ITEM_ISYTIHAR_I_KIBFG where nombor_barcode='" + rujukan.Text + "'" & _
                              " and no_skpi not in (select no_skpi from PENGISYTIHARAN_I_KIBFG where no_barcode='" + rujukan.Text + "' )"
                    opClass.InsertData(sqlText)
                    ...
                    opClass.Proses_Pengisytiharan_kibfg(arrayVal.Value, Barcodes.Text, no_daftar, noKenderaan.Text, JenisUrusan.SelectedItem.Value, NamaPemandu.Text, cara_pengangkutan.SelectedItem.Value, Bekalan.SelectedItem.Value, KompleksPPI.SelectedItem.Value, OnlineSend_By.Value)


                    If (opClass.ErrorSignal = False) Then

                        'Commit All Processing For ITEM_ISYTIHAR_I_KIBFG and PENGISYTIHARAN_I_KIBFG
                        Dim idx As Integer
                        ...
                        sqlText = "SELECT * FROM NO_INVOIS WHERE No_Barcode = '" & rujukan.Text & "' order by bil_invois"
