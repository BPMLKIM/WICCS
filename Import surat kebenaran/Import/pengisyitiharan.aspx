...
function AddArray()
{
 ...
 //variable surat
    var licDate1 = strTemp2[4];
    var arrLicDate1 = licDate1.split("/");
    licDate1 = arrLicDate1[1]+"/"+arrLicDate1[0]+"/"+arrLicDate1[2];    
    var date1temp1 = new Date(licDate1 + " " + "00:00:00AM");
    ...
    date1temp1.setDate(date1temp1.getDate()+7);
    ...
    {
       input_box=confirm('Lesen Pengimport Telah Tamat Tempoh & Melebihi Hari Pelepasan Ditetapkan. Gunakan Surat Kebenaran Jika Ada. Tekan OK untuk YA atau CANCEL untuk Tidak.');                
            ...
            if (input_box==true)
                {
                    if (strTemp2[3]=="")
                        {
                            alert('Tiada Surat Kebenaran Sementara Bagi Pengimport ' + document.all.searchKodImporter.value); 
                        } 
                    else if (date1temp1 <=date2temp>0)
                        {
                            alert('Surat Kebenaran Sementara Telah Tamat Tempoh.');
                        }
                    else
                        {
                         ...
                         {    
                          ...
                          if (stat=="false")
                          {
                            ...
                            document.all.arrayVal.value = document.all.Importer.value + '`' +document.all.searchKodImporter.value + '`' + dataItem2.options.value +'`'+ dataItem3.options.value + '`' + document.all.Exporter.value + '`' +document.all.searchKodExporter.value +'~' + document.all.arrayVal.value;  
                        
                            var myString =document.all.Importer.value + '`' + document.all.searchKodImporter.value + '`' + dataItem2.options.value +'`'+ dataItem3.options.value + '`' + document.all.Exporter.value + '`' + document.all.searchKodExporter.value +'~';
    ...
    for (i=0;i<arrImporter.length-1; i++)
        {
	        ...
	        //-----------shah added---------------
	        oCell = newRow.insertCell();
	        oCell.innerHTML = arrImporterData[3];	
	        oCell = newRow.insertCell();
	        oCell.innerHTML = arrImporterData[4];	    
	        //-----------shah added end-----------
	        oCell = newRow.insertCell();
...
<%
    ...
    sqlText = "SELECT RTRIM(PENGIMPORT.Kod_Pengimport) as kodPengimport, RTRIM(PENGIMPORT.Kod_Pengimport) +'|'+ " & _
              ...
              "RTRIM(LESEN.No_Surat_Kebenaran) + '|'+ CAST(DAY(LESEN.Tarikh_Tamat_Surat) AS nvarchar(200)) " & _
              "+ '/'+ case when MONTH(LESEN.Tarikh_Tamat_Surat) < 10 then '0'+cast(month(lesen.tarikh_tamat_surat) as varchar(1)) else cast(month(lesen.tarikh_tamat_Surat) as varchar(2)) end   " & _
              "+ '/' + CAST(YEAR(LESEN.Tarikh_Tamat_surat) as nvarchar(4))AS Val," & _
...
<body >
  ...
  <table style="width: 100%">
    ...
    <tr> 
      ...
      <td style="height: 23px; font-weight: bold;" > <asp:TextBox ID="noKenderaan" runat="server" Width="93px" ReadOnly="True"></asp:TextBox></td>
  ...
  <Input style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1" id="Button2" onclick="AddFishArray();" type="button" value="Tambah" />
     ...
     <div class="scrollingdatagrid" style="width:100%;height:110px;">
        ...
        <asp:Label ID="Label8" runat="server" Font-Bold="True" Text="0" Width="82px"></asp:Label>
         &nbsp; &nbsp; &nbsp;&nbsp; <strong>Jumlah Peti Biru Kecil&nbsp; :
             <asp:TextBox ID="PetiBiruKecil" runat="server" Width="93px"></asp:TextBox>
             &nbsp; &nbsp; Jumlah Peti Biru Besar&nbsp; :&nbsp;
             <asp:TextBox ID="PetiBiruBesar" runat="server" Width="93px"></asp:TextBox></strong><br />
        &nbsp;
