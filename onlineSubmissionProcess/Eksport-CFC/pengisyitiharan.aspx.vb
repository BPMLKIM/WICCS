    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            sqlText = "SELECT PENDAFTARAN_PINTU.No_Kenderaan, AGEN_PENGANGKUTAN.Nama_Agen_Pengangkutan, PENDAFTARAN_PINTU.Kod_Jenis_Urusan, " & _
                      "TMP_PENDAFTARAN_PINTU.NamaPemandu,PENDAFTARAN_PINTU.[Nombor_Barcode],PENGISYTIHARAN_E.CARA_PENGANGKUTAN FROM  PENDAFTARAN_PINTU INNER JOIN " & _
            ...
            If arrayVal.Value <> "" And arrayFishVal.Value <> "" And Barcodes.Text <> "" Then
                ...
                Else
                    ...
                    If (opClass.ErrorSignalE = False) Then
                        ...
                        sqlText = "UPDATE SISTEM_Q Set status='Isytihar',Bil_SKPE='" & opClass.eSKPEArray.Count() & "',pegawai='" & Session("namaPegawai") & "' WHERE No_Barcode = '" & Trim(Barcodes.Text) & "'"
                        opClass.InsertData(sqlText)
    ...
    Protected Sub Button7_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button7.Click
        ...
        If sender.id = "Button7" Then
            ...
            Else
                ...
                opClass.ConfigureCrystalReportsSKPEPrint("rpt/crSKPE.rpt", formula)
                CrystalReportViewer1.ReportSource = opClass.crSKPE
                opClass.crSKPE.PrintOptions.PrinterName = namaPrinter
                opClass.crSKPE.PrintToPrinter(1, False, 0, 0)

                opClass.ConfigureCrystalReports_MSheet("rpt/crMasterSheetExport_Top.rpt", formula, Request("invois_id"), "SALINAN LKIM-BUKIT KAYU HITAM")
                CrystalReportViewer2.ReportSource = opClass.crMasterSheetEksport
                opClass.crMasterSheetEksport.PrintOptions.PrinterName = namaPrinter
                opClass.crMasterSheetEksport.PrintToPrinter(1, False, 0, 0)

                opClass.ConfigureCrystalReports_MSheet("rpt/crMasterSheetExport_Top.rpt", formula, Request("invois_id"), "SALINAN AGEN PENGANGKUTAN")
                CrystalReportViewer3.ReportSource = opClass.crMasterSheetEksport
                opClass.crMasterSheetEksport.PrintOptions.PrinterName = namaPrinter
                opClass.crMasterSheetEksport.PrintToPrinter(1, False, 0, 0)

                opClass.ConfigureCrystalReports_MSheet("rpt/crMasterSheetExport_Top.rpt", formula, Request("invois_id"), "SALINAN CFC")
                ...
                opClass.ConfigureCrystalReports_MSheet("rpt/crMasterSheetExport_Top.rpt", formula, Request("invois_id"), "SALINAN PENGUATKUASA")
