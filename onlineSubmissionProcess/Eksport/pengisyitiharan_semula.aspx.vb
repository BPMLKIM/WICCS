...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            sqlText = "SELECT   DISTINCT  PENGISYTIHARAN_E.Kod_Pengeksport + '|' + RTRIM(PENGEKSPORT.No_Lesen) + '|' + CASE WHEN DAY(LESEN.Tarikh_Tamat) " & _
                  ...
                  " + '`' + PENGIMPORT_THAILAND.Nama_Pengimport + '`' + NEGARA.Nama_Negara + '`' + PENGISYTIHARAN_E.No_Sijil + '`' + PENGISYTIHARAN_E.Destinasi_Negara_EU + '`' + PENGISYTIHARAN_E.NO_KONTENA + '`' + PENGISYTIHARAN_E.STATUS + '~' AS data, PENGISYTIHARAN_E.STATUS, PENGISYTIHARAN_E.KOD_URUSAN, JENIS_URUSAN.NAMA_URUSAN, PENGISYTIHARAN_E.ONLINESEND_BY " & _
                  ...
                  "INNER JOIN NEGARA ON PENGISYTIHARAN_E.DESTINASI_NEGARA_EU = NEGARA.KOD_NEGARA " & _
            ...
            sqlText = "SELECT PENGISYTIHARAN_E.Kod_Pengeksport + '`' + JENIS_IKAN.Kod_BKH + '`' + JENIS_IKAN.Nama_BKH + '`' + ITEM_ISYTIHAR_E.Kod_Ikan + '`' + PENGISYTIHARAN_E.Destinasi_Negara " & _
                      ...
                      "+ '`' + CAST(ITEM_ISYTIHAR_E.Nilai AS varchar(20)) + '`' + NEGARA.Nama_Negara  + '`' + CAST(ISNULL(ALL_KADAR_CAJ_Eksport.Kadar_Peti_Kecil,0) as varchar(20)) + '`' + Cast(ISNULL(ALL_KADAR_CAJ_Eksport.Kadar_Peti_Besar,0) as Varchar(20)) + '`' + Cast(ISNULL(ALL_KADAR_CAJ_Eksport.Kadar_Ekor,0) as Varchar(20)) + '`' + Cast(ISNULL(ALL_KADAR_CAJ_Eksport.Kadar_Kuantiti,0) as varchar(20)) + '`' + Cast(ISNULL(ITEM_ISYTIHAR_E.Caj_Ikan_ID,0) as varchar(20)) +'`'+ Cast(ISNULL(ITEM_ISYTIHAR_E.Caj,0) as varchar(100)) + '~' AS Data " & _
                      ...
                      "LEFT OUTER JOIN ALL_KADAR_CAJ_Eksport ON ALL_KADAR_CAJ_Eksport.ID = ITEM_ISYTIHAR_E.Caj_Ikan_ID " & _
            ...
            If arrayVal.Value <> "" And arrayFishVal.Value <> "" And Barcodes.Text <> "" Then
                ...
                Else
                    ...
                    sqlText = "INSERT INTO ITEM_ISYTIHAR_E_BATAL " & _
                              ...
                              "ITEM_ISYTIHAR_E.Site_Code, ITEM_ISYTIHAR_E.Caj_Ikan_Id, ITEM_ISYTIHAR_E.flag " & _
                    ...
                    "Destinasi_Negara, status, Nama_Pegawai, Transaction_Date, Nama_PemanduPindahan, No_KenderaanPindahan, Site_Code, OnlineSend_By, Kod_Urusan,destinasi_negara_eu,no_sijil,no_kontena, flag " & _
                    "FROM PENGISYTIHARAN_E " & _
                    ...
                    sqlText = "delete from PENGISYTIHARAN_E where [No_Barcode]='" & Barcodes.Text & "'"
                    opClass.InsertData(sqlText)
                    ...
                    sqlText = "delete  from item_isytihar_e where nombor_barcode='" + Barcodes.Text + "'" & _
                              " and no_skpe not in (select no_skpe from pengisytiharan_e where no_barcode='" + Barcodes.Text + "' )"
                    opClass.InsertData(sqlText)
