<%@ Page Language="VB" AutoEventWireup="false" CodeFile="pengisyitiharan_semula.aspx.vb" Inherits="Export_pengisyitiharan_semula" %>
...
function printReport(strCetak)
{
    ...
    var str ="../../eksport/eSKPe.aspx?barcode="+document.all.Barcodes.value+"&invois_id="+document.all.Invois_Id.value+"&cetak="+ strCetak +"&pname="+document.all.printer_name.value;
       ...
       //added by zuraini
        ...
        {   
            ...
            for(i=0;i<arrImporterInfoRow.length;i++)
            {
                ...
                if(arrImporterInfoCol[0] == document.all.Exporter.value)
                {
                                    stat="true";
...
function getExporterStatus(importerCode)
{
    ...
    for (i=0;i<arrImporter.length-1; i++)
        {
	        ...
	        var oCell = newRow.insertCell();	
	               ...
	               //alert("syah " + arrImporterInfoDetails[8]);
//    	    
//	        if (arrImporterInfoDetails[9].replace(/\s+$/,"")!="B")
//	        {
//	             oCell.innerHTML =""
//	        }
//	        else
       ...
       //if (urusan==1)//urusan
       {
           // alert("urusan bukan transit");
            ...
            for (i=0;i<arrImporter.length-1; i++)
            {
             ...
             // alert(document.all.arrayVal.value);
             var b= arrImporterDetails.split("|"); //a.split("|");
            }
            var searchItem1 = b[0];
            var foundeksport=0;
...
function refreshTableGridIkan()
{
    ...
    if (currImporter!="")
    {
        ...
        for (i=0;i<arrIkanInfo.length; i++)
        {
            ...
            {         	
       	        var exporterStatus = getExporterStatus(currImporter);
       	        //add a row to the rows collection and get a reference to the newly added row
...
{
 var strUrl="../../eksport/v_mastersheet.aspx";
...
<body>
        ...
        <table style="width: 100%">
            <tr>
                <td colspan="4" style="height: 18px; background-color:#0000cc;">
                    <strong>&nbsp;<span style="color: #ffffff">PENGISYTIHARAN SEMULA EKSPORT</span></strong></td>
            </tr>
            <tr>
                <td>
                </td>
    ...
    <table style="width: 100%">
        ...
        <tr>
         ...
         <table id="tblGridImporter" border="0" width="100%" >
          ...
          </div><table id="Table1" border="0" style="width: 100%;">
              <tr>
         ...
         <div><asp:HiddenField ID="arrayFishVal" runat="server" />
             ...
             <asp:HiddenField ID="arrayFishLarangan" runat="server" />
	...
	<!--end of edited by kmz for caj eksport -->
        ...
        <table style="width: 100%;FONT-SIZE: 8pt;FONT-FAMILY: Arial,Verdana, Tahoma; " border="0">
               <thead>
               <tr>
                <th style="width: 55px">
                    <strong>Kod BKH</strong></th>
                <th style="width:20%;">
        ...
        <input id="Button1" type="button" value="Tambah" style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1;" onclick="AddFishArray();"  />  
        ...
        <table id="tblGrid" border="0" style="width: 100%;">
            ...
            </div><table id="Table2" border="0" style="width: 100%;FONT-SIZE: 8pt;FONT-FAMILY: Arial,Verdana, Tahoma;">
                <thead>
                    <tr>
                        <th style="height: 17px; background-color: #ffffcc">
                        </th>
                        <th style="width: 20%; height: 17px; background-color: #ffffcc">
                        </th>
                        <th style="height: 17px; background-color: #ffffcc">
                        </th>
                        <th style="width: 15%; height: 17px; background-color: #ffffcc">
                        </th>
                        <th style="border-top-style: solid; border-top-color: teal; border-bottom: teal thin solid;
                            height: 17px; background-color: #ffffcc">
                    ...
                    <tr>
                        <th style="background-color:#f1f1f1;color:#f1f1f1">
                            Kod BKH</th>
                        <th  style="background-color:#f1f1f1;width: 20%">
                            </th>
                        <th style=" background-color:#f1f1f1;color:#f1f1f1">
                        ...
                        <th style="background-color:#f1f1f1;text-align: center;color:#f1f1f1">
                            Nilai (RM)</th>
                    </tr>
                </thead>
                <tbody>
        ...
        &nbsp;
        <hr /><input id="Button6" type="button" value="BARU" style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1;" onclick="location.href='../pintu_masuk/verifikasi_PintuMasuk.aspx';"  /><asp:Button ID="Simpan" runat="server" Text="SIMPAN" style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1;" OnClientClick="return pastiKanData();" /><input
             ...
             background-color: #f1f1f1" type="button" value="CETAK SKPI" /><input id="Button9"
                 ...
                 type="button" value="PAPAR CETAKKAN" /><input id="Button8" runat="server" onclick="showSenaraiprinter();" style="border-right: #333333 1px ridge;
                 padding-right: 1px; border-top: #ffffff 1px ridge; padding-left: 1px; font-size: 10px;
                 padding-bottom: 1px; border-left: #ffffff 1px ridge; color: #000000; padding-top: 1px;
                 border-bottom: #000000 1px ridge; font-family: MS Shell Dlg,verdana,??; background-color: #f1f1f1"
        ...
        <asp:SqlDataSource ID="JenisPengangkutan" runat="server" ConnectionString="<%$ ConnectionStrings:W-ICCS_Conn %>"
            SelectCommand="SELECT RTRIM([Kod_Cara_Pengangkutan]) as Kod_Pengangkutan, [Nama_Cara_Pengangkutan] as [Nama_Pengangkutan]  FROM [CARA_PENGANGKUTAN] where status ='yes'">
        </asp:SqlDataSource>
