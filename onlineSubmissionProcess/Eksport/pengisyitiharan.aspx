    ...
    <table style="width: 100%">
        ...
        <tr>
         ...
         <div><asp:HiddenField ID="arrayVal" runat="server" /><asp:HiddenField ID="arrayFishVal" runat="server" />
              ...
              <asp:HiddenField ID="CajMasuk" runat="server" /><asp:HiddenField ID="printer_name" runat="server" />
        ...
        <table id="Table2" border="0" style="width: 100%;">
            <tr>
                <td style="height: 18px; background-color: #ffffcc">
                </td>
                <td style="width: 20%; height: 18px; background-color: #ffffcc">
                </td>
                <td style="height: 18px; background-color: #ffffcc">
                </td>
                <td style="width: 15%; height: 18px; background-color: #ffffcc">
                </td>
                <td style="border-top-style: solid; border-top-color: teal; border-bottom: teal thin solid;
                    background-color: #ffffcc; height: 18px;">
            ...
            <tr>
                <td style="background-color:#f1f1f1; height: 30px;color:#f1f1f1">
                    <strong>Kod BKH</strong></td>
                <td  style="background-color:#f1f1f1;width: 20%; height: 30px;color:#f1f1f1">
                    <strong>Nama</strong></td>
                <td style=" background-color:#f1f1f1; height: 30px;color:#f1f1f1">
                    <div style="text-align:center">
                       <strong>Kod 8 Digit</strong></div>
                </td>
                <td style="background-color:#f1f1f1;width: 15%; height: 30px;color:#f1f1f1">
                    <div style="text-align:center">
                        <span ><strong>Destinasi</strong></span></div>
                </td>
                <td style="background-color:#f1f1f1; height: 30px;color:#f1f1f1">
                  <span><strong>Peti Kecil</strong></span></td>
              <td style="background-color:#f1f1f1; height: 30px;color:#f1f1f1">
              ...
              <td style="background-color:#f1f1f1; height: 30px;color:#f1f1f1" >
                ...
                <td style="background-color:#f1f1f1; height: 30px;color:#f1f1f1">
                    <div style=" text-align:center;">
                        <strong>Pek</strong></div>
                </td>
                <td style="background-color:#f1f1f1; height: 30px;color:#f1f1f1">
                    <div style=" text-align:center">
                        <strong>Ekor</strong></div>
                </td>
                <td style="background-color:#f1f1f1;text-align: center; height: 30px; color:#f1f1f1">
        ...
        <hr /><input id="Button6" type="button" value="BARU" style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1;" onclick="location.href='../pintu_masuk/verifikasi_PintuMasuk.aspx';"  /><asp:Button ID="Simpan" runat="server" Text="SIMPAN" style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1;" OnClientClick="return pastiKanData();" />
         <input id="Button10" runat="server" disabled="disabled" onclick="printReport('1');"
             ...
             background-color: #f1f1f1" type="button" value="CETAK SKPI" /><input id="Button9"
                 ...
                 type="button" value="PAPAR CETAKKAN" /><input runat="server" id="Button8" onclick="showSenaraiprinter();" style="border-right: #333333 1px ridge;
                 padding-right: 1px; border-top: #ffffff 1px ridge; padding-left: 1px; font-size: 10px;
                 padding-bottom: 1px; border-left: #ffffff 1px ridge; color: #000000; padding-top: 1px;
                 border-bottom: #000000 1px ridge; font-family: MS Shell Dlg,verdana,??; background-color: #f1f1f1"
        ...
        <asp:SqlDataSource ID="Destinasi" runat="server" ConnectionString="<%$ ConnectionStrings:W-ICCS_Conn %>"
         ...
         <asp:SqlDataSource ID="Urusan" runat="server" ConnectionString="<%$ ConnectionStrings:W-ICCS_Conn %>"
             SelectCommand="SELECT [Kod_Urusan], [Nama_Urusan] FROM [JENIS_URUSAN] WHERE KOD_URUSAN IN('018','003')">
         </asp:SqlDataSource>
