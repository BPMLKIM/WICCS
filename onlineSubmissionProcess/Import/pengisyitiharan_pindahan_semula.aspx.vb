...
Partial Class Import_pengisyitiharan_psemula
...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            'Query TMP_PENDAFTARAN PINTU
            'sqlText = "SELECT PENDAFTARAN_PINTU.No_Kenderaan, AGEN_PENGANGKUTAN.Nama_Agen_Pengangkutan, PENDAFTARAN_PINTU.Kod_Jenis_Urusan, " & _
            '          "PENDAFTARAN_PINTU.Nama_Pemandu,PENDAFTARAN_PINTU.[Nombor_Barcode],Pendaftaran_Pintu.Caj_Masuk FROM  PENDAFTARAN_PINTU INNER JOIN " & _
            '          "INNER JOIN JENIS_URUSAN ON Pendaftaran_Pintu.Kod_Jenis_Urusan = JENIS_URUSAN.Kod_Urusan " & _
            '          "INNER JOIN AGEN_PENGANGKUTAN ON PENDAFTARAN_PINTU.Kod_Agen_Pengangkutan = AGEN_PENGANGKUTAN.Kod_Agen_Pengangkutan " & _
            '          "WHERE PENDAFTARAN_PINTU.[Tmp_Barcode]='" & Barcodes.Text & "'"
            ' Response.Write(sqlText)
            sqlText = "SELECT PENDAFTARAN_PINTU.No_Kenderaan, AGEN_PENGANGKUTAN.Nama_Agen_Pengangkutan, PENDAFTARAN_PINTU.Kod_Jenis_Urusan, " & _
                     "PENDAFTARAN_PINTU.[Tmp_Barcode],Pendaftaran_Pintu.Caj_Masuk FROM  PENDAFTARAN_PINTU " & _
                     "INNER JOIN JENIS_URUSAN ON Pendaftaran_Pintu.Kod_Jenis_Urusan = JENIS_URUSAN.Kod_Urusan " & _
                     "INNER JOIN AGEN_PENGANGKUTAN ON PENDAFTARAN_PINTU.Kod_Agen_Pengangkutan = AGEN_PENGANGKUTAN.Kod_Agen_Pengangkutan " & _
            ...
            sqlText = "SELECT RTRIM(PENGISYTIHARAN_I.Kod_Pengimport) + '|' + RTRIM(PENGIMPORT.No_Lesen) + '|' + " & _
                      ...
                      "+ '`' + PENGEKSPORT_THAILAND.Nama_Pengeksport +'`'+ PENGISYTIHARAN_I.Nama_PemanduPindahan+ '`'+ PENGISYTIHARAN_I.No_KenderaanPindahan + '`' + PENGISYTIHARAN_I.STATUS + '~'" & _
                      " AS data, PENGISYTIHARAN_I.STATUS, PENGISYTIHARAN_I.KOD_URUSAN,PENGISYTIHARAN_I.ONLINESEND_BY, PENGISYTIHARAN_I.Nama_Pemandu,PENGISYTIHARAN_I.PETI_BIRU_KECIL,PENGISYTIHARAN_I.PETI_BIRU_BESAR" & _
            ...
            If sqlRead.HasRows Then
                Do While sqlRead.Read()
                    ...
                    NamaPemandu.Text = sqlRead.GetValue(4)
                    PetiBiruKecil.Text = sqlRead.GetValue(5)
                    PetiBiruBesar.Text = sqlRead.GetValue(6)
            ...
            sqlRead = opClass.DataReader(sqlprint)

            If sqlRead.HasRows Then

                sqlRead.Read()
                printer_name.Value = sqlRead("printer_name")
            ...
            If NamaPemandu.Text <> "" And arrayVal.Value <> "" And arrayFishVal.Value <> "" And Barcodes.Text <> "" Then
                ...
                Else
                    ...
                    sqlText = "INSERT INTO ITEM_ISYTIHAR_I_BATAL " & _
                              ...
                              "FROM ITEM_ISYTIHAR_I INNER JOIN " & _
                              "PENGISYTIHARAN_I ON ITEM_ISYTIHAR_I.No_SKPI = PENGISYTIHARAN_I.No_SKPI " & _
                              "WHERE (PENGISYTIHARAN_I.No_Barcode = '" & Barcodes.Text & "') AND (PENGISYTIHARAN_I.Status = 'B')"
                    ...
                    sqlText = "INSERT INTO PENGISYTIHARAN_I_BATAL " & _
                              ...
                              "Sumber_Bekalan, Status, Nama_Pegawai, Transaction_Date, Nama_PemanduPindahan, No_KenderaanPindahan, Site_Code, OnlineSend_By," & _
                    ...
                    opClass.Generate_eSKPI_SemulaPindahan(arrayVal.Value, Barcodes.Text, KompleksPPI.SelectedItem.Value, arrayFishVal.Value)
