...
Partial Class Import_pengisyitiharan_p
...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            'Query TMP_PENDAFTARAN PINTU
            sqlText = "SELECT PENDAFTARAN_PINTU.No_Kenderaan, AGEN_PENGANGKUTAN.Nama_Agen_Pengangkutan, PENDAFTARAN_PINTU.Kod_Jenis_Urusan, " & _
                      "TMP_PENDAFTARAN_PINTU.NamaPemandu,PENDAFTARAN_PINTU.[Nombor_Barcode],Pendaftaran_Pintu.Caj_Masuk FROM  PENDAFTARAN_PINTU INNER JOIN " & _
                      "TMP_PENDAFTARAN_PINTU ON PENDAFTARAN_PINTU.Tmp_Barcode = TMP_PENDAFTARAN_PINTU.Nombor_Barcode " & _
            ...
            If sqlRead.HasRows Then
                ...
                noKenderaan.Text = sqlRead.GetValue(0)
                strJenisUrusan = sqlRead.GetValue(2)
                JenisUrusanLama.Value = strJenisUrusan
                NamaAgen.Text = sqlRead.GetValue(1)
                NamaPemandu.Text = sqlRead.GetValue(3)
                Barcodes.Text = sqlRead.GetValue(4)
                CajMasuk.Value = sqlRead.GetValue(5)
            End If
            sqlRead.Close()
            sqlRead = Nothing
            ...
            sqlText = "SELECT RTRIM(PENGISYTIHARAN_I.Kod_Pengimport) + '|' + RTRIM(PENGIMPORT.No_Lesen) + '|' + " & _
                      ...
                      " AS data, PENGISYTIHARAN_I.STATUS, PENGISYTIHARAN_I.KOD_URUSAN,PENGISYTIHARAN_I.ONLINESEND_BY,PENGISYTIHARAN_I.PETI_BIRU_KECIL,PENGISYTIHARAN_I.PETI_BIRU_BESAR " & _
            ...
            If sqlRead.HasRows Then
                Do While sqlRead.Read()
                    ...
                    PetiBiruKecil.Text = sqlRead.GetValue(4)
                    PetiBiruBesar.Text = sqlRead.GetValue(5)
        ...
        nama_pemandu_pindahan.Attributes.Add("onKeyPress", "return keyToUpperCase(this, event);")
        no_kenderaan_pindahan.Attributes.Add("onKeyPress", "return keyToUpperCase(this, event);")
    ...
    Protected Sub Button7_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button7.Click
        ...
        If sender.id = "Button7" Then
            ...
            If printer_name.Value = "" Then
                Response.Write("<script>alert('Sila pilih printer dahulu');history.go(-1);</script>")

            Else

                Dim formula As String = "{PENGISYTIHARAN_I.No_Barcode} = '" & Barcodes.Text & "' AND {PENGISYTIHARAN_I.Status} = 'A'"
                'Response.Write(printer_name.Value)

                Dim namaPrinter As String = printer_name.Value '"KONICA MINOLTA 7145/IP-432" '
                If namaPrinter <> "" Then
                    namaPrinter = namaPrinter.Replace("/", "\")
                End If

                opClass.ConfigureCrystalReportsSKPIPrint("rpt/crSKPI-P.rpt", formula)
                ...
                opClass.ConfigureCrystalReports_MSheet("rpt/crMasterSheetImport_Top.rpt", formula, Invois_Id.Value, "SALINAN LKIM-BUKIT KAYU HITAM")
                ...
                opClass.ConfigureCrystalReports_MSheet("rpt/crMasterSheetImport_Top.rpt", formula, Invois_Id.Value, "SALINAN AGEN PENGANGKUTAN")
                CrystalReportViewer3.ReportSource = opClass.crMasterSheetImport
                opClass.crMasterSheetImport.PrintOptions.PrinterName = namaPrinter
                opClass.crMasterSheetImport.PrintToPrinter(1, False, 0, 0)

                opClass.ConfigureCrystalReports_MSheet("rpt/crMasterSheetImport_Top.rpt", formula, Invois_Id.Value, "SALINAN CFC")
                ...
                opClass.ConfigureCrystalReports_MSheet("rpt/crMasterSheetImport_Top.rpt", formula, Invois_Id.Value, "SALINAN PENGUATKUASA")
