...
Partial Class Import_pengisyitiharan
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            sqlText = "SELECT PENDAFTARAN_PINTU.No_Kenderaan, AGEN_PENGANGKUTAN.Nama_Agen_Pengangkutan, PENDAFTARAN_PINTU.Kod_Jenis_Urusan, " & _
                      "TMP_PENDAFTARAN_PINTU.NamaPemandu,PENDAFTARAN_PINTU.[Nombor_Barcode],Pendaftaran_Pintu.Caj_Masuk,PENGISYTIHARAN_I.CARA_PENGANGKUTAN,JENIS_URUSAN.NAMA_URUSAN FROM  PENDAFTARAN_PINTU INNER JOIN " & _
            ...
            If sqlRead.HasRows Then
                ...
                JenisUrusanLama.Value = sqlRead.GetValue(7)
                ...
                strKodKenderaan = sqlRead.GetValue(6)
            End If
            sqlRead.Close()
            sqlRead = Nothing
            ...
            sqlText = "SELECT DISTINCT RTRIM(PENGISYTIHARAN_I.Kod_Pengimport) + '|' + RTRIM(PENGIMPORT.No_Lesen) + '|' + " & _
                      ...
                      " AS data, PENGISYTIHARAN_I.STATUS, PENGISYTIHARAN_I.KOD_URUSAN,JENIS_URUSAN.NAMA_URUSAN,PENGISYTIHARAN_I.ONLINESEND_BY,PENGISYTIHARAN_I.PETI_BIRU_KECIL,PENGISYTIHARAN_I.PETI_BIRU_BESAR " & _
            ...
            sqlText = "SELECT     PENGISYTIHARAN_I.Kod_Pengimport + '`' + JENIS_IKAN.Kod_BKH + '`' + JENIS_IKAN.Nama_BKH + '`' + ITEM_ISYTIHAR_I.Kod_Ikan + '`' + ITEM_ISYTIHAR_I.Destinasi_Pasar " & _
                      ...
                      "+ '`' + CAST(ITEM_ISYTIHAR_I.Nilai AS varchar(20)) + '`' + DESTINASI_PASAR.Nama_Pasar + '`' + CAST(ISNULL(ALL_KADAR_CAJ.Kadar_Peti_Kecil,0) as varchar(20)) + '`' + Cast(ISNULL(ALL_KADAR_CAJ.Kadar_Peti_Besar,0) as Varchar(20)) + '`' + Cast(ISNULL(ALL_KADAR_CAJ.Kadar_Ekor,0) as Varchar(20)) + '`' + Cast(ISNULL(ALL_KADAR_CAJ.Kadar_Kuantiti,0) as varchar(20)) + '`' + Cast(ITEM_ISYTIHAR_I.Caj_Ikan_ID as varchar(20)) +'`'+ Cast(ITEM_ISYTIHAR_I.Caj as varchar(100)) + '~' AS Data " & _
