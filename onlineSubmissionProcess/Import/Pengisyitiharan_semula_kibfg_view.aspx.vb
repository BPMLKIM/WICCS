...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            sqlText = "SELECT DISTINCT RTRIM(PENGISYTIHARAN_I_KIBFG.Kod_Pengimport) + '|' + RTRIM(PENGIMPORT.No_Lesen) + '|' + " & _
                      ...
                      "+ '`' + PENGEKSPORT_THAILAND.Nama_Pengeksport + '`' + PENGISYTIHARAN_I_KIBFG.Peti_Biru_Kecil + '`'+ PENGISYTIHARAN_I_KIBFG.Peti_Biru_Besar + '`'+ PENGISYTIHARAN_I_KIBFG.Status +'~'" & _
            ...
            '          "+ '`' + CAST(ITEM_ISYTIHAR_I_KIBFG.Nilai AS varchar(20)) + '`' + DESTINASI_PASAR.Nama_Pasar + '`' + CAST(ISNULL(ALL_KADAR_CAJ.Kadar_Peti_Kecil,0) as varchar(20)) + '`' + Cast(ISNULL(ALL_KADAR_CAJ.Kadar_Peti_Besar,0) as Varchar(20)) + '`' + Cast(ISNULL(ALL_KADAR_CAJ.Kadar_Ekor,0) as Varchar(20)) + '`' + Cast(ISNULL(ALL_KADAR_CAJ.Kadar_Kuantiti,0) as varchar(20)) + '`' + Cast(ISNULL(ITEM_ISYTIHAR_I_KIBFG.Caj_Ikan_ID,0) as varchar(20)) +'`'+ Cast(ISNULL(ITEM_ISYTIHAR_I_KIBFG.Caj,0) as varchar(100)) + '~' AS Data " & _
            ...
            '          "LEFT OUTER JOIN ALL_KADAR_CAJ ON ALL_KADAR_CAJ.ID = ITEM_ISYTIHAR_I_KIBFG.Caj_Ikan_ID " & _
            '          "WHERE (ITEM_ISYTIHAR_I_KIBFG.Nombor_Barcode = '" & Barcodes.Text & "')"
            ...
            If NamaPemandu.Text <> "" And arrayVal.Value <> "" And arrayFishVal.Value <> "" And Barcodes.Text <> "" Then
                ...
                Else
                    ...
                    sqlText = "INSERT INTO PENGISYTIHARAN_I_KIBFG_BATAL " & _
                              ...
                              "Kod_Urusan, Kod_CajIkan_ID, Nama_Pemandu,Peti_Biru_Kecil, Peti_Biru_Besar, No_Rujukan_Skpi FROM PENGISYTIHARAN_I_KIBFG " & _
    ...
    Protected Sub Keluar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Keluar.Click
        Response.Redirect("../import/verifikasi_rebat.aspx")
    End Sub
