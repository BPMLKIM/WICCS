        ...
        <table style="width: 100%">
            <tr>
                <td colspan="4" style="height: 18px; background-color:#0000cc;">
                    <strong>&nbsp;<span style="color: #ffffff">PENGISYTIHARAN <%=namaJenisUrusan.ToUpper()%></span></strong></td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="height: 23px; width: 289px;" >
                    <strong>No. /Nama Kapal/Penerbangan/Kenderaan</strong></td>
                <td style="height: 23px; font-weight: bold; width: 337px;" >
            ...
            <tr >
                <td style="font-weight: bold; width: 289px;">
    ...
    <table style="width: 100%">
        ...
        <tr>
         ...
         <table id="tblGridImporter" border="0" width="100%">
          ...
          </table></div><table id="Table1" border="0" style="width: 98.7%">
              <tr>
        ...
        <table style="width: 100%; border-top-width: thin; border-left-width: thin; border-bottom-width: thin; border-right-width: thin;" border="0">
              ...
              <td style="height: 15px; text-align: center; color: black;">
                  <strong>Kuantiti<br />Kecil (kg)</strong></td>
              <td style="height: 15px; text-align: center;">
