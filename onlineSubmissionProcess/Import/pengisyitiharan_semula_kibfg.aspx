<%@ Page Language="VB" AutoEventWireup="false" CodeFile="pengisyitiharan_semula_KIBFG.aspx.vb" Inherits="Import_pengisyitiharan_semula_KIBFG" %>
...
<head runat="server">
    <title>[WICCS]-Pengisytiharan Rebat <%=namaJenisUrusan%></title>
...
function newForm()
{
    ...
    if (input_box==true) 
    {
         location.href='../../onlineSubmissionProcess/import/verifikasi_rebat.aspx';    
    }    
}
...
function resetForms()
{
    ...
    location.href="pengisyitiharan_semula_kibfg.aspx?barcode="+document.all.Barcodes.value;
}
    ...
    for (i=0;i<arrImporter.length-1; i++)
        {
            ...
            //-----------------------------------------shah
               kotakkecil = kotakkecil + parseFloat(arrImporterInfoDetails[6]);
               kotakbesar = kotakbesar + parseFloat(arrImporterInfoDetails[7]);
           //---------------------------------------
	        ...
	        //newRow.bgColor="#c9cc99";
	        var oCell = newRow.insertCell();		        
    	    //alert(arrImporterInfoDetails[6]);
	        //if (arrImporterInfoDetails[6].replace(/\s+$/,"")!="B")
	       // {
	         //   oCell.innerHTML = "";
	       // }
	        //else
        ...
        //shah
        document.all.Label8.innerHTML= kotakkecil ;
        document.all.Label1.innerHTML= kotakbesar ;
        //shah
}
...
function AddFishArray()
{
    ...
    //Checking whether importer have to isytihar semula or not
    var strImporterInfo = document.all.arrayVal.value;
    if (strImporterInfo!="")
    {    
            //Validate Importer Already Exist Or Not    
            ...
            for(i=0;i<arrImporterInfoRow.length;i++)
            {
                var strImporterInfoRow = arrImporterInfoRow[i];
                var arrImporterInfoCol = strImporterInfoRow.split("`");
                if(arrImporterInfoCol[0] == document.all.currentImporter.value)
                {
                    stat="true";
                }        
            } 
...
//    //for (i=0;i<arrTempDetailsIkan.length;i++)
//   // {
//    document.all.Kod_BKH.value=arrTempIkanInfo[1];
//    document.all.Nama_Ikan.value=arrTempIkanInfo[2];
//    document.all.Kod8_Digit.value=arrTempIkanInfo[3];
//    document.all.Destination.options[document.all.Destination.selectedIndex].text=arrTempIkanInfo[12];
//    document.all.txtPetiKecil.value=arrTempIkanInfo[5];
//    document.all.txtKuantitiKecil.value=arrTempIkanInfo[6];
//    document.all.txtPetiBesar.value=arrTempIkanInfo[7];
//    document.all.txtKuantitiBesar.value=arrTempIkanInfo[8];
//    document.all.txtPek.value=arrTempIkanInfo[9];
//    document.all.txtEkor.value=arrTempIkanInfo[10];
//    //document.all.txtNilai.value=arrTempIkanInfo[11];    
//    document.all.txtJumlahNilai.value=arrTempIkanInfo[11];
//   
// // }      //shah
    ...
    if (currImporter!="")
    {
        ...
        for (i=0;i<arrIkanInfo.length; i++)
        {
            ...
            {         	
                ...
                var oCell = newRow.insertCell();
                //alert(arrIkanInfoDetails[19]);
                //alert(currImporter + "="+ importerStatus);
                //if (importerStatus=="B")
	            //{
...
//    {
       ...
       if (found==0)               
       {
           ...
           { 
                ...
                window.open('../../import/Senarai-Importer.aspx','SECURITY','scrollbars=yes,status=1,toolbar=no,personalbar=no,menubar=no,locationbar=no,resizable=no,width=380, height=420,top=100,left=70');               
           }
           else
           {
...
//    {
       ...
       if (found==0)               
       {
           ...
           { 
                // Output when OK is clicked                
                window.open('../../import/Senarai-Exporter.aspx','SenaraAgen','scrollbars=yes,status=1,toolbar=no,personalbar=no,menubar=no,locationbar=no,resizable=no,width=380, height=420,top=100,left=70');               
           }
           else
           {
                // Output when Cancel is clicked
...
<body>
     <form id="form1" runat="server">
        ...
        <table style="width: 100%">
            <tr>
                <td colspan="4" style="height: 18px; background-color:#ffccff;">
                    <strong>&nbsp;<span style="color: black">PENGISYTIHARAN REBAT KIBFG&nbsp;<%=namaJenisUrusan.ToUpper()%></span></strong></td>
            </tr>
            <tr>
                <td>
                </td>
            ...
            <tr>
                ...
                <td style="width: 227px" >
                    <asp:TextBox ID="rujukan" runat="server" Width="156px" ReadOnly="True"></asp:TextBox></td>
            </tr>
            <tr>
                <td >
            ...
            <tr>
                ...
                <td style="height: 23px; font-weight: bold;" >
                Jenis Urusan</td>
                <td style="height: 23px; font-weight: bold; width: 227px;" >
    ...
    <table style="width: 100%">
        ...
        <tr>
         ...
         <asp:TextBox ID="PetiBiruBesar" runat="server" Width="93px">0</asp:TextBox><strong>&nbsp;</strong><br />
         <br />
        <%-- <input id="Button3" type="button" value="Tambah" style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1;" onclick="AddArray();refreshTableGridIkan();"  />--%>
         <input id="Button3" type="button" value="Tambah" style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1;" onclick="AddArray();"  />
         ...
         <table id="tblGridImporter" border="0" width="100%">
             ...
             <tr>
                 ...
                 <th style="background-color:#f1f1f1; width:15%; height:22px">
                     No. Lesen</th>
                 <th style="background-color:#f1f1f1; width:11%; height:22px">
                     Tarikh Luput</th>
                 <th style="background-color:#f1f1f1; width:17%; height:22px">
                     Pengeksport</th>
                 <th style="background-color:#f1f1f1; width:11%; height:22px">
                     Bil. Peti Biru Kecil</th>
                 <th style="background-color:#f1f1f1; width:9%; height:22px">
         ...
         &nbsp; &nbsp; &nbsp; &nbsp; <strong>Jumlah Peti Biru Besar :</strong>
         <asp:Label ID="Label1" runat="server" Font-Bold="True" Text="0" Width="82px"></asp:Label>
         &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;<br />
         &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
         &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
         &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
        ...
        <div class="scrollingdatagrid" style="width:100%;height:110px;left: 0px; top: 0px;">
         <table id="tblGrid" border="0" width="100%">
            <thead >
            <tr>
                ...
                <th style="background-color:#f1f1f1; text-align: center;">Peti<br />Kecil</th>
                <th style="background-color:#f1f1f1; text-align: center;">Kuantiti<br />Kecil (kg)</th>
                <th style="background-color:#f1f1f1; text-align: center;">Peti<br />Besar</th>
                <th style="background-color:#f1f1f1; text-align: center;">Kuantiti<br />Besar (kg)</th>
                <th style="background-color:#f1f1f1; ">
            ...
            <table id="Table2" border="0" style="width: 100%;">
            <tr>
                ...
                <td style="width: 15%; background-color: #ffffcc">
                </td>
                ...
                <td style="background-color: #ffffcc; border-top-style: solid; border-top-color: teal; border-bottom: teal thin solid; width: 64px;">
                    <asp:Label ID="Label7" runat="server" Width="100%">0</asp:Label></td>
            </tr>
            <tr>
                <td style="background-color:#f1f1f1; color: #f1f1f1;">
                    Kod BKH</td>
                <td style="background-color:#f1f1f1;width: 20%;color: #f1f1f1;">
                    Nama</td>
                <td style=" background-color:#f1f1f1;">
                    <div style="text-align:center; color: #f1f1f1;">
                        Kod 8 Digit</div>
                </td>
                <td style="background-color:#f1f1f1;width: 15%;">
                    <div style="text-align:center">
                        <span style="color: #f1f1f1">Destinasi</span></div>
                </td>
                <td style="background-color:#f1f1f1;text-align: center; color: #f1f1f1;">
                    Peti<br />
                    Kecil</td>
                <td style="background-color:#f1f1f1;text-align: center; color: #f1f1f1;">
                    Kuantiti<br />
                ...
                <td style="background-color:#f1f1f1;text-align: center;color: #f1f1f1; width: 64px;">
                    Nilai (RM)</td>
            </tr>
        </table>
        ...
        <hr />
         <input id="Button6" onclick="newForm();" style="border-right: #333333 1px ridge;
             ...
             background-color: #f1f1f1" type="button" value="PAPAR MASTERSHEET" />--%><asp:Button ID="Simpan" runat="server" Text="SIMPAN" style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1;" OnClientClick="return pastiKanData();" /><input
                 ...
                 padding-bottom: 1px; border-left: #ffffff 1px ridge; color: #000000; padding-top: 1px;
                 border-bottom: #000000 1px ridge; font-family: MS Shell Dlg,verdana,??; background-color: #f1f1f1"
                 type="button" value="CETAK SLIP REBAT" /><input id="Button5" runat="server" disabled="disabled"
                     onclick="printReport('0');" style="border-right: #333333 1px ridge; padding-right: 1px;
         ...
         <input id="Button1" runat="server" onclick="showSenaraiprinter();" style="border-right: #333333 1px ridge;
             padding-right: 1px; border-top: #ffffff 1px ridge; padding-left: 1px; font-size: 10px;
             padding-bottom: 1px; border-left: #ffffff 1px ridge; color: #000000; padding-top: 1px;
             border-bottom: #000000 1px ridge; font-family: MS Shell Dlg,verdana,??; background-color: #f1f1f1"
             type="button" value="PILIH PRINTER" disabled="disabled" /><asp:Button
                 ID="Keluar" runat="server" Style="border-right: #333333 1px ridge; padding-right: 1px;
                 border-top: #ffffff 1px ridge; padding-left: 1px; font-size: 10px; padding-bottom: 1px;
                 border-left: #ffffff 1px ridge; color: #000000; padding-top: 1px; border-bottom: #000000 1px ridge;
                 font-family: MS Shell Dlg,verdana,??; background-color: #f1f1f1" Text="KELUAR" />&nbsp;<br />
        <br />
        <br />
        <br />
         <CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" AutoDataBind="true"  Visible="False"/> 
         <CR:CrystalReportViewer ID="CrystalReportViewer2" runat="server" AutoDataBind="true"  Visible="False"/>
         <CR:CrystalReportViewer ID="CrystalReportViewer3" runat="server" AutoDataBind="true"  Visible="False"/>
         <CR:CrystalReportViewer ID="CrystalReportViewer4" runat="server" AutoDataBind="true"  Visible="False"/>
         <CR:CrystalReportViewer ID="CrystalReportViewer5" runat="server" AutoDataBind="true"  Visible="False"/>
         &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;
                &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;
                 &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;
         &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;
        ...
        <asp:SqlDataSource ID="Destinasi" runat="server" ConnectionString="<%$ ConnectionStrings:W-ICCS_Conn %>"
         ...
         <asp:SqlDataSource ID="Urusan" runat="server" ConnectionString="<%$ ConnectionStrings:W-ICCS_Conn %>"
             SelectCommand="SELECT [Kod_Urusan], [Nama_Urusan] FROM [JENIS_URUSAN] WHERE [Kod_Urusan] Not In('003','017','018','019','007','008','020','009') order by [Nama_Urusan] asc ">
         </asp:SqlDataSource>
