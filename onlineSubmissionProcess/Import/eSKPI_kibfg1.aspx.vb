...
Partial Class _Default_kibfg1
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim formula As String = "{PENGISYTIHARAN_I_KIBFG.No_Barcode} = '" & Request("barcode") & "' AND {PENGISYTIHARAN_I_KIBFG.Status} = 'A'" '  and {PENGISYTIHARAN_I.No_SKPI} = '" & Request("skpi") & "'"
