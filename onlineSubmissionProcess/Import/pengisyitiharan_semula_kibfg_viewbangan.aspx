<%@ Page Language="VB" AutoEventWireup="false" CodeFile="pengisyitiharan_semula_kibfg_viewbangan.aspx.vb" Inherits="Import_pengisyitiharan_semula_KIBFG_view" %>
...
<body>
        ...
        <table style="width: 100%">
            <tr>
                <td colspan="4" style="height: 18px; background-color:#ffccff;">
                    <strong>&nbsp;<span style="color: black">PENGISYTIHARAN REBAT KIBFG
    ...
    </table> <input id="Button3" type="button" value="Tambah" style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1;"   />
    ...
    &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<strong>Jumlah Peti Biru Kecil&nbsp; :
         ...
         <asp:TextBox ID="PetiBiruBesar" runat="server" Width="93px"></asp:TextBox><strong>&nbsp;</strong><br />
        &nbsp;
