<%@ Page Language="VB" AutoEventWireup="false" CodeFile="pengisyitiharan_semula_KIBFG_view.aspx.vb" Inherits="Import_pengisyitiharan_semula_KIBFG_view" %>
   ...
   // var dataItem4 = document.all.Exporter;
    ...
    else
    {
        ...
        if (stat=="false")
        {
            ...
            document.all.arrayVal.value = document.all.Importer.value + '`' +document.all.searchKodImporter.value + '`' + dataItem2.options.value +'`'+ dataItem3.options.value + '`' + document.all.Exporter.value + '`'+ document.all.searchKodExporter.value +'`'+ document.all.PetiBiruKecil.value + '`' + document.all.PetiBiruBesar.value + '`' + "A" + '~' + document.all.arrayVal.value;
            
                 //  alert("shah" +      document.all.arrayVal.value);
            var myString =document.all.Importer.value + '`' + document.all.searchKodImporter.value + '`' + dataItem2.options.value +'`'+ dataItem3.options.value + '`' + document.all.Exporter.value + '`' + document.all.searchKodExporter.value + '`'+ document.all.PetiBiruKecil.value + '`' + document.all.PetiBiruBesar.value + '`' + "A" + '~';
...
<body>
        ...
        <table style="width: 100%">
            <tr>
                <td colspan="4" style="height: 18px; background-color:#ffccff;">
                    <strong>&nbsp;<span style="color: black">PENGISYTIHARAN SEMULA REBAT KIBFG 
    ...
    <table style="width: 100%">
        ...
        <tr>
         ...
         <table id="tblGridImporter" border="0" width="100%">
             ...
             <tr>
                 <th style="background-color:#f1f1f1; width:7%">
                     No.</th>
                 <th style="background-color:#f1f1f1; width:18%; height:22px">
                     Pengimport</th>
         ...
         &nbsp; <strong>Jumlah Peti Biru Kecil :</strong>
         <asp:Label ID="Label8" runat="server" Font-Bold="True" Text="0" Width="82px"></asp:Label><strong>
             &nbsp; </strong>&nbsp; <strong>Jumlah Peti Biru Besar :</strong>
