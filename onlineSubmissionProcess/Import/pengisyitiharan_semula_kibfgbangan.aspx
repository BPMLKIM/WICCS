<%@ Page Language="VB" AutoEventWireup="false" CodeFile="pengisyitiharan_semula_kibfgbangan.aspx.vb" Inherits="Import_pengisyitiharan_semula_KIBFG" %>
...
<body>
    ...
    <table style="width: 100%">
        ...
        <tr>
         ...
         <asp:TextBox ID="PetiBiruKecil" runat="server" Width="93px" />
         &nbsp; &nbsp;<strong >Jumlah Peti Biru Besar&nbsp; :</strong>&nbsp;
         <asp:TextBox id="PetiBiruBesar" runat="server" Width="93px" /><strong >&nbsp;</strong><br />
         <input id="Button3" type="button" value="Tambah" style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1;" onclick="AddArray();refreshTableGridImporter();"/>
         ...
         <table id="tblGridImporter" border="0" width="100%">
             ...
             <tr>
                 ...
                 <th style="background-color:#f1f1f1; width:15%; height:22px">
                     Tarikh Luput</th>
                 <th style="background-color:#f1f1f1; width:19%; height:22px">
                     Pengeksport</th>
