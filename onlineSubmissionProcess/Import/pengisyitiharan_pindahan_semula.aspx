<%@ Page Language="VB" AutoEventWireup="false" CodeFile="pengisyitiharan_pindahan_semula.aspx.vb" Inherits="Import_pengisyitiharan_psemula" %>
    ...
    for (i=0;i<arrImporter.length-1; i++)
        {
	       ...
	       // if (arrImporterInfoDetails[8].replace(/\s+$/,"")=="B")
	       // {
	       //     oCell.innerHTML = "";
	       // }
	       // else
...
function getImporterStatus(importerCode)
{
    ...
    for (i=0;i<arrImporter.length-1; i++)
    {
            ...
            {
                skpiStatus=arrImporterInfoDetails[8].replace(/\s+$/,"");                
                break;     
            }
        ...
        <table style="width: 100%">
            <tr>
                <td colspan="4" style="height: 18px; background-color:#0000cc;">
                    <strong>&nbsp;<span style="color: #ffffff">PENGISYTIHARAN SEMULA PINDAHAN BARANGAN</span></strong></td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="height: 23px; width: 267px;" >
                    <strong>No. /Nama Kapal/Penerbangan/Kenderaan</strong></td>
                <td style="height: 23px; font-weight: bold; width: 261px;" >
                    <asp:TextBox ID="noKenderaan" runat="server" Width="256px" ReadOnly="True"></asp:TextBox></td>
                <td style="height: 23px; font-weight: bold; width: 119px;" >
                &nbsp;Jenis Urusan</td>
                <td style="height: 23px; font-weight: bold; width: 134px;" >
         ...
         <input id="Button6" onclick="newForm();" style="border-right: #333333 1px ridge;
             ...
             background-color: #f1f1f1" type="button" value="PAPAR MASTERSHEET" /><asp:Button ID="Simpan" runat="server" Text="SIMPAN" style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1;" OnClientClick="return pastiKanData();" /><input
                 ...
                 type="button" value="CETAK SKPI" /><input id="Button5" runat="server" disabled="disabled"
                     ...
                     value="PAPAR CETAKKAN" /><input id="Button8" runat="server" disabled="disabled" onclick="showSenaraiprinter();"
