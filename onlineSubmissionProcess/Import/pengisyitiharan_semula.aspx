<%@ Page Language="VB" AutoEventWireup="false" CodeFile="pengisyitiharan_semula.aspx.vb" Inherits="Import_pengisyitiharan_semula" %>
...
var str ="../../import/eSKPI.aspx?barcode="+ document.all.Barcodes.value +"&invois_id="+document.all.Invois_Id.value+"&SalinanMs="+ escape(winTitle)+"&cajPBI="+ cajPBI +"&cajPK="+ cajPK +"&cajKdrEkor"+ cajKdrEkor +"&cajKdrQty="+ cajKdrQty +"&cetak="+ strCetak+"&pname="+document.all.printer_name.value;
   ...
   date1temp.setDate(date1temp.getDate());
    ...
    else
    {
        ...
        if (stat=="false")
        {
            ...
            document.all.arrayVal.value = document.all.Importer.value + '`' +document.all.searchKodImporter.value + '`' + dataItem2.options.value +'`'+ dataItem3.options.value + '`' + document.all.Exporter.value + '`'+ document.all.searchKodExporter.value + '`' + document.all.PetiBiruKecil.value +  '`' + document.all.PetiBiruBesar.value + '`'+ document.all.NoKontena.value + '`'+ "B" + '~' + document.all.arrayVal.value;
            
                        
            var myString =document.all.Importer.value + '`' + document.all.searchKodImporter.value + '`' + dataItem2.options.value +'`'+ dataItem3.options.value + '`' + document.all.Exporter.value + '`' + document.all.searchKodExporter.value + '`' + document.all.PetiBiruKecil.value +  '`' + document.all.PetiBiruBesar.value + '`' + document.all.NoKontena.value + '`' + "B" + '~';
...
function showFilteredCompanyIkanCaj(company_code,jenis_urusan_code,kategori_ikanSearch)
{
   ...
   // alert(company_c.length);
    for (i=0;i<company_c.length;i++)
    {
          ...
          //alert(kategori_ikanSearch +"="+ kategori_ikan_c[i]);
          //if (company_code==company_c[i] && jenis_urusan_code==jenis_urusan_c[i] && kategori_ikanSearch==kategori_ikan_c[i])
           //if (company_code==company_c[i] && kategori_ikanSearch==kategori_ikan_c[i] && kod_ikanSearch==kod_ikan_c[i])
        ...
        <table style="width: 100%">
            <tr>
                <td colspan="4" style="height: 18px; background-color:#0000cc;">
                    <strong>&nbsp;<span style="color: #ffffff">PENGISYTIHARAN SEMULA <%=namaJenisUrusan.ToUpper()%></span></strong></td>
            </tr>
            <tr>
                <td>
                </td>
         ...
         <table id="tblGridImporter" border="0" width="100%">
             ...
             <tr>
                 ...
                 <th style="background-color:#f1f1f1; width:10%; height:22px">
                     Tarikh Luput</th>
                 <th style="background-color:#f1f1f1; width:21%; height:22px">
                     Pengeksport</th>
