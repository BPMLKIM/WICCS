...
<body>
    ...
    <div>
        ...
        <table style="width: 100%">
            ...
            <tr>
                <td style="width: 164px">
                    <strong>Kata Pengguna</strong></td>
                <td style="width: 424px">
            ...
            <tr>
                ...
                <td style="width: 424px; height: 15px">
                    <asp:DropDownList ID="hak_akses" runat="server" DataSourceID="accessGroup" DataTextField="nama_kumpulan_kebenaran" DataValueField="kebenaran_akses">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
        ...
        <asp:SqlDataSource ID="accessGroup" runat="server" ConnectionString="<%$ ConnectionStrings:W-ICCS_Conn %>"
                        SelectCommand="SELECT [kebenaran_akses], [nama_kumpulan_kebenaran] FROM [KUMPULAN_KEBENARAN_AKSES]">
                    </asp:SqlDataSource>
        &nbsp;<br />
