...
Partial Class UserManagement_LKIM_edit_lkim_user
    ...
    Protected Sub NewUser_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles NewUser.Click
        ...
        Dim sqlText As String = "select count(*) from spesis_ikan_1 where kod_spesis_ikan_1='" & textbox1.Text & "'"
        Dim rcount As Integer = opClass.SingleFieldResults(sqlText)

        sqlText = "UPDATE spesis_ikan_1 set kod_spesis_ikan_1 = '" & textbox1.Text & "', nama_spesis_ikan_1= '" & textbox2.Text & "' where kod_spesis_ikan_1='" & textbox1.Text & "'"
        ...
        If opClass.ErrorSignal = False Then
            Dim popupScript As String = "<script language='javascript'>" & _
                                    "alert('Maklumat Telah Selamat Dikemaskini!!!');location.href='s1.aspx';" & _
                                    "</script>"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            sqlText = "SELECT Kod_spesis_ikan_1, Nama_spesis_ikan_1 from spesis_ikan_1 WHERE nama_spesis_ikan_1='" & Request("user") & "'"
            ...
            Else
                Dim popupScript As String = "<script language='javascript'>" & _
                                               "alert('spesis ikan Tidak Wujud!!!');history.back();" & _
                                               "</script>"
                Response.Write(popupScript)
            End If
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Else
            sqlText = "update spesis_ikan_1 set status='no' where kod_spesis_ikan_1='" & textbox1.Text & "'"
            'sqlText = "delete from ikan_caj where id='" & textbox1.Text & "'"
            opClass.InsertData(sqlText)

            If opClass.ErrorSignal = False Then
                Dim popupScript As String = "<script language='javascript'>" & _
                                        "alert('Maklumat Telah Selamat Dihapuskan!!!');location.href='s1.aspx';" & _
                                        "</script>"
                Response.Write(popupScript)
            Else
                Dim popupScript As String = "<script language='javascript'>" & _
