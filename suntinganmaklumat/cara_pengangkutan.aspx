<%@ Page Language="VB" AutoEventWireup="false" CodeFile="cara_pengangkutan.aspx.vb" Inherits="UserManagement_LKIM_list_users" %>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
      ...
      <td colspan="3"> Table Caj Ikan</td>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <tr>
                <td style="width: 217px; height: 8px">
                    Carian berdasarkan nama kategori ikan</td>
                <td style="height: 8px">
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
            ...
            <Columns>
                <asp:BoundField DataField="Kod_Cara_Pengangkutan" HeaderText="Kod_Cara_Pengangkutan"
                    SortExpression="Kod_Cara_Pengangkutan" />
                <asp:BoundField DataField="Nama_Cara_Pengangkutan" HeaderText="Nama_Cara_Pengangkutan"
                    SortExpression="Nama_Cara_Pengangkutan" />
            </Columns>
        ...
        <asp:SqlDataSource ID="lkim_userlists" runat="server" ConnectionString="<%$ ConnectionStrings:W-ICCS_Conn %>"
            SelectCommand="SELECT Kod_Cara_Pengangkutan, Nama_Cara_Pengangkutan FROM CARA_PENGANGKUTAN WHERE (Nama_Cara_Pengangkutan LIKE '%' + @nama + '%')and(status='yes')">
            <SelectParameters>
                ...
                <input id="NewUser" onclick="location.href='cara_pengangkutan_new_lkim_user.aspx'" style="border-right: #333333 1px ridge;
            ...
            type="button" value="Tambah Cara Pengangkutan" />
...
<%--                <asp:Button ID="NewUser" runat="server" Text="Tambah Cara Pengangkutan" style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1;" OnClientClick="location.href='cara_pengangkutan_new_lkim_user.aspx';"/><asp:Button ID="Kembali" runat="server" Text="Kembali" style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1;" OnClientClick="location.href='suntingmaklumat.aspx';"/>--%>
