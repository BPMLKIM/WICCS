<%@ Page Language="VB" AutoEventWireup="false" CodeFile="negeri_new_lkim_user.aspx.vb" Inherits="UserManagement_LKIM_new_lkim_user" %>
...
<body>
  ...
  <div> 
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
      <tr>
              <td colspan="2">
                  <font color="#333333"><strong>Maklumat </strong><span style="color: #000000">negeri</span></font></td>
          </tr>
          <tr>
          ...
          <tr>
              <td style="width: 164px">
                  Nama negeri</td>
              <td style="width: 424px">
                  <asp:TextBox ID="textbox2" runat="server" Width="200px" MaxLength="15"></asp:TextBox></td>
          </tr>
      </table>  
        &nbsp;<br />
    <asp:Button ID="NewUser" runat="server" Style="border-right: #333333 1px ridge;
            ...
            Text="Simpan" /><input id="Button1" onclick="location.href='negeri.aspx'" style="border-right: #333333 1px ridge;
            padding-right: 1px; border-top: #ffffff 1px ridge; padding-left: 1px; font-size: 10px;
            padding-bottom: 1px; border-left: #ffffff 1px ridge; color: #000000; padding-top: 1px;
            border-bottom: #000000 1px ridge; font-family: MS Shell Dlg,verdana,??; background-color: #f1f1f1"
            type="button" value="Papar" />&nbsp;<br />
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="textbox1"
            Display="None" ErrorMessage="kod negeri"></asp:RequiredFieldValidator>
      &nbsp; &nbsp;
        &nbsp;&nbsp;<br />
