<%@ Page UICulture="it-IT" Culture="it-IT" Language="VB" AutoEventWireup="false" CodeFile="pengeksport_kecuali_edit.aspx.vb" Inherits="pengeksport_kecuali_edit" %>
...
<body>
  ...
  <div> 
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
      <tr>
              <td colspan="2">
                  <font color="#333333"><strong> Kemaskini Maklumat Pengeksport Kecuali</strong></font></td>
        ...
        <tr>
            ...
            <td style="width: 309px; height: 14px">
                <asp:TextBox ID="searchKodPengeksport" runat="server" Width="24px"></asp:TextBox><input
                    id="Button4" runat="server" class="textbox" name="choose2" onclick="showSenaraiPengeksport(); return false;"
                    style="border-left-color: white; background-image: url(../images/search.gif);
                    border-bottom-color: white; width: 18px; cursor: hand; border-top-style: none;
                    border-top-color: white; border-right-style: none; border-left-style: none; height: 22px;
                    background-color: white; border-right-color: white; border-bottom-style: none"
    ...
    <br />
        ...
        &nbsp;<asp:Button ID="NewUser" runat="server"
            ...
            background-color: #f1f1f1" Text="Kemaskini" Visible="False" /><asp:Button ID="Button1" runat="server" 
            Style="border-right: #333333 1px ridge; padding-right: 1px; border-top: #ffffff 1px ridge;
            padding-left: 1px; font-size: 10px; padding-bottom: 1px; border-left: #ffffff 1px ridge;
            color: #000000; padding-top: 1px; border-bottom: #000000 1px ridge; font-family: MS Shell Dlg,verdana,??;
            background-color: #f1f1f1" Text="Hapus" /><input id="Button3" onclick="location.href='pengeksport_kecuali.aspx'" style="border-right: #333333 1px ridge;
