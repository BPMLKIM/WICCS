...
Partial Class UserManagement_LKIM_edit_lkim_user
    ...
    Protected Sub NewUser_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles NewUser.Click
        ...
        Dim sqlText As String = "select count(*) from bentuk_ikan_3 where kod_bentuk_ikan_3='" & textbox1.Text & "'"
        Dim rcount As Integer = opClass.SingleFieldResults(sqlText)

        sqlText = "UPDATE bentuk_ikan_3 set kod_bentuk_ikan_3='" & textbox1.Text & "', nama_bentuk_ikan_3='" & textbox2.Text & "' WHERE kod_bentuk_ikan_3='" & textbox1.Text & "'"

        opClass.InsertData(sqlText)

        If opClass.ErrorSignal = False Then
            Dim popupScript As String = "<script language='javascript'>" & _
                                    "alert('Maklumat Telah Selamat Dikemaskini!!!');location.href='bentuk_ikan3.aspx';" & _
                                    "</script>"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            sqlText = "SELECT Kod_bentuk_ikan_3, Nama_bentuk_ikan_3" & _
            " FROM bentuk_ikan_3 WHERE Nama_bentuk_ikan_3='" & Request("user") & "'"
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Else
            sqlText = "update bentuk_ikan_3 set status='no' where kod_bentuk_ikan_3='" & textbox1.Text & "'"
            'sqlText = "delete from bentuk_ikan_3 where kod_bentuk_ikan_3='" & textbox1.Text & "'"
            opClass.InsertData(sqlText)

            If opClass.ErrorSignal = False Then
                Dim popupScript As String = "<script language='javascript'>" & _
                                        "alert('Maklumat Bentuk Ikan Telah Selamat Dihapuskan!!!');location.href='bentuk_ikan3.aspx';" & _
                                        "</script>"
                Response.Write(popupScript)
            Else
                Dim popupScript As String = "<script language='javascript'>" & _
