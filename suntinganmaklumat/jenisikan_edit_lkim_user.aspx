<%@ Page Language="VB" AutoEventWireup="false" CodeFile="jenisikan_edit_lkim_user.aspx.vb" Inherits="UserManagement_LKIM_edit_lkim_user" %>
...
<body>
  ...
  <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
    <tr> 
      <td colspan="2" > <strong><font color="#333333">Maklumat 
              Jenis ikan</font></strong></td>
    </tr>
    <tr> 
    ...
    <tr> 
      <td style="width: 164px"> Kod BKH</td>
      <td style="width: 424px"> <asp:TextBox ID="textbox1" runat="server" Width="200px"></asp:TextBox></td>
    </tr>
    <tr> 
      <td style="width: 164px"> Kod ikan</td>
      <td style="width: 424px"> <asp:TextBox ID="textbox2" runat="server" Width="200px" MaxLength="10"></asp:TextBox></td>
    </tr>
      <tr>
          <td style="width: 164px">
              Nama BKH</td>
          
      <td style="width: 424px"> <asp:textbox ID="TextBox3" runat="server" Width="200px" MaxLength="30"></asp:textbox></td>
      </tr>
      <tr>
          <td style="width: 164px">
              Harga BKH</td>
        ...
        &nbsp;&nbsp;<cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender4" runat="server"
            FilterType="Custom,Numbers" TargetControlID="TextBox4" ValidChars=",-.">
        ...
        &nbsp;<asp:Button ID="NewUser" runat="server"
            ...
            padding-left: 1px; font-size: 10px; padding-bottom: 1px; border-left: #ffffff 1px ridge;
            color: #000000; padding-top: 1px; border-bottom: #000000 1px ridge; font-family: MS Shell Dlg,verdana,??;
            background-color: #f1f1f1" Text="Hapus" /><input id="Button3" onclick="location.href='jenisikan.aspx'" style="border-right: #333333 1px ridge;
