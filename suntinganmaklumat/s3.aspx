<%@ Page Language="VB" AutoEventWireup="false" CodeFile="s3.aspx.vb" Inherits="UserManagement_LKIM_list_users" %>
...
<body>
  ...
  <div> 
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
      ...
      <td colspan="3"> Table Spesis Ketam</td>
            </tr>
        </table>
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <tr>
                <td style="width: 237px; height: 8px">
                    Carian berdasarkan nama Spesis Ketam</td>
                <td style="height: 8px">
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
            ...
            <Columns>
                <asp:BoundField DataField="Kod_Spesis_Ikan_3" HeaderText="Kod_Spesis_Ikan_3" SortExpression="Kod_Spesis_Ikan_3" />
                <asp:BoundField DataField="Nama_Spesis_Ikan_3" HeaderText="Nama_Spesis_Ikan_3" SortExpression="Nama_Spesis_Ikan_3" />
            </Columns>
        ...
        <asp:SqlDataSource ID="lkim_userlists" runat="server" ConnectionString="<%$ ConnectionStrings:W-ICCS_Conn %>"
            SelectCommand="SELECT Kod_Spesis_Ikan_3, Nama_Spesis_Ikan_3 FROM SPESIS_IKAN_3 WHERE (Nama_Spesis_Ikan_3 LIKE '%' + @nama + '%')and(status='yes')">
            <SelectParameters>
                ...
                <br />
                    <input id="NewUser" onclick="location.href='s3_new_lkim_user.aspx'" style="border-right: #333333 1px ridge;
