    <%@ Page Language="VB" AutoEventWireup="false" CodeFile="lesen.aspx.vb" Inherits="UserManagement_LKIM_list_users" %>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
      ...
      <td colspan="3"> Table lesen</td>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <tr>
                <td style="width: 237px; height: 8px">
                    Carian berdasarkan No lesen atau Siri Lesen atau Nama Syarikat Eksport</td>
                <td style="height: 8px">
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
            ...
            <Columns>
                <asp:BoundField DataField="Nama_Syarikat_Eksport" HeaderText="Nama_Syarikat_Eksport"
                    SortExpression="Nama_Syarikat_Eksport" />
                <asp:BoundField DataField="Expr1" HeaderText="No lesen" SortExpression="Expr1" />
                <asp:BoundField DataField="Tarikh_Tamat" HeaderText="Tarikh_Tamat" SortExpression="Tarikh_Tamat" />
                <asp:BoundField DataField="Tarikh_Disah" HeaderText="Tarikh_Disah" SortExpression="Tarikh_Disah" />
                <asp:BoundField DataField="Kawasan" HeaderText="Kawasan" SortExpression="Kawasan" />
                <asp:BoundField DataField="Siri_Lesen" HeaderText="Siri_Lesen" SortExpression="Siri_Lesen" />
            </Columns>
        ...
        <asp:SqlDataSource ID="lkim_userlists" runat="server" ConnectionString="<%$ ConnectionStrings:W-ICCS_Conn %>"
            SelectCommand="SELECT PENGEKSPORT.Nama_Syarikat_Eksport, LESEN.No_Lesen AS Expr1, LESEN.Tarikh_Tamat, LESEN.Tarikh_Disah, LESEN.Kawasan, LESEN.Siri_Lesen FROM PENGEKSPORT INNER JOIN LESEN ON PENGEKSPORT.No_Lesen = LESEN.No_Lesen WHERE (LESEN.no_Lesen LIKE '%' + @nama + '%') or (LESEN.siri_Lesen LIKE '%' + @nama + '%') or (PENGEKSPORT.Nama_Syarikat_Eksport LIKE '%' + @nama + '%')">
            <SelectParameters>
                ...
                <br />
                 <input id="NewUser" onclick="location.href='lesen_new_lkim_user.aspx'" style="border-right: #333333 1px ridge;
            ...
            type="button" value="Tambah lesen" />
...
<%--                <asp:Button ID="NewUser" runat="server" Text="Tambah lesen" style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1;" OnClientClick="location.href='lesen_new_lkim_user.aspx';"/><asp:Button ID="Kembali" runat="server" Text="Kembali" style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1;" OnClientClick="location.href='suntingmaklumat.aspx';"/>--%>
