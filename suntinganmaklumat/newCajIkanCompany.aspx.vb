...
Partial Class suntinganmaklumat_newCajIkanCompany
    ...
    Protected Sub Simpan_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Simpan.Click
        ...
        If Simpan.Page.IsPostBack Then
            ...
            Dim sql As String = "INSERT INTO COMPANY_IKAN_CAJ" & _
            ...
            Response.Write("<script> alert('Maklumat Telah Selamat Disimpan!!!!');location.href='cajIkanCompany.aspx?kodImporter=" & strKodImporter & "'; </script>")
        End If
    End Sub
End Class
