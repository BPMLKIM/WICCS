...
Partial Class UserManagement_LKIM_edit_lkim_user
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            " FROM company_ikan_caj WHERE id='" & Request("user") & "'"
    ...
    Protected Sub Batal_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Batal.Click
        ...
        Dim sqlText As String = "select count(*) from company_ikan_caj where id='" & Label8.Text & "'"
        Dim rcount As Integer = opClass.SingleFieldResults(sqlText)

        sqlText = "update company_ikan_caj set status='No' where id='" & Label8.Text & "'"
        ...
        If opClass.ErrorSignal = False Then
            Dim popupScript As String = "<script language='javascript'>" & _
                                    "alert('Maklumat company ikan caj Telah Selamat Dihapuskan!!!');location.href='cajIkanCompany.aspx';" & _
                                    "</script>"
            Response.Write(popupScript)
        Else
            Dim popupScript As String = "<script language='javascript'>" & _
    ...
    Protected Sub papar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles papar.Click
        Server.Transfer("cajIkanCompany.aspx")
    End Sub
End Class
