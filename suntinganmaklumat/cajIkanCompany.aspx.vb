...
Partial Class suntinganmaklumat_cajIkanCompany
    ...
    Protected Sub Button1_Click1(ByVal sender As Object, ByVal e As System.EventArgs)
        If Button1.Page.IsPostBack Then
            ...
            Else
                Label1.Text = ""
                Response.Redirect("newCajIkanCompany.aspx?kodImporter=" & Importer.SelectedValue)
                'Panel1.Visible = True
            End If
        End If
    End Sub
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            e.Row.Attributes.Add("onClick", "HighLightTR('#c9cc99','cc3333');location.href='cajIkanCompany_edit_lkim_user.aspx?user=" & e.Row.DataItem(0).ToString() & "';")
