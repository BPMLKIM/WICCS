<%@ Page Language="VB" AutoEventWireup="false" CodeFile="newCajIkanCompany.aspx.vb" Inherits="suntinganmaklumat_newCajIkanCompany" %>
          ...
          <tr>
              ...
              <td>
                  :<asp:DropDownList ID="Importer" runat="server" AppendDataBoundItems="True" DataSourceID="SenaraiPengimport"
                      DataTextField="Nama_Syarikat_Import" DataValueField="Kod_Pengimport">
