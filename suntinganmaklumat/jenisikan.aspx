<%@ Page Language="VB" AutoEventWireup="false" CodeFile="jenisikan.aspx.vb" Inherits="UserManagement_LKIM_list_users" %>
...
<body>
  ...
  <div> 
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
      ...
      <td colspan="3"> Table jenis ikan</td>
            </tr>
        </table>
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <tr>
                <td style="width: 217px; height: 8px">
                    Carian berdasarkan nama nama BKH</td>
                <td style="height: 8px">
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
            ...
            <Columns>
                <asp:BoundField DataField="Kod_BKH" HeaderText="Kod_BKH" SortExpression="Kod_BKH" />
                <asp:BoundField DataField="Kod_Ikan" HeaderText="Kod_Ikan" SortExpression="Kod_Ikan" />
                <asp:BoundField DataField="Nama_BKH" HeaderText="Nama_BKH" SortExpression="Nama_BKH" />
                <asp:BoundField DataField="Harga_BKH" HeaderText="Harga_BKH" ReadOnly="True" SortExpression="Harga_BKH" />
            </Columns>
        ...
        <asp:SqlDataSource ID="lkim_userlists" runat="server" ConnectionString="<%$ ConnectionStrings:W-ICCS_Conn %>"
            SelectCommand="SELECT Kod_BKH, Kod_Ikan, Nama_BKH, CONVERT (varchar(13), CONVERT (money, Harga_BKH), 1) AS Harga_BKH FROM JENIS_IKAN WHERE (Nama_BKH LIKE '%' + @nama + '%') AND (status = 'yes')">
            <SelectParameters>
                ...
                <br />
                <input id="NewUser" onclick="location.href='jenisikan_new_lkim_user.aspx'" style="border-right: #333333 1px ridge;
            ...
            type="button" value="Tambah jenis ikan" />
...
<%--                <asp:Button ID="NewUser" runat="server" Text="Tambah jenis ikan" style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1;" OnClientClick="location.href='jenisikan_new_lkim_user.aspx';"/><asp:Button ID="Kembali" runat="server" Text="Kembali" style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1;" OnClientClick="location.href='suntingmaklumat.aspx';"/>--%>
