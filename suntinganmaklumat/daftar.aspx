<%@ Page Language="VB" AutoEventWireup="false" CodeFile="daftar.aspx.vb" Inherits="UserManagement_LKIM_list_users" %>
...
<body>
  ...
  <div> 
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
      ...
      <td colspan="3"> Table Daftar Barangan Bukan Ikan</td>
            </tr>
        </table>
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <tr>
                <td style="width: 237px; height: 8px">
                    Carian berdasarkan nama Barangan Bukan Ikan</td>
                <td style="height: 8px">
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
            ...
            <Columns>
                <asp:BoundField DataField="Kod_barangan" HeaderText="Kod_barangan" SortExpression="Kod_barangan" />
                <asp:BoundField DataField="Nama_barangan" HeaderText="Nama_barangan" SortExpression="Nama_barangan" />
            </Columns>
        ...
        <asp:SqlDataSource ID="lkim_userlists" runat="server" ConnectionString="<%$ ConnectionStrings:W-ICCS_Conn %>"
            SelectCommand="SELECT Kod_barangan, Nama_barangan FROM KodBukanIkan WHERE (Nama_barangan LIKE N'%' + @nama + N'%') AND (status = 'Y')">
            <SelectParameters>
                ...
                <br />
                <input id="NewUser" onclick="location.href='daftar_new_lkim_user.aspx'" style="border-right: #333333 1px ridge;
            ...
            type="button" value="Tambah Barangan Bukan Ikan" />
...
<%--                <asp:Button ID="NewUser" runat="server" Text="Tambah Barangan Bukan Ikan" style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1;" OnClientClick="location.href='daftar_new_lkim_user.aspx';"/><asp:Button ID="Kembali" runat="server" Text="Kembali" style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1;" OnClientClick="location.href='suntingmaklumat.aspx';"/>--%>
