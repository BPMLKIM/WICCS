<%@ Page Language="VB" AutoEventWireup="false" CodeFile="pengeksportm.aspx.vb" Inherits="UserManagement_LKIM_list_users" %>
...
<body>
  ...
  <div> 
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
      ...
      <td colspan="3"> Table Pengeksport malaysia</td>
            </tr>
        </table>
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <tr>
                <td style="width: 237px; height: 8px">
                    Carian berdasarkan nama syarikat eksport</td>
                <td style="height: 8px">
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
            ...
            <Columns>
                <asp:BoundField DataField="Kod_Pengeksport" HeaderText="Kod_Pengeksport" SortExpression="Kod_Pengeksport" />
                <asp:BoundField DataField="Nama_Syarikat_Eksport" HeaderText="Nama_Syarikat_Eksport"
                    SortExpression="Nama_Syarikat_Eksport" />
                <asp:BoundField DataField="Alamat_Syarikat_Eksport" HeaderText="Alamat_Syarikat_Eksport"
                    SortExpression="Alamat_Syarikat_Eksport" />
                <asp:BoundField DataField="No_Lesen" HeaderText="No_Lesen" SortExpression="No_Lesen" />
                <asp:BoundField DataField="Tarikh_Dimasukkan" HeaderText="Tarikh_Dimasukkan" SortExpression="Tarikh_Dimasukkan" />
            </Columns>
        ...
        <asp:SqlDataSource ID="lkim_userlists" runat="server" ConnectionString="<%$ ConnectionStrings:W-ICCS_Conn %>"
            SelectCommand="SELECT Kod_Pengeksport, Nama_Syarikat_Eksport, Alamat_Syarikat_Eksport, No_Lesen, Tarikh_Dimasukkan FROM PENGEKSPORT WHERE (Nama_Syarikat_Eksport LIKE '%' + @nama + '%')">
            <SelectParameters>
                ...
                <br />
                 <input id="NewUser" onclick="location.href='pengeksportm_new_lkim_user.aspx'" style="border-right: #333333 1px ridge;
            ...
            type="button" value="Tambah pengeksport malaysia" />
...
<%--                <asp:Button ID="NewUser" runat="server" Text="Tambah pengeksport malaysia" style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1;" OnClientClick="location.href='pengeksportm_new_lkim_user.aspx';"/><asp:Button ID="Kembali" runat="server" Text="Kembali" style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1;" OnClientClick="location.href='suntingmaklumat.aspx';"/>--%>
