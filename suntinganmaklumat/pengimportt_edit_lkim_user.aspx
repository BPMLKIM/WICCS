<%@ Page Language="VB" AutoEventWireup="false" CodeFile="pengimportt_edit_lkim_user.aspx.vb" Inherits="UserManagement_LKIM_edit_lkim_user" %>
...
<body>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="22%"><font color="#333333"><strong>Maklumat <span>pengimport luar</span></strong></font></td>
      <td width="78%">&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    ...
    <tr>
      <td>Kod pengimport luar</td>
      <td><asp:textbox ID="textbox1" runat="server" Width="200px" MaxLength="5"></asp:textbox></td>
    </tr>
    <tr>
  ...
  <cc1:ConfirmButtonExtender ID="ConfirmButtonExtender1" runat="server" TargetControlID="NewUser" ConfirmText="Adakah anda pasti ingin mengemaskini maklumat pengguna berikut?">
        ...
        &nbsp;<asp:Button ID="NewUser" runat="server"
            ...
            padding-left: 1px; font-size: 10px; padding-bottom: 1px; border-left: #ffffff 1px ridge;
            color: #000000; padding-top: 1px; border-bottom: #000000 1px ridge; font-family: MS Shell Dlg,verdana,??;
            background-color: #f1f1f1" Text="Hapus" /><input id="Button3" onclick="location.href='pengimportt.aspx'" style="border-right: #333333 1px ridge;
