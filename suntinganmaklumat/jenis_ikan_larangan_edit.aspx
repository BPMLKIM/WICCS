<%@ Page UICulture="it-IT" Culture="it-IT" Language="VB" AutoEventWireup="false" CodeFile="jenis_ikan_larangan_edit.aspx.vb" Inherits="jenis_ikan_larangan_edit" %>
...
agenwin=dhtmlwindow.open("SenaraiIkan", "iframe", "Senarai_ikan.aspx", "#1: Senarai Ikan", "width=380px,height=340px,resize=1,scrolling=1,center=1", "recal",document.all.kodIkan);
}
...
<%
    ...
    Dim sqlText As String = "SELECT Rtrim([Kod_bkh]) as keyCode, [Kod_bkh],[kod_ikan],[nama_bkh] FROM [jenis_ikan]"
...
<body>
  ...
  <div> 
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
      <tr>
              <td colspan="2">
                  <font color="#333333"><strong> Kemaskini Maklumat Jenis Ikan Larangan</strong></font></td>
    ...
    <br />
        ...
        &nbsp;<asp:Button ID="NewUser" runat="server"
            ...
            padding-left: 1px; font-size: 10px; padding-bottom: 1px; border-left: #ffffff 1px ridge;
            color: #000000; padding-top: 1px; border-bottom: #000000 1px ridge; font-family: MS Shell Dlg,verdana,??;
            background-color: #f1f1f1" Text="Hapus" /><input id="Button3" onclick="location.href='jenis_ikan_larangan.aspx'" style="border-right: #333333 1px ridge;
