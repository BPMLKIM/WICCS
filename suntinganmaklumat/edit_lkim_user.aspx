...
<body>
  ...
  <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
    <tr> 
      <td colspan="2" > <strong><font color="#333333">Maklumat Agen Pengangkutan</font></strong></td>
    </tr>
    <tr> 
    ...
    <tr> 
      <td style="width: 164px"> Kod Agen Pengangkutan</td>
      <td style="width: 424px"> <asp:TextBox ID="kod_agen_pengangkutan" runat="server" Width="200px" ></asp:TextBox></td>
    </tr>
    <tr> 
      <td style="width: 164px"> Nama Agen Pengangkutan</td>
      <td style="width: 424px"> <asp:TextBox ID="nama_agen_pengangkutan" runat="server" Width="200px"></asp:TextBox></td>
    </tr>
    <tr> 
      <td style="width: 164px;"> Alamat Agen Pengangkutan</td>
      <td style="width: 424px;"> <asp:TextBox ID="alamat_agen_pengangkutan" runat="server" Width="200px"></asp:TextBox></td>
    </tr>
    <tr> 
      <td style="width: 164px; height: 14px"> Deposit Semasa</td>
      <td style="width: 424px; height: 14px"> <asp:TextBox ID="deposit_semasa" runat="server" Width="200px"></asp:TextBox></td>
    </tr>
    <tr> 
      <td style="width: 164px"> Transaksi Semasa&nbsp;</td>
      <td style="width: 424px"> <asp:TextBox ID="transaksi_semasa" runat="server" Width="200px"></asp:TextBox></td>
    </tr>
    <tr> 
      <td style="width: 164px"> Tambah Deposit Semasa</td>
      <td style="width: 424px"> <asp:TextBox ID="deposit_semasa_tambahan" runat="server" Width="200px" MaxLength="5"></asp:TextBox></td>
    </tr>
    <tr> 
      <td style="width: 164px"> Jumlah baru Deposit Semasa&nbsp;</td>
      <td style="width: 424px"> <asp:TextBox ID="nilai_deposit_semasa" runat="server" EnableViewState="False" Width="120px"></asp:TextBox></td>
    </tr>
  </table>
        ...
        <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" TargetControlID="deposit_semasa_tambahan" FilterType="Custom,Numbers" ValidChars=",-.">
        </cc1:FilteredTextBoxExtender>
        <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender2" runat="server" TargetControlID="nilai_deposit_semasa" FilterType="Custom,Numbers" ValidChars=",-.">
        </cc1:FilteredTextBoxExtender>
        <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender3" runat="server" TargetControlID="transaksi_semasa" FilterType="Custom,Numbers" ValidChars=",-.">
        </cc1:FilteredTextBoxExtender>
        &nbsp; &nbsp;
        &nbsp;
        &nbsp;&nbsp;<br />
        &nbsp;<asp:Button ID="NewUser" runat="server"
            ...
            padding-left: 1px; font-size: 10px; padding-bottom: 1px; border-left: #ffffff 1px ridge;
            color: #000000; padding-top: 1px; border-bottom: #000000 1px ridge; font-family: MS Shell Dlg,verdana,??;
            background-color: #f1f1f1" Text="Hapus" /><input id="Button3" onclick="location.href='list_users.aspx'" style="border-right: #333333 1px ridge;
