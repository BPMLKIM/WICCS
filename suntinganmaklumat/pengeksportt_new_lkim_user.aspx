<%@ Page Language="VB" AutoEventWireup="false" CodeFile="pengeksportt_new_lkim_user.aspx.vb" Inherits="UserManagement_LKIM_new_lkim_user" %>
...
<body>
  ...
  <div> 
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="23%"><font color="#333333"><strong>Maklumat <span style="color: #000000">pengeksport luar</span></strong></font></td>
        <td width="77%">&nbsp;</td>
      </tr>
      <tr>
        <td>&nbsp;</td>
      ...
      <tr>
        <td>Kod pengeksport luar</td>
        <td><asp:textbox ID="textbox1" runat="server" Width="200px" MaxLength="10">055</asp:textbox></td>
      </tr>
      <tr>
        <td>Nama pengeksport luar</td>
        <td><asp:textbox ID="textbox2" runat="server" Width="200px" MaxLength="50"></asp:textbox></td>
      </tr>
      <tr>
        <td>Alamat pengeksport luar</td>
    ...
    <asp:Button ID="NewUser" runat="server" Style="border-right: #333333 1px ridge;
            ...
            Text="Simpan" /><input id="Button1" onclick="location.href='pengeksportt.aspx'" style="border-right: #333333 1px ridge;
            padding-right: 1px; border-top: #ffffff 1px ridge; padding-left: 1px; font-size: 10px;
            padding-bottom: 1px; border-left: #ffffff 1px ridge; color: #000000; padding-top: 1px;
            border-bottom: #000000 1px ridge; font-family: MS Shell Dlg,verdana,??; background-color: #f1f1f1"
            type="button" value="Papar" />&nbsp;<br />
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="textbox1"
            Display="None" ErrorMessage="kod pengeksport thailand"></asp:RequiredFieldValidator>
      &nbsp; &nbsp;
        &nbsp;&nbsp;<br />
