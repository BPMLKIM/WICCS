<%@ Page Language="VB" AutoEventWireup="false" CodeFile="agen_jaminan_list_users.aspx.vb" Inherits="UserManagement_LKIM_list_users" %>
...
<body>
  ...
  <div> 
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
      ...
      <td colspan="3"> Table Agen Pengangkutan Jaminan Bank</td>
            </tr>
        </table>
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
            ...
            <Columns>
                <asp:BoundField DataField="Kod_Agen_Pengangkutan" HeaderText="Kod_Agen_Pengangkutan"
                    SortExpression="Kod_Agen_Pengangkutan" />
                <asp:BoundField DataField="Nama_Agen_Pengangkutan" HeaderText="Nama_Agen_Pengangkutan"
                    SortExpression="Nama_Agen_Pengangkutan" />
                <asp:BoundField DataField="Jaminan_Bank" HeaderText="Jaminan_Bank" SortExpression="Jaminan_Bank" />
            </Columns>
        ...
        <asp:SqlDataSource ID="lkim_userlists" runat="server" ConnectionString="<%$ ConnectionStrings:W-ICCS_Conn %>"
            SelectCommand="SELECT Kod_Agen_Pengangkutan, Nama_Agen_Pengangkutan, Jaminan_Bank FROM AGEN_JAMINAN_BANK WHERE (Nama_Agen_Pengangkutan LIKE '%' + @nama + '%') AND (Status = 'aktif')">
            <SelectParameters>
                <asp:ControlParameter ControlID="NamaPengguna" DefaultValue="%" Name="nama" PropertyName="Text"
                    Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
                &nbsp;<input id="NewUser2" onclick="location.href='agen_jaminan_new_lkim_user.aspx'" style="border-right: #333333 1px ridge;
