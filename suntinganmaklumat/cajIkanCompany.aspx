<%@ Page Language="VB" AutoEventWireup="false" CodeFile="cajIkanCompany.aspx.vb" Inherits="suntinganmaklumat_cajIkanCompany" %>
...
<body>       
  ...
  <div> <br />
    ...
    <table style="width: 100%">
            ...
            <tr>
                <td style="width: 138px; height: 15px">
                    &nbsp;<strong>Kod Agen Pengimport</strong></td>
                <td style="height: 15px">
                    <asp:TextBox ID="kodImporter" runat="server" Width="91px"></asp:TextBox></td>
            </tr>
            <tr>
                <td style="width: 138px; height: 15px">
                    <strong>&nbsp;Senarai Pengimport</strong></td>
                <td style="height: 15px">
                    <asp:DropDownList ID="Importer" runat="server" DataSourceID="SenaraiPengimport"
                        DataTextField="Nama_Syarikat_Import" DataValueField="Kod_Pengimport" AppendDataBoundItems="True">
        ...
        <asp:SqlDataSource ID="SenaraiCaj" runat="server" ConnectionString="<%$ ConnectionStrings:W-ICCS_Conn %>"
            SelectCommand="SELECT COMPANY_IKAN_CAJ.ID, COMPANY_IKAN_CAJ.Kategori_Ikan,COMPANY_IKAN_CAJ.Kod_Ikan, KATEGORI_IKAN.Nama_Kategori_Ikan, COMPANY_IKAN_CAJ.Jenis_Urusan, JENIS_URUSAN.Nama_Urusan, COMPANY_IKAN_CAJ.Kadar_Peti_Kecil, COMPANY_IKAN_CAJ.Kadar_Peti_Besar, COMPANY_IKAN_CAJ.Kadar_Ekor, COMPANY_IKAN_CAJ.Kadar_Kuantiti, COMPANY_IKAN_CAJ.Kod_Pengimport, COMPANY_IKAN_CAJ.tarikh_mula, COMPANY_IKAN_CAJ.tarikh_tamat FROM KATEGORI_IKAN INNER JOIN COMPANY_IKAN_CAJ ON KATEGORI_IKAN.Kod_Kategori_Ikan = COMPANY_IKAN_CAJ.Kategori_Ikan INNER JOIN JENIS_URUSAN ON COMPANY_IKAN_CAJ.Jenis_Urusan = JENIS_URUSAN.Kod_Urusan WHERE (COMPANY_IKAN_CAJ.Kod_Pengimport = @Kod_Pengimport) AND (COMPANY_IKAN_CAJ.status = 'yes')">
            <SelectParameters>
        ...
        <asp:SqlDataSource ID="SenaraiPengimport" runat="server" ConnectionString="<%$ ConnectionStrings:W-ICCS_Conn %>"
            SelectCommand="SELECT RTRIM([Kod_Pengimport]) as Kod_Pengimport, [Nama_Syarikat_Import] FROM [PENGIMPORT]">
        </asp:SqlDataSource>
                </ContentTemplate>
            </asp:UpdatePanel>
            &nbsp;&nbsp;<br />
