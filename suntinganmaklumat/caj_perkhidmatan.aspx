<%@ Page Language="VB" AutoEventWireup="false" CodeFile="caj_perkhidmatan.aspx.vb" Inherits="UserManagement_LKIM_list_users" %>
...
<body>
  ...
  <div> 
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
      ...
      <td colspan="3"> Table Caj Perkhidmatan</td>
            </tr>
        </table>
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <tr>
                <td style="width: 217px; height: 8px">
                    Carian berdasarkan nama Caj</td>
                <td style="height: 8px">
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
            ...
            <Columns>
                <asp:BoundField DataField="Kod_Caj" HeaderText="Kod_Caj" SortExpression="Kod_Caj" />
                <asp:BoundField DataField="Nama_Caj" HeaderText="Nama_Caj" SortExpression="Nama_Caj" />
                <asp:BoundField DataField="Kadar_caj" HeaderText="Kadar_caj" ReadOnly="True" SortExpression="Kadar_caj" />
                <asp:BoundField DataField="Cara_Pembayaran" HeaderText="Cara_Pembayaran" SortExpression="Cara_Pembayaran" />
                <asp:BoundField DataField="Dicaj_Oleh" HeaderText="Dicaj_Oleh" SortExpression="Dicaj_Oleh" />
            </Columns>
        ...
        <asp:SqlDataSource ID="lkim_userlists" runat="server" ConnectionString="<%$ ConnectionStrings:W-ICCS_Conn %>"
            SelectCommand="SELECT Kod_Caj, Nama_Caj, CONVERT (varchar(13), CONVERT (money, Kadar_Caj), 1) AS Kadar_caj, Cara_Pembayaran, Dicaj_Oleh FROM CAJ_PERKHIDMATAN WHERE (Nama_Caj LIKE '%' + @nama + '%') AND (status = 'yes')">
            <SelectParameters>
                ...
                <br />
                <input id="NewUser" onclick="location.href='caj_perkhidmatan_new_lkim_user.aspx'" style="border-right: #333333 1px ridge;
            ...
            type="button" value="Tambah caj perkhidmatan" />
            ...
            type="button" value="Kembali" />
                ...
                <%--<asp:Button ID="NewUser" runat="server" Text="Tambah caj perkhidmatan" style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1;" OnClientClick="location.href='caj_perkhidmatan_new_lkim_user.aspx';"/><asp:Button ID="Kembali" runat="server" Text="Kembali" style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1;" OnClientClick="location.href='suntingmaklumat.aspx';"/>--%>
