...
Partial Class suntingmaklumat
    ...
    'Protected opClass As New SqlOperation
    ...
    Function show_agen()
        ...
        'Dim sqlText As String = "SELECT kod_agen_pengangkutan, nama_agen_pengangkutan FROM agen_pengangkutan where kod_agen_pengangkutan <>'00000'ORDER BY nama_agen_pengangkutan"
        ...
        'Dim SqlRdr As SqlDataReader = opClass.DataReader(sqlText)
        myconn.Open()
    ...
    Function datagrid_agen()
        Dim myconn As New SqlConnection(connectionstring)
        Dim sql As String = "SELECT KOD_AGEN_PENGANGKUTAN,NAMA_AGEN_PENGANGKUTAN,ALAMAT_AGEN_PENGANGKUTAN, deposit_semasa, transaksi_semasa from  AGEN_PENGANGKUTAN where kod_agen_pengangkutan <>'00000' ORDER BY NAMA_AGEN_PENGANGKUTAN "
    ...
    Function datagrid_caj_ikan()
        Dim myconn As New SqlConnection(connectionstring)
        Dim sql As String = "SELECT id, kategori_ikan, jenis_urusan, kadar_peti_kecil, kadar_peti_besar,kadar_ekor, kadar_kuantiti FROM ikan_caj where id <>'00000'ORDER BY kategori_ikan"
        Dim Cmd As New SqlClient.SqlCommand(sql, myconn)
        myconn.Open()
        Dim myAdapter As New SqlClient.SqlDataAdapter(Cmd)
        Dim ds As New DataSet()
