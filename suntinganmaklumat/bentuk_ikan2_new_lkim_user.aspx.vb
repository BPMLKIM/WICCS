...
Partial Class UserManagement_LKIM_new_lkim_user
    ...
    Protected Sub NewUser_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles NewUser.Click
        ...
        sqlText = "select count(*) from bentuk_ikan_2 where kod_bentuk_ikan_2='" & textbox1.Text & "'"
        ...
        Else
            sqlText = "INSERT INTO [W-ICCS].[dbo].[bentuk_ikan_2] (kod_bentuk_ikan_2 ,nama_bentuk_ikan_2)" & _
