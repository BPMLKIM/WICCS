<%@ Page Language="VB" AutoEventWireup="false" CodeFile="kumpulan_edit_lkim_user.aspx.vb" Inherits="UserManagement_LKIM_edit_lkim_user" %>
  ...
  <table style="width: 100%">
    <tr> 
      <td colspan="2" > <font color="#333333"><strong>Maklumat <span style="color: #000000">
          kumpulan ikan</span></strong></font></td>
    </tr>
    <tr> 
    ...
    <tr> 
      <td style="width: 164px"> Kod kumpulan ikan</td>
      <td style="width: 424px"> <asp:TextBox ID="textbox1" runat="server" Width="200px"></asp:TextBox></td>
    </tr>
    <tr> 
      <td style="width: 164px; height: 23px;"> 
              Nama kumpulan ikan</td>
      <td style="width: 424px; height: 23px;"> <asp:TextBox ID="textbox2" runat="server" Width="200px"></asp:TextBox></td>
    </tr>
  </table>
        ...
        &nbsp;<asp:Button ID="NewUser" runat="server"
            ...
            padding-left: 1px; font-size: 10px; padding-bottom: 1px; border-left: #ffffff 1px ridge;
            color: #000000; padding-top: 1px; border-bottom: #000000 1px ridge; font-family: MS Shell Dlg,verdana,??;
            background-color: #f1f1f1" Text="Hapus" /><input id="Button3" onclick="location.href='kumpulan.aspx'" style="border-right: #333333 1px ridge;
