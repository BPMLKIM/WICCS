<%@ Page Language="VB" AutoEventWireup="false" CodeFile="s7.aspx.vb" Inherits="UserManagement_LKIM_list_users" %>
...
<body>
  ...
  <div> 
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
      ...
      <td colspan="3"> Table Spesis Hidupan Akuatik</td>
            </tr>
        </table>
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <tr>
                <td style="width: 237px; height: 8px">
                    Carian berdasarkan nama Spesis Hidupan Akuatik</td>
                <td style="height: 8px">
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
            ...
            <Columns>
                <asp:BoundField DataField="Kod_Spesis_Ikan_7" HeaderText="Kod_Spesis_Ikan_7" SortExpression="Kod_Spesis_Ikan_7" />
                <asp:BoundField DataField="Nama_Spesis_Ikan_7" HeaderText="Nama_Spesis_Ikan_7" SortExpression="Nama_Spesis_Ikan_7" />
            </Columns>
        ...
        <asp:SqlDataSource ID="lkim_userlists" runat="server" ConnectionString="<%$ ConnectionStrings:W-ICCS_Conn %>"
            SelectCommand="SELECT Kod_Spesis_Ikan_7, Nama_Spesis_Ikan_7 FROM SPESIS_IKAN_7 WHERE (Nama_Spesis_Ikan_7 LIKE '%' + @nama + '%')and(status='yes')">
            <SelectParameters>
                ...
                <br />
                    <input id="NewUser" onclick="location.href='s7_new_lkim_user.aspx'" style="border-right: #333333 1px ridge;
