<%@ Page Language="VB" AutoEventWireup="false" CodeFile="jenisbarangan.aspx.vb" Inherits="UserManagement_LKIM_list_users" %>
...
<body>
  ...
  <div> 
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
      ...
      <td colspan="3"> Table Jenis barangan</td>
            </tr>
        </table>
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <tr>
                <td style="width: 217px; height: 8px">
                    Carian berdasarkan nama nama barangan</td>
                <td style="height: 8px">
        ...
        <asp:SqlDataSource ID="lkim_userlists" runat="server" ConnectionString="<%$ ConnectionStrings:W-ICCS_Conn %>"
            SelectCommand="SELECT Kod_Barangan, Nama_Barangan FROM JENIS_BARANGAN WHERE (Nama_Barangan LIKE '%' + @nama + '%')and(status='yes')">
            <SelectParameters>
                ...
                <br />
                <input id="NewUser" onclick="location.href='jenisbarangan_new_lkim_user.aspx'" style="border-right: #333333 1px ridge;
            ...
            type="button" value="Tambah jenis barangan" />
