<%@ Page Language="VB" AutoEventWireup="false" CodeFile="s2_new_lkim_user.aspx.vb" Inherits="UserManagement_LKIM_new_lkim_user" %>
...
<body>
  ...
  <div> 
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
      <tr>
              <td colspan="2">
                  <font color="#333333"><strong>Maklumat Spesis Udang</strong></font></td>
          </tr>
          <tr>
              <td style="width: 66px">
              </td>
     ...
     <br />
        &nbsp;<asp:Button ID="NewUser" runat="server" Style="border-right: #333333 1px ridge;
            ...
            Text="Simpan" /><input id="Button1" onclick="location.href='s2.aspx'" style="border-right: #333333 1px ridge;
            padding-right: 1px; border-top: #ffffff 1px ridge; padding-left: 1px; font-size: 10px;
            padding-bottom: 1px; border-left: #ffffff 1px ridge; color: #000000; padding-top: 1px;
            border-bottom: #000000 1px ridge; font-family: MS Shell Dlg,verdana,??; background-color: #f1f1f1"
