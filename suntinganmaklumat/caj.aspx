<%@ Page Language="VB" AutoEventWireup="false" CodeFile="caj.aspx.vb" Inherits="UserManagement_LKIM_list_users" %>
...
<body>
  ...
  <div> 
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
      ...
      <td colspan="3"> Table Caj Ikan</td>
            </tr>
        </table>
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <tr>
                <td style="width: 217px; height: 8px">
                    Carian berdasarkan nama kategori Caj Ikan</td>
                <td style="height: 8px">
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
            ...
            Width="100%" Height="22px" BorderStyle="None" BorderWidth="0px" DataKeyNames="ID" >
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Kadar_Peti_Kecil" HeaderText="Kadar_Peti_Kecil" ReadOnly="True"
                    SortExpression="Kadar_Peti_Kecil" />
                <asp:BoundField DataField="Kadar_Peti_Besar" HeaderText="Kadar_Peti_Besar" ReadOnly="True"
                    SortExpression="Kadar_Peti_Besar" />
                <asp:BoundField DataField="Kadar_Ekor" HeaderText="Kadar_Ekor" ReadOnly="True" SortExpression="Kadar_Ekor" />
                <asp:BoundField DataField="Kadar_Kuantiti" HeaderText="Kadar_Kuantiti" ReadOnly="True"
                    SortExpression="Kadar_Kuantiti" />
            </Columns>
        ...
        <asp:SqlDataSource ID="lkim_userlists" runat="server" ConnectionString="<%$ ConnectionStrings:W-ICCS_Conn %>"
            SelectCommand="SELECT IKAN_CAJ.ID, IKAN_CAJ.Kategori_Ikan, KATEGORI_IKAN.Nama_Kategori_Ikan, IKAN_CAJ.Jenis_Urusan, JENIS_URUSAN.Nama_Urusan, CONVERT (varchar(13), CONVERT (money, IKAN_CAJ.Kadar_Peti_Kecil), 1) AS Kadar_Peti_Kecil, CONVERT (varchar(13), CONVERT (money, IKAN_CAJ.Kadar_Peti_Besar), 1) AS Kadar_Peti_Besar, CONVERT (varchar(13), CONVERT (money, IKAN_CAJ.Kadar_Ekor), 1) AS Kadar_Ekor, CONVERT (varchar(13), CONVERT (money, IKAN_CAJ.Kadar_Kuantiti), 1) AS Kadar_Kuantiti FROM IKAN_CAJ INNER JOIN KATEGORI_IKAN ON IKAN_CAJ.Kategori_Ikan = KATEGORI_IKAN.Kod_Kategori_Ikan INNER JOIN JENIS_URUSAN ON IKAN_CAJ.Jenis_Urusan = JENIS_URUSAN.Kod_Urusan WHERE (KATEGORI_IKAN.Nama_Kategori_Ikan LIKE '%' + @nama + '%') AND (IKAN_CAJ.status = 'yes')">
            <SelectParameters>
                ...
                <br />
                <input id="NewUser" onclick="location.href='caj_new_lkim_user.aspx'" style="border-right: #333333 1px ridge;
            ...
            type="button" value="Tambah caj ikan" />
...
<%--                <asp:Button ID="NewUser" runat="server" Text="Tambah caj ikan" style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1;" OnClientClick="location.href='caj_new_lkim_user.aspx';"/><asp:Button ID="Kembali" runat="server" Text="Kembali" style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1;" OnClientClick="location.href='suntingmaklumat.aspx';"/>--%>
