<%@ Page Language="VB" AutoEventWireup="false" CodeFile="jenis_ikan_larangan.aspx.vb"
    Inherits="jenis_ikan_larangan" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                    ...
                    <Columns>
                        <asp:HyperLinkField DataNavigateUrlFields="kod_ikan,t_mula,t_tamat" DataNavigateUrlFormatString="jenis_ikan_larangan_edit.aspx?kod_ikan={0}&amp;t_mula={1:yyyy/MM/dd}&amp;idp={2:yyyy/MM/dd}"
                ...
                <asp:SqlDataSource ID="lkim_userlists" runat="server" ConnectionString="<%$ ConnectionStrings:w-iccs_Conn %>"
                    SelectCommand="SELECT jenis_ikan_larangan.kod_ikan, jenis_ikan_larangan.nama_bkh,jenis_ikan_larangan.t_mula,jenis_ikan_larangan.t_tamat, status_tempoh1.status FROM jenis_ikan_larangan,status_tempoh1 WHERE jenis_ikan_larangan.status=status_tempoh1.kod order by jenis_ikan_larangan.t_mula desc">
                   <%-- <SelectParameters>
                ...
                <asp:Button ID="NewUser" runat="server" Text="Rekod Baru" Style="border-right: #333333 1px ridge;
                    ...
                    OnClientClick="location.href='jenis_ikan_larangan_new.aspx';" /><asp:Button ID="Kembali"
