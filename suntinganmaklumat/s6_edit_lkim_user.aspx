<%@ Page Language="VB" AutoEventWireup="false" CodeFile="s6_edit_lkim_user.aspx.vb" Inherits="UserManagement_LKIM_edit_lkim_user" %>
...
<body>
  ...
  <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
    <tr> 
      <td colspan="2" > <font color="#333333"><strong>Maklumat Spesis Bivals</strong></font></td>
    </tr>
    <tr> 
    ...
    <tr> 
      ...
      <td style="width: 94px"> <asp:TextBox ID="textbox2" runat="server" Width="200px" MaxLength="20"></asp:TextBox>&nbsp;
        ...
        &nbsp;<asp:Button ID="NewUser" runat="server"
            ...
            padding-left: 1px; font-size: 10px; padding-bottom: 1px; border-left: #ffffff 1px ridge;
            color: #000000; padding-top: 1px; border-bottom: #000000 1px ridge; font-family: MS Shell Dlg,verdana,??;
            background-color: #f1f1f1" Text="Hapus" /><input id="Button3" onclick="location.href='s6.aspx'" style="border-right: #333333 1px ridge;
