<%@ Page Language="VB" AutoEventWireup="false" CodeFile="negara_edit_lkim_user.aspx.vb" Inherits="UserManagement_LKIM_edit_lkim_user" %>
...
<body>
  ...
  <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
    ...
    <tr> 
      <td style="width: 164px"> Kod Negara</td>
    ...
    <tr> 
     ...
     <tr> 
      ...
      <td style="width: 424px"> 
          <asp:DropDownList ID="list5" runat="server" AutoPostBack="True">
              <asp:ListItem>sila buat pilihan</asp:ListItem>
              <asp:ListItem>ASEAN</asp:ListItem>
        ...
        &nbsp;<asp:Button ID="NewUser" runat="server"
            ...
            padding-left: 1px; font-size: 10px; padding-bottom: 1px; border-left: #ffffff 1px ridge;
            color: #000000; padding-top: 1px; border-bottom: #000000 1px ridge; font-family: MS Shell Dlg,verdana,??;
            background-color: #f1f1f1" Text="Hapus" /><input id="Button3" onclick="location.href='negara.aspx'" style="border-right: #333333 1px ridge;
