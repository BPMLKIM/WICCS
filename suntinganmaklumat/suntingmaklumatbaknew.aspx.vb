...
Partial Class suntingmaklumat
    ...
    Function show_caj_ikan()
        ...
        Dim myconn As New SqlConnection(connectionstring)
        Dim mycmd As New SqlCommand("SELECT kod_kategori_ikan, nama_kategori_ikan from kategori_ikan inner join ikan_caj on ikan_caj.kategori_ikan=kategori_ikan.kod_kategori_ikan where kod_kategori_ikan <>'' ORDER BY nama_kategori_ikan", myconn)
        Dim item2 As ListItem
        Dim SqlRdr As SqlDataReader
        myconn.Open()
        SqlRdr = mycmd.ExecuteReader(System.Data.CommandBehavior.CloseConnection)
        ...
        While SqlRdr.Read
            ...
            item2.Value = SqlRdr.Item("nama_kategori_ikan")
            DropDownList2.Items.Add(item2)
            '   label8.Text = DropDownList2.Items(item2)
            DropDownList2.Visible = True
        End While
    ...
    Function view_caj_ikan(ByVal result As String)
        ...
        If SqlRdr.Read Then
            ...
            view.Visible = True
            list4.Visible = True
            list4.Items.Insert(0, "-- Select jenis Urusan --")
            Label7.Text = DropDownList1.SelectedItem.Value
            Label8.Text = DropDownList2.SelectedItem.Value
        End If
    End Function
