...
Partial Class UserManagement_LKIM_new_lkim_user
    ...
    Protected Sub NewUser_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles NewUser.Click
        ...
        sqlText = "select count(*) from pengeksport where kod_pengeksport='" & textbox1.Text & "'"
        ...
        Else
            sqlText = "INSERT INTO [W-ICCS].[dbo].[pengeksport] (kod_pengeksport, nama_syarikat_eksport, alamat_syarikat_eksport, no_lesen, tarikh_dimasukkan)" & _
