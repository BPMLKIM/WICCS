<%@ Page Language="VB" AutoEventWireup="false" CodeFile="pengimportt_new_lkim_user.aspx.vb" Inherits="UserManagement_LKIM_new_lkim_user" %>
...
<body>
  ...
  <div> 
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="22%"><font color="#333333"><strong>Maklumat <span style="color: #000000">pengimport</span><span> luar</span></strong></font></td>
        <td width="78%">&nbsp;</td>
      </tr>
      <tr>
        <td>&nbsp;</td>
      ...
      <tr>
        <td style="height: 21px">Kod pengimport luar</td>
        <td style="height: 21px"><asp:textbox ID="textbox1" runat="server" Width="200px">055</asp:textbox></td>
      </tr>
      <tr>
        <td>Nama pengimport luar</td>
        <td><asp:textbox ID="textbox2" runat="server" Width="200px" MaxLength="50"></asp:textbox></td>
      </tr>
      <tr>
        <td>Alamat pengimport luar</td>
    ...
    <asp:Button ID="NewUser" runat="server" Style="border-right: #333333 1px ridge;
            ...
            Text="Simpan" /><input id="Button1" onclick="location.href='pengimportt.aspx'" style="border-right: #333333 1px ridge;
            padding-right: 1px; border-top: #ffffff 1px ridge; padding-left: 1px; font-size: 10px;
            padding-bottom: 1px; border-left: #ffffff 1px ridge; color: #000000; padding-top: 1px;
            border-bottom: #000000 1px ridge; font-family: MS Shell Dlg,verdana,??; background-color: #f1f1f1"
            type="button" value="Papar" />&nbsp;<br />
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="textbox1"
            Display="None" ErrorMessage="kod pengimport thailand"></asp:RequiredFieldValidator>
      &nbsp; &nbsp;
        &nbsp;&nbsp;<br />
