<%@ Page Language="VB" AutoEventWireup="false" CodeFile="s8.aspx.vb" Inherits="UserManagement_LKIM_list_users" %>
...
<body>
  ...
  <div> 
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
      ...
      <td colspan="3"> Table Spesis Lain - lain</td>
            </tr>
        </table>
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <tr>
                <td style="width: 237px; height: 8px">
                    Carian berdasarkan nama Spesis Lain - lain</td>
                <td style="height: 8px">
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
            ...
            <Columns>
                <asp:BoundField DataField="Kod_Spesis_Ikan_8" HeaderText="Kod_Spesis_Ikan_8" SortExpression="Kod_Spesis_Ikan_8" />
                <asp:BoundField DataField="Nama_Spesis_Ikan_8" HeaderText="Nama_Spesis_Ikan_8" SortExpression="Nama_Spesis_Ikan_8" />
            </Columns>
        ...
        <asp:SqlDataSource ID="lkim_userlists" runat="server" ConnectionString="<%$ ConnectionStrings:W-ICCS_Conn %>"
            SelectCommand="SELECT Kod_Spesis_Ikan_8, Nama_Spesis_Ikan_8 FROM SPESIS_IKAN_8 WHERE (Nama_Spesis_Ikan_8 LIKE '%' + @nama + '%')and(status='yes')">
            <SelectParameters>
                ...
                <br />
                    <input id="NewUser" onclick="location.href='s8_new_lkim_user.aspx'" style="border-right: #333333 1px ridge;
