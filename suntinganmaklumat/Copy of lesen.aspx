<%@ Page Language="VB" AutoEventWireup="false" CodeFile="copy of lesen.aspx.vb" Inherits="UserManagement_LKIM_list_users" %>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
      ...
      <td colspan="3"> Table lesen</td>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <tr>
                <td style="width: 237px; height: 8px">
                    Carian berdasarkan nama No lesen atau Siri lesen atau Nama Syarikat Import</td>
                <td style="height: 8px">
        ...
        <asp:SqlDataSource ID="lkim_userlists" runat="server" ConnectionString="<%$ ConnectionStrings:W-ICCS_Conn %>"
            SelectCommand="SELECT PENGIMPORT.Nama_Syarikat_import, LESEN.No_Lesen AS Expr1, LESEN.Tarikh_Tamat, LESEN.Tarikh_Disah, LESEN.Kawasan, LESEN.Siri_Lesen FROM PENGIMPORT INNER JOIN LESEN ON PENGIMPORT.No_Lesen = LESEN.No_Lesen WHERE (lesen.No_Lesen LIKE '%' + @nama + '%') or (lesen.siri_Lesen LIKE '%' + @nama + '%') or (PENGIMPORT.Nama_Syarikat_import LIKE '%' + @nama + '%')">
            <SelectParameters>
                ...
                <br />
                <input id="NewUser" onclick="location.href='copy of lesen_new_lkim_user.aspx'" style="border-right: #333333 1px ridge;
...
<%--                <asp:Button ID="NewUser" runat="server" Text="Tambah lesen" style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1;" OnClientClick="location.href='copy of lesen_new_lkim_user.aspx';"/><asp:Button ID="Kembali" runat="server" Text="Kembali" style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1;" OnClientClick="location.href='suntingmaklumat.aspx';"/>--%>
