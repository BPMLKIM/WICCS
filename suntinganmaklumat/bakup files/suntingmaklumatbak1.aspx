...
<body>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      <td style="height: 32px"><asp:dropdownlist ID="DropDownList1" runat="server" AutoPostBack="True"> 
  ...
  &nbsp;<br />
        ...
        <br />
        <br />
        <asp:DataGrid ID="GridView1" runat="server" AllowSorting="True" BackColor="White"
            BorderColor="White" BorderStyle="Ridge" CellPadding="0" Font-Size="Small"
            OnPageIndexChanged="GridView1_PageIndexChanged" Visible="False" AllowPaging="True" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" GridLines="None" Width="100%">
            <FooterStyle BackColor="#FFC080" Font-Size="8pt" ForeColor="White" /><SelectedItemStyle BackColor="White" Font-Bold="True" ForeColor="#F7F7F7">
            <PagerStyle BackColor="White" BorderColor="Black" Font-Names="arial" Font-Size="Small"
                ForeColor="Black" HorizontalAlign="Center" />
            <AlternatingItemStyle BackColor="White" />
            <ItemStyle BackColor="Azure" Font-Names="arial" Font-Size="8pt" ForeColor="Black"
                HorizontalAlign="Justify" />
            <HeaderStyle BackColor="Transparent" Font-Bold="True" Font-Names="arial" Font-Size="8pt"
                ForeColor="Black" HorizontalAlign="Center" />
            <Columns>
                <asp:TemplateColumn HeaderText="No.">
                    <ItemTemplate>
                        <asp:Label ID="bil" runat="server" Text='<%# Container.ItemIndex+1 + (GridView1.PageSize() * GridView1.CurrentPageIndex()) %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateColumn>
            </Columns>
        </asp:DataGrid>
