<%@ Page Language="VB" AutoEventWireup="false" CodeFile="pengimporttm_edit_lkim_user.aspx.vb" Inherits="UserManagement_LKIM_edit_lkim_user" %>
...
<body>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="25%"><font color="#333333"><strong>Maklumat Pengimport<span style="color: #000000"> 
        malaysia</span></strong></font></td>
      <td width="75%">&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    ...
    <tr>
      <td>alamat Menyurat</td>
      <td><asp:textbox ID="TextBox5" runat="server" Width="200px"></asp:textbox>
      </td>
    </tr>
    <tr>
      <td>Nama Pemilik</td>
    ...
    <tr>
      <td>No kp</td>
      <td><asp:textbox ID="TextBox7" runat="server" Width="200px" MaxLength="13"></asp:textbox></td>
    </tr>
    <tr>
      <td>No Tel</td>
      <td><asp:textbox ID="TextBox8" runat="server" Width="200px" MaxLength="8"></asp:textbox></td>
    </tr>
  </table>
  <cc1:ConfirmButtonExtender ID="ConfirmButtonExtender1" runat="server" TargetControlID="NewUser" ConfirmText="Adakah anda pasti ingin mengemaskini maklumat pengguna berikut?">
        ...
        &nbsp;<asp:Button ID="NewUser" runat="server"
            ...
            padding-left: 1px; font-size: 10px; padding-bottom: 1px; border-left: #ffffff 1px ridge;
            color: #000000; padding-top: 1px; border-bottom: #000000 1px ridge; font-family: MS Shell Dlg,verdana,??;
            background-color: #f1f1f1" Text="Hapus" /><input id="Button3" onclick="location.href='pengimporttm.aspx'" style="border-right: #333333 1px ridge;
