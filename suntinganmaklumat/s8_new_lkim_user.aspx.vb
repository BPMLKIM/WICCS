...
Partial Class UserManagement_LKIM_new_lkim_user
    ...
    Protected Sub NewUser_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles NewUser.Click
        ...
        sqlText = "select count(*) from spesis_ikan_8 where kod_spesis_ikan_8='" & textbox1.Text & "'"
        ...
        Else
            sqlText = "INSERT INTO [W-ICCS].[dbo].[spesis_ikan_8] (Kod_spesis_ikan_8 , Nama_spesis_ikan_8)" & _
