<%@ Page Language="VB" AutoEventWireup="false" CodeFile="caj_edit_lkim_user.aspx.vb" Inherits="UserManagement_LKIM_edit_lkim_user" %>
...
<body>
  ...
  <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
    <tr> 
      <td colspan="2" > <strong><font color="#333333">Maklumat Caj Ikan</font></strong></td>
    </tr>
    <tr> 
    ...
    <tr> 
      <td style="width: 164px"> Id</td>
      <td style="width: 424px"> <asp:TextBox ID="textbox1" runat="server" Width="200px"></asp:TextBox></td>
    </tr>
    <tr> 
      <td style="width: 164px"> Kategori Ikan</td>
      <td style="width: 424px;"> <asp:TextBox ID="textbox2" runat="server" Width="200px" MaxLength="3"></asp:TextBox></td>
    </tr>
      <tr>
          <td style="width: 164px">
              Jenis urusan</td>
          <td style="width: 424px">
              <asp:TextBox ID="TextBox3" runat="server" Width="200px" MaxLength="3"></asp:TextBox></td>
      </tr>
      <tr>
          <td style="width: 164px">
              Kadar Peti Kecil</td>
          <td style="width: 424px">
              <asp:TextBox ID="TextBox4" runat="server" Width="200px" MaxLength="3"></asp:TextBox></td>
      </tr>
      <tr>
          <td style="width: 164px">
              Kadar Peti Besar</td>
      ...
      <tr>
          <td style="width: 164px">
              kadar Ekor</td>
          <td style="width: 424px">
              <asp:TextBox ID="TextBox6" runat="server" Width="200px" MaxLength="3"></asp:TextBox></td>
      </tr>
      <tr>
          <td style="width: 164px">
              kadar Kuantiti</td>
          <td style="width: 424px">
              <asp:TextBox ID="TextBox7" runat="server" Width="200px" MaxLength="3"></asp:TextBox></td>
      </tr>
  </table>
        ...
        &nbsp;<asp:Button ID="NewUser" runat="server"
            ...
            padding-left: 1px; font-size: 10px; padding-bottom: 1px; border-left: #ffffff 1px ridge;
            color: #000000; padding-top: 1px; border-bottom: #000000 1px ridge; font-family: MS Shell Dlg,verdana,??;
            background-color: #f1f1f1" Text="Hapus" /><input id="Button3" onclick="location.href='caj.aspx'" style="border-right: #333333 1px ridge;
