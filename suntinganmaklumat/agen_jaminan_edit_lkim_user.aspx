<%@ Page Language="VB" AutoEventWireup="false" CodeFile="agen_jaminan_edit_lkim_user.aspx.vb" Inherits="UserManagement_LKIM_edit_lkim_user" %>
...
<body>
  ...
  <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
    <tr> 
      <td colspan="2" > <strong><font color="#333333">Maklumat Agen Pengangkutan
              Jaminan Bank</font></strong></td>
    </tr>
    <tr> 
    ...
    <tr> 
      ...
      <td style="width: 424px; height: 14px"> <asp:TextBox ID="deposit_semasa" runat="server" Width="120px"></asp:TextBox></td>
    </tr>
  </table>
        ...
        <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" TargetControlID="deposit_semasa" FilterType="Custom,Numbers" ValidChars=",-.">
        </cc1:FilteredTextBoxExtender> &nbsp; &nbsp; &nbsp; &nbsp; <br />
  <table border="0" cellspacing="0" cellpadding="0" style="width: 515px">
    <tr>
      <td style="width: 500px"><asp:Button ID="NewUser" runat="server"
            ...
            background-color: #f1f1f1" Text="Kemaskini" />
        <asp:Button ID="Button1" runat="server" 
            Style="border-right: #333333 1px ridge; padding-right: 1px; border-top: #ffffff 1px ridge;
            padding-left: 1px; font-size: 10px; padding-bottom: 1px; border-left: #ffffff 1px ridge;
            color: #000000; padding-top: 1px; border-bottom: #000000 1px ridge; font-family: MS Shell Dlg,verdana,??;
            background-color: #f1f1f1" Text="Hapus" />
        <input name="button"
            type="button" id="Button3" style="border-right: #333333 1px ridge;
            ...
            border-bottom: #000000 1px ridge; font-family: MS Shell Dlg,verdana,??; background-color: #f1f1f1" onclick="location.href='agen_jaminan_list_users.aspx'" value="Papar" /> 
        &nbsp; </td>
    </tr>
  </table>
  </form>
