<%@ Page Language="VB" AutoEventWireup="false" CodeFile="bentuk_ikan1_edit_lkim_user.aspx.vb" Inherits="UserManagement_LKIM_edit_lkim_user" %>
...
<body>
  ...
  <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
    <tr> 
      <td colspan="2" > <strong><font color="#333333">Maklumat Ikan Basah</font></strong></td>
    </tr>
    <tr> 
    ...
    <tr> 
      <td style="width: 164px"> Kod Bentuk Ikan</td>
      <td style="width: 424px"> <asp:TextBox ID="textbox1" runat="server" Width="200px"></asp:TextBox></td>
    </tr>
    <tr> 
      <td style="width: 164px"> Nama Bentuk Ikan</td>
      <td style="width: 424px"> <asp:textbox ID="textbox2" runat="server" Width="200px" MaxLength="20"></asp:textbox></td>
    </tr>
  </table>
      ...
      <td style="width: 500px"> 
        ...
        <input name="button"
            type="button" id="Button2" style="border-right: #333333 1px ridge;
            ...
            border-bottom: #000000 1px ridge; font-family: MS Shell Dlg,verdana,??; background-color: #f1f1f1" onclick="location.href='bentuk_ikan1.aspx'" value="Papar" /></td>
            </tr>
        </table>
