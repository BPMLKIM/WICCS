<%@ Page Language="VB" AutoEventWireup="false" CodeFile="epermit.aspx.vb" Inherits="UserManagement_LKIM_list_users" %>
...
<body>
  ...
  <div> 
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
      ...
      <td colspan="3"> Table E - permit</td>
            </tr>
        </table>
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <tr>
                <td style="width: 237px; height: 8px">
                    Carian berdasarkan nama E - permit</td>
                <td style="height: 8px">
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
            ...
            <Columns>
                <asp:BoundField DataField="epermit_serial_no" HeaderText="epermit_serial_no" SortExpression="epermit_serial_no" />
                <asp:BoundField DataField="epermit_code" HeaderText="epermit_code" SortExpression="epermit_code" />
                <asp:BoundField DataField="epermit_desc" HeaderText="epermit_desc" SortExpression="epermit_desc" />
                <asp:BoundField DataField="epermit_cost" HeaderText="epermit_cost" SortExpression="epermit_cost" />
        ...
        <asp:SqlDataSource ID="lkim_userlists" runat="server" ConnectionString="<%$ ConnectionStrings:W-ICCS_Conn %>"
            SelectCommand="SELECT epermit_serial_no, epermit_code, epermit_desc, epermit_cost, edate, userid FROM EPERMIT_MAINTENANCE WHERE (epermit_code LIKE '%' + @nama + '%')and(status='yes')">
            <SelectParameters>
                ...
                <br />
                    <input id="NewUser" onclick="location.href='epermit_new_lkim_user.aspx'" style="border-right: #333333 1px ridge;
            ...
            type="button" value="Tambah epermit" />
