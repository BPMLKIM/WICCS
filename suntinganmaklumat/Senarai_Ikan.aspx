<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Senarai_Ikan.aspx.vb" Inherits="Senarai_Ikan" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <asp:SqlDataSource ID="Ikan" runat="server" ConnectionString="<%$ ConnectionStrings:w-iccs_Conn %>"
                    SelectCommand="SELECT [kod_bkh], [kod_ikan], [nama_bkh] FROM [jenis_ikan] WHERE ([nama_bkh] LIKE '%' + @Nama_Agen_Pengangkutan + '%')">
                    <SelectParameters>
