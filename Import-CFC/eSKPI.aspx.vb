...
Partial Class _Default
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Request("cetak") = "0" Then
            ...
            Dim reportPath As String = Server.MapPath("rpt/crSKPI.rpt")
            ...
            reportPath = Server.MapPath("rpt/crMasterSheetImport_Top.rpt")
            masterSheet1.Load(reportPath)
            formula = "{v_MasterSheetTop.Nombor_Barcode} = '" & barcodeEntry & "'"
            ...
            masterSheet1.DataDefinition.FormulaFields("MS_Salinan").Text = "'SALINAN LKIM-BUKIT KAYU HITAM'"
            ...
            masterSheet3.DataDefinition.FormulaFields("MS_Salinan").Text = "'SALINAN CFC'"
