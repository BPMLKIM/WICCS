...
function fillUpRec_tblGrid1()        
{
    ...
    document.all.CB.innerHTML=totalcajbiasa;
    document.all.CP.innerHTML=centPlace(totalcajluarbiasa);
}	            
...
<body>
    ...
    <table id="Table3" border="0" style="border-right: gray thin groove; border-bottom: gray thin groove;
        ...
        <tr>
            <td colspan="3" style="height: 24px;  text-align: right;">Jumlah Pengurangan Caj&nbsp;
            </td>
            <td style="height: 24px;  text-align: left">
