<%@ Page Language="VB" AutoEventWireup="false" CodeFile="v_mastersheetOld.aspx.vb" Inherits="Import_v_mastersheet" %>
...
<script language="javascript" type="text/javascript">
 ...
 function processTable1()
 {
    ...
    document.all.cajKenderaan.innerHTML = window.opener.document.all.CajMasuk.value;
...
function fillUpRec_tblGrid1()        
{
    ...
    for(i=0;i<tbl1_kodimporter.length-1;i++)
    {
        //alert(tbl1_kodimporter[i]);
        ...
        oCell = newRow.insertCell();
        oCell.innerHTML = "<span style='display:inline-block;width:100%;text-align:right;'>"+ totalcaj[i]; + "</span>";
        ...
        oCell3.innerHTML = "<span style='display:inline-block;width:100%;text-align:center;'>"+ cnt +"</span>";    
        ...
        oCell3 = newRow3.insertCell();
        oCell3.innerHTML = "<span style='display:inline-block;width:100%;text-align:right;'>"+ totalcaj[i]+ "</span>";               
        
    }//end for
    
    document.all.jp.innerHTML=jumlahpeti;
    document.all.jkg.innerHTML=jumlahkg;
    document.all.jcaj.innerHTML=jumlahcaj;
    document.all.jekor.innerHTML=jumlahekor;
    document.all.totalcajsemua.innerHTML=parseFloat(window.opener.document.all.CajMasuk.value) + parseFloat(jumlahcaj);
}	            
...
<body>
    ...
    </form><table border="0" style="width: 100%">
        <tr>
            <td style="height: 24px;  text-align: right;" colspan="3">
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Caj Kenderaan Masuk</td>
            <td style="width: 10%; height: 24px;  text-align: left;">
                &nbsp;&nbsp; : RM</td>
            <td style="width: 10%; height: 24px;  text-align: right;">
            </td>
            <td style="width: 10%; height: 24px;  text-align: right;">
            </td>
            <td style="width: 10%; height: 24px;  text-align: right; border-left: black 1px dotted;">
                <asp:Label ID="cajKenderaan" runat="server" Width="100%"></asp:Label></td>
            <td style="width: 15%; height: 24px;  text-align: right;">
            </td>
        </tr>
        <tr>
            ...
            <td style="border-right: black 3px solid; border-top: black 1px dotted; border-left: black 1px dotted; border-bottom: black 3px solid; text-align:right;">
                <asp:Label ID="totalcajsemua" runat="server" Width="100%"></asp:Label></td>
            <td style="width: 15%; height: 24px; text-align: right">
            </td>
        </tr>
    </table>
    ...
    <table style="width: 100%" id="TABLE2">
        <tr>
            <td style="height: 15px">
                <strong><span style="text-decoration: underline">RINGKASAN CAJ PERKHIDMATAN IKAN </span>
                </strong>
            </td>
        </tr>
    </table>
