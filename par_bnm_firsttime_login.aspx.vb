...
'Public fp As par_ibi_user_management

Public Class par_bnm_firsttime_login
            ...
            ElseIf (newpassword.Text = confirmpassword.Text) Then
                ...
                If sqlRdr.HasRows Then
                    ...
                    If passwordStat Then
                        ...
                        sqlText = "Update Pegawai set [first_time_login]='F',kata_laluan='" & pwd & "' where kata_pengguna='" & penggunaSend & "'"
                        ...
                        Else
                            Dim popupScript As String = "<script language='javascript'>" & _
                                                              "alert('Kata Laluan anda telah berjaya dikemaskini.');location.href='mainpage.htm';" & _
                                                              "</script>"
                            Response.Write(popupScript)
                        End If
                    Else
