...
Public Class SQLOperationbangan
...
#Region "Variables Declaration"
    ...
    Protected KPK As Decimal = 0
    Protected KPB As Decimal = 0
    Protected KPPK As Decimal = 0
    Protected KPPB As Decimal = 0
...
#End Region
            ...
            For i = 0 To totRowArray
                ...
                If (skpi_idx > -1) Then
                    ...
                    sqlText = "INSERT INTO [W-ICCS].[dbo].[ITEM_ISYTIHAR_I_KIBFG]" & _
                                                 ...
                                                 "'," & bil_item & ",'" & arrColIkan(3) & "','" & arrColIkan(4) & _
                                                 "'," & arrColIkan(5) & "," & arrColIkan(6) & "," & arrColIkan(7) & _
                                                 "," & arrColIkan(8) & "," & arrColIkan(9) & "," & arrColIkan(10) & "," & arrColIkan(11) & "," & nilaiCajSvr & ",'001'," & cajIkanKodId & "," & nilaiCaj & "," & nilaiKurangCajSvr & ")"
    ...
    Public Sub Generate_eSKPI_Semula_KIBFG(ByVal strValue As String, ByVal strBarcode As String, ByVal PPI As String, ByVal strFishItem As String)
        ...
        For i = 0 To UBound(rowArray) - 1
            ...
            If valStr(6).Trim() = "A" Then 'sebab dia tak buat pembatalan kat periksa so status tak update ke B
                ' If valStr(6).Trim() = "B" Or valStr(6).Trim() = "" Then
...
#End Region
                ...
                If kodPengimport = ieArray(mx).ToString Then
                    ...
                    If myTotalItemSS > 0 Then
                        ...
                        sqlText = "INSERT INTO [W-ICCS].[dbo].[PENGISYTIHARAN_I]" & _
                                                ...
                                                "[Nama_Pegawai],[Nama_PemanduPindahan],[No_KenderaanPindahan],[OnlineSend_by],[Kod_Urusan],[Site_Code],[Nama_Pemandu],[Peti_Biru_Kecil],[Peti_Biru_Besar])" & _
                                                ...
                                                "'" & bekalan & "','A','" & nama_pegawai & "','" & namaPemanduPindahan & "','" & noKenderaanPindahan & "','" & online & "','" & jenisUrusan & "','001','" & namaPemandu & "','" & petiBiruKecil & "','" & petiBiruBesar & "')"
                        transactionProcess.Add(sqlText)
                    End If
    ...
    Public Sub Proses_Pengisytiharan_kibfg(ByVal strImporter As String, ByVal strBarcode As String, ByVal no_daftar As Integer, ByVal no_kenderaan As String, ByVal jenisUrusan As String, ByVal namaPemandu As String, ByVal caraPengangkutan As String, ByVal bekalan As String, ByVal ppi As String, ByVal petiBiruKecil As String, ByVal petiBiruBesar As String, ByVal online As String)
        ...
        '            totalSemuaCaj = (petiBiruKecil * CDbl(KPK)) + (petiBiruBesar * CDbl(KPB))
        '            totalSemuaCajKurang = (petiBiruKecil * CDbl(KPPK)) + (petiBiruBesar * CDbl(KPPB))
        ...
        '            '                        "[Nama_Pegawai],[Nama_PemanduPindahan],[No_KenderaanPindahan],[OnlineSend_by],[Kod_Urusan],[Site_Code],[Nama_Pemandu],[TotalKurangCajIkan],[Peti_Biru_Kecil],[Peti_Biru_Besar],[No_Skpi_Rujukan])" & _
        '            '                        "VALUES('" & strBarcode & "','" & eskpi_val & "','" & no_daftar & "'," & _
        '            '                        "'" & no_kenderaan & "','" & caraPengangkutan & "','" & kodPengimport & "','" & arrImporterCol(4) & "'," & _
        '            '                        "'" & ppi & "'," & _
        '            '                        totalSemuaCaj & "," & _
        '            '                        "'" & bekalan & "','A','" & nama_pegawai & "','" & namaPemanduPindahan & "','" & noKenderaanPindahan & "','" & online & "','" & jenisUrusan & "','001','" & namaPemandu & "','" & totalSemuaCajKurang & "','" & arrImporterCol(6) & "','" & arrImporterCol(7) & "','" & skpi_r & "')"
        ...
        '                                  "'" & ppi & "'," & _
        '                                  totalSemuaCaj & "," & _
        '                                  "'" & bekalan & "','A','" & nama_pegawai & "','" & namaPemanduPindahan & "','" & noKenderaanPindahan & "','" & online & "','" & jenisUrusan & "','001','" & namaPemandu & "','" & totalSemuaCajKurang & "','" & petiBiruKecil & "','" & petiBiruBesar & "','" & skpi_r & "')"
