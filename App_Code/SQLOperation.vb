...
#Region "Variables Declaration"
    ...
    Protected kadarKPKArray As New ArrayList()
    Protected kadarKPBArray As New ArrayList()
    ...
    'Protected kodikanCaj As New ArrayList()


    Protected totalSemuaNilai As Decimal = 0
    Protected totalSemuaCaj As Decimal = 0
    Protected totalSemuaCajKurang As Decimal = 0
...
#End Region
    ...
    Public Function Set_NoDaftar_KIBFG(ByVal strBarcode) As Integer
        ...
        If sqlConn.State = Data.ConnectionState.Open Then
            ...
            sqlText = "Select cast(trans_id as varchar(10)) as trans_id  from p_isytihar_transNo_KIBFG where no_barcode='" & strBarcode & "'"
            ...
            If strData.HasRows Then
                strData.Read()
                valNumber = strData.GetValue(0)
                sqlText = "select count(*) as data from p_isytihar_transNo_KIBFG where trans_id<=" & valNumber & " and " & _
                     "(datepart(d,trans_date)=datepart(d,trans_date)" & _
                     "and datepart(m,trans_date)=datepart(m,trans_date)" & _
                     "and datepart(yy,trans_date)=datepart(yy,trans_date))"
                strData.Close()
            ...
            Else
                strData.Close()
                strData = Nothing
                sqlText = "insert into p_isytihar_transNo_KIBFG(no_barcode)values('" & strBarcode & "');select SCOPE_IDENTITY()"
                Dim execOperation As New System.Data.SqlClient.SqlCommand(sqlText, sqlConn)
                Try
                    valNumber = execOperation.ExecuteScalar()
                    execOperation = Nothing
    ...
    Public Sub Generate_eSKPI(ByVal strValue As String, ByVal strBarcode As String, ByVal PPI As String, ByVal strFishItem As String)
        ...
        For i = 0 To ImporterfishItem.Count - 1
            ...
            ElseIf totalItem > 8 Then
                Dim divTotalSkpi As Integer = math.floor(totalItem / 8)
                Dim modTotalSkpi As Integer = totalItem Mod 8
                If modTotalSkpi > 0 Then
                    totalSkpi = Math.Round(divTotalSkpi, 0) + 1
                ElseIf modTotalSkpi = 0 Then
                    totalSkpi = Math.Round(divTotalSkpi, 0)
                End If
            End If
            ...
            If totalSkpi > 0 Then
                ...
                For ix = 1 To totalSkpi
                    ...
                    'Response.Write("<script>alert('Maklumat Berikut Diperlukan1 :-\n\n');</script>")
    ...
    Public Sub Generate_eSKPI_kibfg(ByVal strValue As String, ByVal strBarcode As String, ByVal PPI As String)
    ...
    Public Sub ProsesFish_Item(ByVal strFish As String, ByVal strBarcode As String, ByVal kodUrusan As String)
        ...
        For mx = 0 To ImporterfishItem.Count - 1
            ...
            For i = 0 To totRowArray
                ...
                'nilaiCaj =math.round(CDbl(arrColIkan(18)),2)
                '' end coded
                ...
                'Dim cariKodSyarikat As String = arrColIkan(0) & "_" & kodeikan
                ...
                If cariKodSyarikatIdx >= 0 Then
                    ...
                    If jkategoriIkanCaj(cariKodSyarikatIdx) = kateIkan Then
                        ...
                        nilaiCajSvr = math.round((CDbl(arrColIkan(5)) * CDbl(kadarPKArrayCaj(cariKodSyarikatIdx))) + (CDbl(arrColIkan(7)) * CDbl(kadarPBArrayCaj(cariKodSyarikatIdx))) + (CDbl(arrColIkan(6)) * CDbl(kadarQtyArrayCaj(cariKodSyarikatIdx))) + (CDbl(arrColIkan(10)) * CDbl(kadarEkorArrayCaj(cariKodSyarikatIdx))), 2)
                    ...
                    Else
                        ...
                        If cajIdx >= 0 Then
                            ...
                            nilaiCajSvr = math.round((CDbl(arrColIkan(5)) * CDbl(kadarPKArray(cajIdx))) + (CDbl(arrColIkan(7)) * CDbl(kadarPBArray(cajIdx))) + (CDbl(arrColIkan(6)) * CDbl(kadarQtyArray(cajIdx))) + (CDbl(arrColIkan(10)) * CDbl(kadarEkorArray(cajIdx))), 2)
    ...
    Public Sub ProsesFish_Item_kibfg(ByVal strFish As String, ByVal strBarcode As String, ByVal kodUrusan As String, ByVal petiBiruKecil As String, ByVal petiBiruBesar As String)
        ...
        For mx = 0 To ImporterfishItem.Count - 1
            ...
            For i = 0 To totRowArray
                ...
                Dim nilaiKurangCajSvr As Double = 0
                ...
                If cariKodSyarikatIdx >= 0 Then
                    ...
                    Else
                        ...
                        If cajIdx >= 0 Then
                            'If jkategoriIkan(cajIdx) = kateIkan Then
                            nilaiCajSvr = math.round((CDbl(arrColIkan(5)) * CDbl(kadarPKArray(cajIdx))) + (CDbl(arrColIkan(7)) * CDbl(kadarPBArray(cajIdx))) + (CDbl(arrColIkan(6)) * CDbl(kadarQtyArray(cajIdx))) + (CDbl(arrColIkan(10)) * CDbl(kadarEkorArray(cajIdx))), 2)
                            nilaiKurangCajSvr = (CDbl(arrColIkan(5)) * CDbl(kadarKPKArray(cajIdx))) + (CDbl(arrColIkan(7)) * CDbl(kadarKPBArray(cajIdx)))
                            'nilaiCajSvr = (CDbl(petiBiruKecil) * CDbl(kadarPKArray(cajIdx))) + (CDbl(petiBiruBesar) * CDbl(kadarPBArray(cajIdx)))
                            'nilaiKurangCajSvr = (CDbl(petiBiruKecil) * CDbl(kadarKPKArray(cajIdx))) + (CDbl(petiBiruBesar) * CDbl(kadarKPBArray(cajIdx)))
                ...
                If (skpi_idx > -1) Then
                    ...
                    sqlText = "INSERT INTO [W-ICCS].[dbo].[ITEM_ISYTIHAR_I_KIBFG]" & _
                                                 ...
                                                 "[Destinasi_Pasar], [PetiKecil], [KuantitiKecil]," & _
                                                 "[PetiBesar], [KuantitiBesar], [Pek], [Ekor], [Nilai]," & _
                                                 "[Caj],[Site_Code],[Caj_Ikan_ID],[CajSvr],[Nilai_Caj_Kurang]) values('" & strBarcode & "','" & eSKPIArray(skpi_idx).ToString() & _
                                                 "'," & bil_item & ",'" & arrColIkan(3) & "','" & arrColIkan(4) & _
                                                 "'," & arrColIkan(5) & "," & arrColIkan(6) & "," & arrColIkan(7) & _
                                                 "," & arrColIkan(8) & "," & arrColIkan(9) & "," & arrColIkan(10) & "," & arrColIkan(11) & "," & nilaiCajSvr & ",'055'," & cajIkanKodId & "," & nilaiCaj & "," & nilaiKurangCajSvr & ")"
                    ...
                    totalPek = totalPek + CDec(arrColIkan(9))
                    totalEkor = totalEkor + CDec(arrColIkan(10))
                    'totalSemuaCajKurang = totalSemuaCajKurang + CDec(nilaiKurangCajSvr)
    ...
    Public Sub Generate_eSKPI_Semula_KIBFG(ByVal strValue As String, ByVal strBarcode As String, ByVal PPI As String, ByVal strFishItem As String)
        ...
        For i = 0 To UBound(rowArray) - 1
            ...
            If valStr(8).Trim() = "A" Then 'sebab dia tak buat pembatalan kat periksa so status tak update ke B
                ' If valStr(6).Trim() = "B" Or valStr(6).Trim() = "" Then
                ...
                If totalSkpi > 0 Then
                    ...
                    For ix = 1 To totalSkpi
                        Dim str_eSKPI As String = PPI.Trim()
                        sqlText = "insert into nosiri_skpi_kibfg(no_barcode,kod_pengimport)values('" & strBarcode & "','" & importerStr(0) & "');select SCOPE_IDENTITY()"
                        str_eSKPI = str_eSKPI & "-" & InsertAutoNumber(sqlText)
                        eSKPIArray.Add(str_eSKPI)
                        ieArray.Add(importerStr(0))
                        idx_skpi = importerStr(0) & "-" & ix
    ...
    Public Sub Load_CajIkan_KIBFG()
        '----ubah sini shah
        Dim sqlText As String = "SELECT RTRIM(Kategori_Ikan) as Kategori_Ikan, RTRIM(Jenis_Urusan) as Jenis_Urusan, Kadar_Peti_Kecil, Kadar_Peti_Besar, Kadar_Ekor, Kadar_Kuantiti, id,Kadar_Kurang_Peti_Kecil,Kadar_Kurang_Peti_Besar " & _
        ...
        Do While cajIkanRdr.Read
            ...
            kadarQtyArray.Add(cajIkanRdr.GetValue(5))
            normalIdIkanCaj.Add(cajIkanRdr.GetValue(6))
            kadarKPKArray.Add(cajIkanRdr.GetValue(7))
            kadarKPBArray.Add(cajIkanRdr.GetValue(8))
        Loop
        cajIkanRdr.Close()
        'cajIkanRdr = Nothing
    ...
    Public Sub Load_CajIkanSyarikat()
        ...
        Dim caj_sqlText As String = "SELECT RTRIM(Kategori_Ikan) as Kategori_Ikan, RTRIM(Jenis_Urusan) as Jenis_Urusan, Kadar_Peti_Kecil, Kadar_Peti_Besar, Kadar_Ekor, Kadar_Kuantiti, Kod_Pengimport +'_'+ RTRIM(Kategori_Ikan) ,id " & _
                                    "FROM COMPANY_IKAN_CAJ WHERE (tarikh_tamat >= GETDATE() and status='yes')"
...
#End Region
    ...
    Public Sub Proses_Pengisytiharan(ByVal strImporter As String, ByVal strBarcode As String, ByVal no_daftar As Integer, ByVal no_kenderaan As String, ByVal jenisUrusan As String, ByVal namaPemandu As String, ByVal caraPengangkutan As String, ByVal bekalan As String, ByVal ppi As String, ByVal online As String)
        'Public Sub Proses_Pengisytiharan(ByVal strImporter As String, ByVal strBarcode As String, ByVal no_daftar As Integer, ByVal no_kenderaan As String, ByVal jenisUrusan As String, ByVal namaPemandu As String, ByVal caraPengangkutan As String, ByVal bekalan As String, ByVal ppi As String, ByVal petiBiruKecil As String, ByVal petiBiruBesar As String, ByVal online As String)
            ...
            For i = 0 To UBound(arrImporterRow) - 1
                ...
                If kodPengimport = ieArray(mx).ToString Then
                    ...
                    sqlText = "SELECT No_SKPI, SUM(PetiKecil) AS TPK, SUM(KuantitiKecil) AS TQK, SUM(PetiBesar) AS TPB, SUM(KuantitiBesar) AS TQB, SUM(Pek) AS tpek, SUM(Ekor) " & _
                              "AS ekor, SUM(Nilai) AS tnilai, round((SUM(Caj)),2) AS tcaj FROM ITEM_ISYTIHAR_I WHERE Nombor_Barcode ='" & strBarcode & "' AND No_SKPI ='" & eskpi_val & "' " & _
                              "GROUP BY No_SKPI"
                    ...
                    If myTotalItemSS > 0 Then
                        ...
                        sqlText = "INSERT INTO [W-ICCS].[dbo].[PENGISYTIHARAN_I]" & _
                                                ...
                                                "[Nama_Pegawai],[Nama_PemanduPindahan],[No_KenderaanPindahan],[OnlineSend_by],[Kod_Urusan],[Site_Code],[Nama_Pemandu],[Peti_Biru_Kecil],[Peti_Biru_Besar],[No_Kontena],[Gst])" & _
                                                ...
                                                "'" & bekalan & "','A','" & nama_pegawai & "','" & namaPemanduPindahan & "','" & noKenderaanPindahan & "','" & online & "','" & jenisUrusan & "','055','" & namaPemandu & "','" & arrImporterCol(6) & "','" & arrImporterCol(7) & "','" & arrImporterCol(8) & "', '" & gst & "')"
    ...
    Public Sub Proses_Pengisytiharan_kibfg(ByVal strImporter As String, ByVal strBarcode As String, ByVal no_daftar As Integer, ByVal no_kenderaan As String, ByVal jenisUrusan As String, ByVal namaPemandu As String, ByVal caraPengangkutan As String, ByVal bekalan As String, ByVal ppi As String, ByVal online As String)
        ' Public Sub Proses_Pengisytiharan_kibfg(ByVal strImporter As String, ByVal strBarcode As String, ByVal no_daftar As Integer, ByVal no_kenderaan As String, ByVal jenisUrusan As String, ByVal namaPemandu As String, ByVal caraPengangkutan As String, ByVal bekalan As String, ByVal ppi As String, ByVal petiBiruKecil As String, ByVal petiBiruBesar As String, ByVal online As String)
        Dim i As Integer
        Dim arrImporterRow() = strImporter.Split("~")
        Dim mx As Integer
        Dim kodimporter As String = ""
        ...
        For mx = 0 To eSKPIArray_Index.Count - 1
            ...
            For i = 0 To UBound(arrImporterRow) - 1
                ...
                If kodPengimport = ieArray(mx).ToString Then
                    ...
                    End If
                    '-----------------utk rebat amik skpi sama dgn asal cuma tambah R depan
                    Dim sqlText1 As String = ""
                    Dim skpi_r As String = ""
                    Dim skpi_r1 As String = ""


                    sqlText1 = "SELECT  no_skpi FROM PENGISYTIHARAN_I WHERE No_Barcode ='" & strBarcode & "'  and kod_pengimport='" & kodPengimport & "'"



                    Dim myCaj1 As System.Data.SqlClient.SqlDataReader = DataReader(sqlText1)

                    If myCaj1.HasRows Then

                        myCaj1.Read()

                        skpi_r = "R" + myCaj1.GetValue(0)
                        skpi_r1 = myCaj1.GetValue(0)
                    ...
                    '----------------------------amik kadar cak dari table ikan caj bukan dari item isytihar i
                    Dim KPK As Decimal
                    Dim KPB As Decimal
                    Dim KPPK As Decimal
                    Dim KPPB As Decimal
                    Dim sqlText As String = ""
                    sqlText = "SELECT  SUM(Kadar_Peti_Kecil) AS KPK, SUM(Kadar_Peti_Besar) AS KPB, SUM(Kadar_Kurang_Peti_Kecil) AS KKPK, SUM(Kadar_Kurang_Peti_Besar) AS KKPB " & _
                    ...
                    If myCaj.HasRows Then
                        ...
                        KPK = myCaj.GetValue(0)
                        KPB = myCaj.GetValue(1)
                        KPPK = myCaj.GetValue(2)
                        KPPB = myCaj.GetValue(3)

                    End If
                    myCaj.Close()
                    myCaj = Nothing

                    totalSemuaCaj = (arrImporterCol(6) * CDbl(KPK)) + (arrImporterCol(7) * CDbl(KPB))
                    totalSemuaCajKurang = (arrImporterCol(6) * CDbl(KPPK)) + (arrImporterCol(7) * CDbl(KPPB))
                    ...
                    'sqlText3 = "SELECT No_SKPI, SUM(PetiKecil) AS TPK, SUM(KuantitiKecil) AS TQK, SUM(PetiBesar) AS TPB, SUM(KuantitiBesar) AS TQB, SUM(Pek) AS tpek, SUM(Ekor) " & _
                    '          "AS ekor, SUM(Nilai) AS tnilai, round((SUM(Caj)),2) AS tcaj, sum(nilai_caj_kurang) AS tkcaj FROM ITEM_ISYTIHAR_I_KIBFG WHERE Nombor_Barcode ='" & strBarcode & "' AND No_SKPI ='" & eskpi_val & "' " & _
                    '          "GROUP BY No_SKPI"

                    sqlText3 = "SELECT  SUM(totalcajikan) AS tcaj FROM pengisytiharan_i where No_Barcode ='" & strBarcode & "' AND kod_pengimport='" & kodPengimport & "' "
                    Dim myCaj4 As System.Data.SqlClient.SqlDataReader = DataReader(sqlText3)

                    If myCaj4.HasRows Then
                        myCaj4.Read()
                        'totalPetiKecil = myCaj4.GetValue(1)
                        'totalKuantitiKecil = myCaj4.GetValue(2)
                        'totalPetiBesar = myCaj4.GetValue(3)
                        'totalKuantitiBesar = myCaj4.GetValue(4)
                        'totalPek = myCaj4.GetValue(5)
                        'totalEkor = myCaj4.GetValue(6)
                        totalSemuaNilai = myCaj4.GetValue(0)
                        'totalSemuaCaj = myCaj4.GetValue(8)
                        'totalSemuaCajKurang = myCaj4.GetValue(9)
                    End If
                    myCaj4.Close()
                    myCaj4 = Nothing
                    ...
                    'Dim myTotalItemSS As Integer = 0
                    'Dim myDataS As String = ""
                    'sqlText = "select count(*) as rectotal from item_isytihar_i_kibfg where nombor_barcode='" & strBarcode & "' and no_skpi='" & eskpi_val & "'"
                    'myDataS = SingleFieldResults(sqlText)
                    'If myDataS <> "" Then
                    '    myTotalItemSS = CInt(myDataS)
                    'End If
                    ...
                    If kodPengimport <> kodimporter Then
                        sqlText = "INSERT INTO [W-ICCS].[dbo].[PENGISYTIHARAN_I_KIBFG]" & _
                                                               "([No_Barcode], [No_SKPI], [No_Daftar], [No_Kenderaan]," & _
                                                               "[Cara_Pengangkutan], [Kod_Pengimport], [Kod_Pengeksport]," & _
                                                               "[Kod_PPI], " & _
                                                               "[TotalCajIkan], [Sumber_Bekalan], [Status]," & _
                                                               "[Nama_Pegawai],[Nama_PemanduPindahan],[No_KenderaanPindahan],[OnlineSend_by],[Kod_Urusan],[Site_Code],[Nama_Pemandu],[TotalKurangCajIkan],[Peti_Biru_Kecil],[Peti_Biru_Besar],[no_rujukan_skpi],[TotalNilai])" & _
                                                               "VALUES('" & strBarcode & "','" & eskpi_val & "','" & no_daftar & "'," & _
                                                               "'" & no_kenderaan & "','" & caraPengangkutan & "','" & kodPengimport & "','" & arrImporterCol(4) & "'," & _
                                                               "'" & ppi & "'," & _
                                                               totalSemuaCaj & "," & _
                                                               "'" & bekalan & "','A','" & nama_pegawai & "','" & namaPemanduPindahan & "','" & noKenderaanPindahan & "','" & online & "','" & jenisUrusan & "','055','" & namaPemandu & "','" & totalSemuaCajKurang & "','" & arrImporterCol(6) & "','" & arrImporterCol(7) & "','" & skpi_r & "','" & totalSemuaNilai & "')"


                        transactionProcess.Add(sqlText)

                        sqlText = "UPDATE PENGISYTIHARAN_I Set peti_biru_kecil='" & arrImporterCol(6) & "',peti_biru_besar='" & arrImporterCol(7) & "' WHERE No_Barcode = '" & strBarcode & "'  and kod_pengimport='" & kodPengimport & "' "
                        transactionProcess.Add(sqlText)

                        'ElseIf kodPengimport = kodimporter Then

                        '    arrImporterCol(6) = "0"
                        '    arrImporterCol(7) = "0"
                        '    totalSemuaCaj = 0.0
                        '    totalSemuaCajKurang = 0.0
                        ...
                        '                                           "[Kod_PPI], " & _
                        '                                           "[TotalCajIkan], [Sumber_Bekalan], [Status]," & _
                        '                                           "[Nama_Pegawai],[Nama_PemanduPindahan],[No_KenderaanPindahan],[OnlineSend_by],[Kod_Urusan],[Site_Code],[Nama_Pemandu],[TotalKurangCajIkan],[Peti_Biru_Kecil],[Peti_Biru_Besar],[no_rujukan_skpi])" & _
                        '                                           "VALUES('" & strBarcode & "','" & eskpi_val & "','" & no_daftar & "'," & _
                        '                                           "'" & no_kenderaan & "','" & caraPengangkutan & "','" & kodPengimport & "','" & arrImporterCol(4) & "'," & _
                        '                                           "'" & ppi & "'," & _
                        '                                           totalSemuaCaj & "," & _
                        '                                           "'" & bekalan & "','A','" & nama_pegawai & "','" & namaPemanduPindahan & "','" & noKenderaanPindahan & "','" & online & "','" & jenisUrusan & "','001','" & namaPemandu & "','" & totalSemuaCajKurang & "','0','0','" & skpi_r & "')"
                ...
                If kodPengimport = ieArray(mx).ToString Then
                    ...
                    If myTotalItemSS > 0 Then
                        ...
                        sqlText = "INSERT INTO [W-ICCS].[dbo].[PENGISYTIHARAN_I]" & _
                                                ...
                                                "'" & ppi & "'," & totalPetiKecil & "," & totalKuantitiKecil & "," & totalPetiBesar & "," & _
                                                totalKuantitiBesar & "," & totalPek & "," & totalEkor & "," & totalSemuaNilai & "," & totalSemuaCaj & "," & _
                                                "'" & bekalan & "','A','" & nama_pegawai & "','" & namaPemanduPindahan & "','" & noKenderaanPindahan & "','" & online & "','" & jenisUrusan & "','055')"
                        transactionProcess.Add(sqlText)
                    End If
                    'InsertData(sqlText)
                End If
    ...
    End Function
    Public Function VerifyItemIsytiharKIBFG(ByVal arrval As String) As Boolean
        'Dim i As Integer
        'Dim arrImporterRow() = arrval.Split("~")
        'foundImportErr = False
