<%@ Page Language="VB" AutoEventWireup="false" CodeFile="v_pengisyitiharan.aspx.vb" Inherits="View_Import_pengisyitiharan" %>
...
{
var str ="eSKPI-P.aspx?barcode="+document.all.Barcodes.value;
window.open(str,'eSKPI','');
//MM_openBrWindow(str,'eSKPI',''); 
var winTitle;

winTitle = "SALINAN LKIM-BUKIT KAYU HITAM";
str ="crMasterSheetImport.aspx?item=1&barcode="+ document.all.Barcodes.value +"&invois_id="+document.all.Invois_Id.value+"&SalinanMs="+ escape(winTitle);
window.open(str,'LKIM','');

winTitle = "SALINAN AGEN PENGANGKUTAN";
str ="crMasterSheetImport.aspx?item=2&barcode="+ document.all.Barcodes.value +"&invois_id="+document.all.Invois_Id.value+"&SalinanMs="+ escape(winTitle);
window.open(str,'AGEN','');

winTitle = "SALINAN PERSATUAN NELAYAN NEGERI KEDAH-NEKAD";
str ="crMasterSheetImport.aspx?item=3&barcode="+ document.all.Barcodes.value +"&invois_id="+document.all.Invois_Id.value+"&SalinanMs="+ escape(winTitle);
window.open(str,'PERSATUAN','');

winTitle = "SALINAN PERSATUAN NELAYAN NEGERI KEDAH-NEKAD";
str ="ePermit_I.aspx?barcode="+ document.all.Barcodes.value +"&CurrentInvois="+document.all.Invois_Id.value;
window.open(str,'EPERMIT','');
   ...
   // var dataItem4 = document.all.Exporter;
    ...
    else
    {
        ...
        if (stat=="false")
        {
            ...
            document.all.arrayVal.value = document.all.arrayVal.value + document.all.Importer.value + '`' +document.all.searchKodImporter.value + '`' + dataItem2.options.value +'`'+ dataItem3.options.value + '`' + document.all.Exporter.value + '`' +document.all.searchKodExporter.value +'`' + document.all.PetiBiruKecil.value +  '`' + document.all.PetiBiruBesar.value +  '`' + document.all.NoKontena.value +'~';
...
//            document.all.Exporter.value="";
        ...
        {
            alert('Pengimport '+ document.all.searchKodExporter.value  +' telah wujud di dalam senarai!!!');
        }
   } 
  }
  else
    ...
    if (currImporter!="")
    {
        ...
        for (i=0;i<arrIkanInfo.length; i++)
        {
            ...
            {         	
                ...
                var oCell = newRow.insertCell();
                oCell.innerHTML = arrIkanInfoDetails[1];			
                oCell = newRow.insertCell();
        ...
        <table style="width: 100%">
            <tr>
                <td colspan="4" style="height: 18px; background-color:#0000cc;">
                    <strong>&nbsp;<span style="color: #ffffff">PAPARAN MAKLUMAT PENGISYTIHARAN <%=namaJenisUrusan.ToUpper()%></span></strong></td>
            </tr>
            <tr>
                <td>
                </td>
    ...
    <table style="width: 100%">
        ...
        <tr>
         ...
         <table id="tblGridImporter" border="0" style="border-right: gray thin groove;
             ...
             <tr>
                 <td style="background-color:#f1f1f1; width:7%; height: 24px;">
                     No.</td>
                 <td style="background-color:#f1f1f1; width:22%; height:24px">
                     Pengimport</td>
                 <td style="background-color:#f1f1f1; width:14%; height:24px">
                     No. Lesen</td>
                 <td style="background-color:#f1f1f1; width:10%; height:24px">
                     Tarikh Luput</td>
                 <td style="background-color:#f1f1f1; width:20%; height:24px">
                     Pengeksport</td>
                 <td style="background-color:#f1f1f1; width:9%; height:24px">
                     Bil. Peti Biru Kecil</td>
                 <td style="background-color:#f1f1f1; width:10%; height:24px">
                     Bil. Peti Biru Besar</td>
                 <td style="background-color:#f1f1f1; width:10%; height:24px">
                     No. Kontena</td>
                 <td style="background-color:#f1f1f1; width:15%; height:24px">
                     Kod Pengimport</td>
             </tr>        
         ...
         <input id="Button3" type="button" value="Tambah" style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1;" onclick="AddArray();refreshTableGridIkan();" disabled="disabled"  />
          <input id="Button4" type="button" value="Batal" style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1; width: 61px;" onclick="RemoveArray()" disabled="disabled" /><div><asp:HiddenField ID="arrayVal" runat="server" /><asp:HiddenField ID="arrayFishVal" runat="server" />
        ...
        <table border="0" style="width: 100%;">
            <tbody>
                 <tr>
                    ...
                    <input id="Button1" type="button" value="Tambah" style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1;" onclick="AddFishArray();" disabled="disabled"  /><input id="Button2" type="button" value="Batal" style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1; width: 50px;" onclick="removeRow()" disabled="disabled" /></strong></span></td>
        ...
        <asp:Label ID="Label8" runat="server" Font-Bold="True" Text="0" Width="82px"></asp:Label>
         &nbsp; &nbsp; &nbsp;&nbsp; <strong>Jumlah Peti Biru Kecil&nbsp; :
             <asp:TextBox ID="PetiBiruKecil" runat="server" Width="93px" ReadOnly="True"></asp:TextBox>
             &nbsp; &nbsp; Jumlah Peti Biru Besar&nbsp; :&nbsp;
             <asp:TextBox ID="PetiBiruBesar" runat="server" Width="93px" ReadOnly="True"></asp:TextBox></strong><br />
        &nbsp;
        <hr /><input id="Button6" type="button" value="BARU" style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1;" onclick="location.href='../pintu_masuk/verifikasi_PintuMasuk.aspx';"  /><asp:Button ID="Simpan" runat="server" Text="SIMPAN" style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1;" Enabled="False" /><asp:Button ID="Button8" runat="server" Text="CETAK SKPI" style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1;" Enabled="False" OnClientClick="printReport();" UseSubmitBehavior="False"/>
        <asp:Button ID="Button7" runat="server" Text="PAPAR PENGISYTIHARAN KOTAK INSULASI" style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1;" Enabled="True" Visible="False"/>
