<%@ Page Language="VB" AutoEventWireup="false" CodeFile="pengisyitiharan_pindahan.aspx.vb"
    Inherits="Import_pengisyitiharan_p" %>
...
function resetForms()
{
    ...
    location.href="pengisyitiharan_pindahan.aspx?barcode="+document.all.Barcodes.value;
}
...
var str ="http://report.lkim.gov.my/import/eSKPI-P.aspx?barcode="+ document.all.Barcodes.value +"&invois_id="+document.all.Invois_Id.value+"&SalinanMs="+ escape(winTitle)+"&cajPBI="+ cajPBI +"&cajPK="+ cajPK +"&cajKdrEkor"+ cajKdrEkor +"&cajKdrQty="+ cajKdrQty +"&cetak="+ strCetak+"&pname="+document.all.printer_name.value;
str ="eSKPI-P.aspx?barcode="+ document.all.Barcodes.value +"&invois_id="+document.all.Invois_Id.value+"&SalinanMs="+ escape(winTitle)+"&cajPBI="+ cajPBI +"&cajPK="+ cajPK +"&cajKdrEkor"+ cajKdrEkor +"&cajKdrQty="+ cajKdrQty +"&cetak="+ strCetak+"&pname="+document.all.printer_name.value;
    ...
    {    
        ...
        else
        {
            ...
            if (stat=="false")
            {
                ...
                //document.all.arrayVal.value = document.all.arrayVal.value + dataItem1 + '`' + document.all.searchKodImporter.value  + '`' + dataItem2.options.value +'`'+ dataItem3.options.value + '`' + dataItem4 + '`' + document.all.searchKodExporter.value +'`'+ document.all.nama_pemandu_pindahan.value +'`'+ document.all.no_kenderaan_pindahan.value +'~';
           ...
           if (searchItem==KodBKHNew[i])
            {
                ...
                showFilteredCompanyIkanCaj(document.all.currentImporter.value,document.all.JenisUrusan.options.value,MKodKategoriIkan[i])
                if (chargeFound==0)
                {
                    showFilteredIkanCaj(document.all.JenisUrusan.options.value,MKodKategoriIkan[i])
                }
    ...
    <form id="form1" runat="server">
        ...
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td style="height: 21px">
                    <asp:DropDownList ID="Bekalan" runat="server" DataSourceID="SumberBekalan" DataTextField="Nama_Negara"
                        DataValueField="Kod_Negara">
                    </asp:DropDownList></td>
                <td style="height: 21px">
                    <strong>Kompleks/PPI</strong></td>
                <td style="height: 21px">
                    <strong>
                        <asp:DropDownList ID="KompleksPPI" runat="server" DataSourceID="PPI" DataTextField="Nama_PPI"
                            DataValueField="Kod_PPI">
        ...
        </table><input id="Button3" type="button" value="Tambah" style="border-right: #333333 1px ridge;
            ...
            onclick="AddArray();refreshTableGridIkan();" />
        <input id="Button4" type="button" value="Batal" style="border-right: #333333 1px ridge;
            padding-right: 1px; border-top: #ffffff 1px ridge; padding-left: 1px; font-size: 10px;
            padding-bottom: 1px; border-left: #ffffff 1px ridge; color: #000000; padding-top: 1px;
            border-bottom: #000000 1px ridge; font-family: MS Shell Dlg,verdana,??; background-color: #f1f1f1;
            width: 61px;" onclick="RemoveArray()" />
        ...
        <div>
                ...
                <asp:HiddenField ID="arrayFishVal" runat="server" />
        ...
        <table style="width: 100%; border-top-width: thin; border-left-width: thin; border-bottom-width: thin;
            border-right-width: thin;" border="0">
              <tr>
                <td style="width: 55px">
            ...
            <tr>
                ...
                <td style="height: 23px">
                    <asp:TextBox ID="txtPetiKecil" runat="server" Width="100%"></asp:TextBox></td>
                <td style="height: 23px">
                    <asp:TextBox ID="txtKuantitiKecil" runat="server" Width="100%"></asp:TextBox></td>
                <td style="height: 23px">
                    <asp:TextBox ID="txtPetiBesar" runat="server" Width="100%"></asp:TextBox></td>
                <td style="height: 23px">
                    <asp:TextBox ID="txtKuantitiBesar" runat="server" Width="100%"></asp:TextBox></td>
        ...
        <div class="scrollingdatagrid" style="width:100%;height:110px;left: 0px; top: 0px;">
         <table id="tblGrid" border="0" width="100%">
            ...
            <table id="Table2" border="0" style="width: 98.7%;">
            <tr>
        ...
        <input id="Button9"
                onclick="openMasterSheet();" style="border-right: #333333 1px ridge; padding-right: 1px;
                border-top: #ffffff 1px ridge; padding-left: 1px; font-size: 10px; padding-bottom: 1px;
                border-left: #ffffff 1px ridge; width: 131px; color: #000000; padding-top: 1px;
                border-bottom: #000000 1px ridge; font-family: MS Shell Dlg,verdana,??; background-color: #f1f1f1"
                type="button" value="PAPAR MASTERSHEET" /><asp:Button
                ID="Simpan" runat="server" Text="SIMPAN" Style="border-right: #333333 1px ridge;
                padding-right: 1px; border-top: #ffffff 1px ridge; padding-left: 1px; font-size: 10px;
                padding-bottom: 1px; border-left: #ffffff 1px ridge; color: #000000; padding-top: 1px;
                border-bottom: #000000 1px ridge; font-family: MS Shell Dlg,verdana,??; background-color: #f1f1f1;" OnClientClick="return pastiKanData();"
                /><input id="Button10" runat="server" disabled="disabled" onclick="printReport('1');"
                    ...
                    background-color: #f1f1f1" type="button" value="CETAK SKPI" /><input id="Button5"
                        runat="server" disabled="disabled" onclick="printReport('0');" style="border-right: #333333 1px ridge;
                        padding-right: 1px; border-top: #ffffff 1px ridge; padding-left: 1px; font-size: 10px;
                        padding-bottom: 1px; border-left: #ffffff 1px ridge; color: #000000; padding-top: 1px;
                        border-bottom: #000000 1px ridge; font-family: MS Shell Dlg,verdana,??; background-color: #f1f1f1"
                        type="button" value="PAPAR CETAKKAN" />
        <input id="Button1" runat="server" disabled="disabled" onclick="showSenaraiprinter();"
            style="border-right: #333333 1px ridge; padding-right: 1px; border-top: #ffffff 1px ridge;
            padding-left: 1px; font-size: 10px; padding-bottom: 1px; border-left: #ffffff 1px ridge;
            color: #000000; padding-top: 1px; border-bottom: #000000 1px ridge; font-family: MS Shell Dlg,verdana,??;
            background-color: #f1f1f1" type="button" value="PILIH PRINTER" />
        <asp:Button
                        ID="Keluar" runat="server" Text="KELUAR" Style="border-right: #333333 1px ridge;
                        padding-right: 1px; border-top: #ffffff 1px ridge; padding-left: 1px; font-size: 10px;
                        padding-bottom: 1px; border-left: #ffffff 1px ridge; color: #000000; padding-top: 1px;
                        border-bottom: #000000 1px ridge; font-family: MS Shell Dlg,verdana,??; background-color: #f1f1f1;" />
        &nbsp;&nbsp;&nbsp;<br />
        ...
        <cc1:FilteredTextBoxExtender ID="txtNilaiKeyboardRestrictor" runat="server" TargetControlID="txtNilai"
            FilterType="Custom,Numbers" ValidChars=",-.">
        </cc1:FilteredTextBoxExtender>
        <cc1:FilteredTextBoxExtender ID="PetiKecilRestrictor" runat="server" TargetControlID="txtPetiKecil"
            FilterType="Numbers">
        </cc1:FilteredTextBoxExtender>
        <cc1:FilteredTextBoxExtender ID="PetiBesarRestrictor" runat="server" TargetControlID="txtPetiBesar"
            FilterType="Numbers">
        </cc1:FilteredTextBoxExtender>
        <cc1:FilteredTextBoxExtender ID="QtyKecilRestrictor" runat="server" TargetControlID="txtKuantitiKecil"
            FilterType="Custom,Numbers" ValidChars=".">
        </cc1:FilteredTextBoxExtender>
        <cc1:FilteredTextBoxExtender ID="QtyBesarRestrictor" runat="server" TargetControlID="txtKuantitiBesar"
            FilterType="Custom,Numbers" ValidChars=".">
        </cc1:FilteredTextBoxExtender>
        <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" TargetControlID="txtKuantitiKecil"
            FilterType="Custom,Numbers" ValidChars=",-.">
        </cc1:FilteredTextBoxExtender>
        <cc1:FilteredTextBoxExtender ID="ekorRestrictor" runat="server" TargetControlID="txtEkor"
            FilterType="Custom,Numbers" ValidChars=",-.">
        </cc1:FilteredTextBoxExtender>
        <cc1:FilteredTextBoxExtender ID="PekRestrictor" runat="server" TargetControlID="txtPek"
            FilterType="Custom,Numbers" ValidChars=",-.">
        </cc1:FilteredTextBoxExtender>
        &nbsp; &nbsp;<br />
        &nbsp;<br />
