...
#End Region
        ...
        If Button5.Page.IsPostBack = True Then
            ...
            If NamaPemandu.Text <> "" And arrayVal.Value <> "" And arrayFishVal.Value <> "" Then
                ...
                Else
                    ...
                    'Response.Write(arrayFishVal.Value)
                    'Response.Write("asasasa" & kpk.Value)
                    ...
                    'Response.Write(arrayVal)
                    'Inserting Importer Information Into Pengisytiharan_I
                    'opClass.Proses_Pengisytiharan(arrayVal.Value, Barcodes.Text, no_daftar, noKenderaan.Text, JenisUrusan.SelectedItem.Value, NamaPemandu.Text, cara_pengangkutan.SelectedItem.Value, Bekalan.SelectedItem.Value, KompleksPPI.SelectedItem.Value, PetiBiruKecil.Text, PetiBiruBesar.Text, Nothing)
                    opClass.Proses_Pengisytiharan(arrayVal.Value, Barcodes.Text, no_daftar, noKenderaan.Text, JenisUrusan.SelectedItem.Value, NamaPemandu.Text, cara_pengangkutan.SelectedItem.Value, Bekalan.SelectedItem.Value, KompleksPPI.SelectedItem.Value, Nothing)
    ...
    Protected Sub Button7_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button7.Click
        ...
        strUrlshah = "../import/pengisyitiharan_baru.aspx?&barcode=" & Barcodes.Text + "&namapemandu=" + NamaPemandu.text
