...
Partial Class View_Import_pengisyitiharan
...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            sqlText = "SELECT DISTINCT RTRIM(PENGISYTIHARAN_I.Kod_Pengimport) + '|' + RTRIM(PENGIMPORT.No_Lesen) + '|' + " & _
                      ...
                      "+ '`' + PENGEKSPORT_THAILAND.Nama_Pengeksport +  '`'+ PENGISYTIHARAN_I.Peti_Biru_Kecil + '`'+ PENGISYTIHARAN_I.Peti_Biru_Besar + '`'+ PENGISYTIHARAN_I.No_Kontena + '~'" & _
                      " AS data, PENGISYTIHARAN_I.STATUS, PENGISYTIHARAN_I.KOD_URUSAN,JENIS_URUSAN.NAMA_URUSAN,PENGISYTIHARAN_I.ONLINESEND_BY,PENGISYTIHARAN_I.PETI_BIRU_KECIL,PENGISYTIHARAN_I.PETI_BIRU_BESAR,PENGISYTIHARAN_I.NO_KONTENA  " & _
        ...
        If Simpan.Page.IsPostBack Then
            ...
            If NamaPemandu.Text <> "" And arrayVal.Value <> "" And arrayFishVal.Value <> "" And Barcodes.Text <> "" Then
                ...
                Else
                    ...
                    sqltext = "delete  from item_isytihar_i where nombor_barcode='" + rujukan.Text + "'" & _
                              " and no_skpi not in (select no_skpi from pengisytiharan_i where no_barcode='" + rujukan.Text + "' )"
                    opClass.InsertData(sqlText)
    ...
    Protected Sub Button7_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button7.Click
        ...
        strUrlshah = "../import/v_pengisyitiharan_kibfg.aspx?&barcode=" & Barcodes.Text
