...
Partial Class _Default
    ...
    Private Sub ConfigureCrystalReports()
        ...
        Dim selectFormula As String = "{PENGISYTIHARAN_I_KIBFG.No_Barcode} = '" & Request("barcode") & "' AND {PENGISYTIHARAN_I_KIBFG.Status} = 'A' and {PENGISYTIHARAN_I_KIBFG.No_SKPI} = '" & request("skpi") & "'"
