<%@ Page Language="VB" AutoEventWireup="false" CodeFile="v_pengisyitiharan_pindahan.aspx.vb" Inherits="View_Import_pengisyitiharan_p" %>
...
<body>
        ...
        <table style="width: 100%">
            <tr>
                <td colspan="4" style="height: 18px; background-color:#0000cc;">
                    <strong>&nbsp;<span style="color: #ffffff">PAPARAN PENGISYTIHARAN PINDAHAN BARANGAN</span></strong></td>
            </tr>
            <tr>
                <td>
                </td>
    ...
    <table style="width: 100%">
         ...
         <table id="tblGridImporter" border="0" style="border-right: gray thin groove;
             ...
             <tr>
                 <td style="background-color:#f1f1f1; width:7%">
                     No.</td>
                 <td style="background-color:#f1f1f1; width:20%; height:22px">
                     Pengimport</td>
                 <td style="background-color:#f1f1f1; width:16%; height:22px">
                     No. Lesen</td>
                 <td style="background-color:#f1f1f1; width:10%; height:22px">
                     Tarikh Luput</td>
                 <td style="background-color:#f1f1f1; width:20%; height:22px">
                     Pengeksport</td>
                 <td style="background-color:#f1f1f1; width:10%; height:22px">
        ...
        <asp:Label ID="Label8" runat="server" Font-Bold="True" Text="0" Width="82px"></asp:Label>
         ...
         &nbsp; &nbsp; <strong>Jumlah Peti Biru Besar </strong><strong>:</strong>&nbsp;
         <asp:TextBox ID="PetiBiruBesar" runat="server" Width="93px" ReadOnly="True"></asp:TextBox><br />
         <br />
        &nbsp;
        <hr /><input id="Button6" type="button" value="BARU" style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1;" onclick="location.href='../pintu_masuk/verifikasi_PintuMasuk.aspx';"  /><asp:Button ID="Simpan" runat="server" Text="SIMPAN" style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1;" Enabled="False" /><asp:Button ID="Button5" runat="server" Text="CETAK SKPI" style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1;" Enabled="False" OnClientClick="printReport();" /><asp:Button ID="Keluar" runat="server" Text="KELUAR" style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1;"/><br />
        <br />
        <br />
        <br />
                &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;
