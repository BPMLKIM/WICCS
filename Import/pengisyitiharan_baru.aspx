<%@ Page Language="VB" AutoEventWireup="false" CodeFile="pengisyitiharan_baru.aspx.vb" Inherits="Import_pengisyitiharan_baru" %>
...
<head runat="server">
    <title>[WICCS]-Pengisytiharan <%=namaJenisUrusan%> Bagi Kotak Insulasi</title>    
...
var str ="http://report.lkim.gov.my/import/eSKPI_KIBFG.aspx?barcode="+ document.all.Barcodes.value +"&invois_id="+document.all.Invois_Id.value+"&SalinanMs="+ escape(winTitle)+"&cajPBI="+ cajPBI +"&cajPK="+ cajPK +"&cajKdrEkor"+ cajKdrEkor +"&cajKdrQty="+ cajKdrQty +"&cetak="+ strCetak+"&pname="+document.all.printer_name.value;

str ="eSKPI_KIBFG.aspx?barcode="+ document.all.Barcodes.value +"&invois_id="+document.all.Invois_Id.value+"&SalinanMs="+ escape(winTitle)+"&cajPBI="+ cajPBI +"&cajPK="+ cajPK +"&cajKdrEkor"+ cajKdrEkor +"&cajKdrQty="+ cajKdrQty +"&cetak="+ strCetak+"&pname="+document.all.printer_name.value;
...
if (strCetak==1)
{
    ...
    {    
      window.open(str,'eSKPI_KIBFG','width=5,height=5,status=yes');
    }
    else
    {
...
{
 var strUrl="v_mastersheet_KIBFG.aspx";
  ...
  <table style="width: 100%">
    <tr> 
      <td colspan="4" style="height: 18px; background-color:#0000cc;"> <strong>&nbsp;<span style="color: #ffffff">PENGISYTIHARAN 
        <%=namaJenisUrusan.ToUpper() %> BAGI KOTAK INSULASI</span></strong></td>
    </tr>
    <tr> 
      <td> </td>
      <td> </td>
