<%@ Page Language="VB" AutoEventWireup="false" CodeFile="pengisyitiharanbangan.aspx.vb" Inherits="Import_pengisyitiharan" %>
...
function AddArray()
{
    ...
    //rebat punya//
    var dataItem4=document.all.PetiBiruKecil;
    var dataItem5=document.all.PetiBiruBesar;
   ...
   // var dataItem4 = document.all.Exporter;
    ...
    else
    {
        ...
        if (stat=="false")
        {
           ...
           document.all.arrayVal.value = document.all.Importer.value + '`' +document.all.searchKodImporter.value + '`' + dataItem2.options.value +'`'+ dataItem3.options.value + '`' + document.all.Exporter.value + '`' +document.all.searchKodExporter.value + '`' + document.all.PetiBiruKecil.value +'`'+ document.all.PetiBiruBesar.value + '~' + document.all.arrayVal.value;  
            ...
            //rebat
               var myString =document.all.Importer.value + '`' + document.all.searchKodImporter.value + '`' + dataItem2.options.value +'`'+ dataItem3.options.value + '`' + document.all.Exporter.value + '`' + document.all.searchKodExporter.value + '`' + document.all.PetiBiruKecil.value +'`'+ document.all.PetiBiruBesar.value + '~';
    ...
    <table style="width: 100%">
        ...
        <tr>
            <td colspan="4">
             ...
             <asp:TextBox ID="PetiBiruBesar" runat="server" Width="93px"></asp:TextBox><br />
