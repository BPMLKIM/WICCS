<%@ Page Language="VB" AutoEventWireup="false" CodeFile="v_pengisyitiharan_kibfg.aspx.vb" Inherits="View_Import_pengisyitiharan_kibfg" %>
        ...
        <table style="width: 100%">
            <tr>
                <td colspan="4" style="height: 18px; background-color:#0000cc;">
                    <strong>&nbsp;<span style="color: #ffffff">PAPARAN MAKLUMAT PENGISYTIHARAN &nbsp;<%=namaJenisUrusan.ToUpper()%> BAGI KOTAK INSULASI</span></strong></td>
            </tr>
            <tr>
                <td>
                </td>
