<%@ Page Language="VB" AutoEventWireup="false" CodeFile="pengisyitiharan.aspx.vb" Inherits="Import_pengisyitiharan" %>
...
<head runat="server">
    <title>[WICCS]-Pengisytiharan <%=namaJenisUrusan%></title>    
...
var str ="http://report.lkim.gov.my/import/eSKPI.aspx?barcode="+ document.all.Barcodes.value +"&invois_id="+document.all.Invois_Id.value+"&SalinanMs="+ escape(winTitle)+"&cajPBI="+ cajPBI +"&cajPK="+ cajPK +"&cajKdrEkor"+ cajKdrEkor +"&cajKdrQty="+ cajKdrQty +"&cetak="+ strCetak+"&pname="+document.all.printer_name.value;

str ="eSKPI.aspx?barcode="+ document.all.Barcodes.value +"&invois_id="+document.all.Invois_Id.value+"&SalinanMs="+ escape(winTitle)+"&cajPBI="+ cajPBI +"&cajPK="+ cajPK +"&cajKdrEkor"+ cajKdrEkor +"&cajKdrQty="+ cajKdrQty +"&cetak="+ strCetak+"&pname="+document.all.printer_name.value;
...
function AddArray()
{
    ...
    //var dataItem1 = document.all.Importer;    
    //document.all.currentImporter.value=dataItem1.options.value;
    document.all.currentImporter.value=document.all.Importer.value;
    var dataItem2 = document.all.Bekalan;
    var dataItem3 = document.all.KompleksPPI;   
   // var dataItem4 = document.all.Exporter;
    var strTemp = document.all.Importer.value;
    ...
    //ate1temp.setDate(date1temp.getDate()+7);
    ...
    else
    {
        ...
        {alert("Lesen Pengimport Akan Tamat Tempoh Dalam Masa Sebulan.");}
        ...
        {    
            ...
            for(i=0;i<arrImporterInfoRow.length;i++)
            {
                ...
                if(arrImporterInfoCol[0] == document.all.Importer.value)
                {
                    stat="true";
                }        
            } 
        ...
        //shah
           ...
           // document.all.arrayVal.value = document.all.arrayVal.value + document.all.Importer.value + '`' +document.all.searchKodImporter.value + '`' + dataItem2.options.value +'`'+ dataItem3.options.value + '`' + document.all.Exporter.value + '`' +document.all.searchKodExporter.value +'~';
           document.all.arrayVal.value = document.all.Importer.value + '`' +document.all.searchKodImporter.value + '`' + dataItem2.options.value +'`'+ dataItem3.options.value + '`' + document.all.Exporter.value + '`' +document.all.searchKodExporter.value + '`' + document.all.PetiBiruKecil.value +  '`' + document.all.PetiBiruBesar.value +  '`' + document.all.NoKontena.value + '~' + document.all.arrayVal.value;  
                        
            var myString =document.all.Importer.value + '`' + document.all.searchKodImporter.value + '`' + dataItem2.options.value +'`'+ dataItem3.options.value + '`' + document.all.Exporter.value + '`' + document.all.searchKodExporter.value + '`' + document.all.PetiBiruKecil.value +  '`' + document.all.PetiBiruBesar.value +  '`' + document.all.NoKontena.value + '~';
            //shah
            
            //alert("shah" + document.all.arrayVal.value);
...
//            document.all.Importer.value="";
//            document.all.searchKodExporter.value="";
//            document.all.Exporter.value="";
            //end of reset
            
            document.all.searchKodImporter.value="";
            document.all.searchKodExporter.value="";   
            
            document.all.PetiBiruKecil.value="0";
            document.all.PetiBiruBesar.value ="0";
  ...
  {
    alert('Sila Masukkan Nama Pengimport & Pengeksport Untuk Meneruskan Operasi!!!');
  }     
}
    ...
    for (i=0;i<arrImporter.length-1; i++)
        {
            ...
            //alert(arrImporterInfoDetails[1]);
            //add a row to the rows collection and get a reference to the newly added row
	        ...
	        oCell = newRow.insertCell();
	        oCell.innerHTML = arrImporterInfoDetails[8];
	        //shah
           ...
           // alert("demo1="+ document.all.currentImporter.value);             
        
        }//end for
        //alert(document.all("tblGridImporter").rows.length);
}
...
//                kodIkan=KodIkan[i];
                //alert(document.all.currentImporter.value +","+ document.all.JenisUrusan.options.value + ","+ MKodKategoriIkan[i] + "," + KodIkan[i]);
                showFilteredCompanyIkanCaj(document.all.currentImporter.value,document.all.JenisUrusan.options.value,katIkan)
//                showFilteredCompanyIkanCaj(document.all.currentImporter.value,document.all.JenisUrusan.options.value,katIkan,kodIkan)
               
                if (chargeFound==0)
                {
                 
                 //alert(document.all.JenisUrusan.options.value + ","+ MKodKategoriIkan[i]);
          ...
          if (found==0)               
          {
             ...
             alert("Kod ikan Tidak Ditemui Sila Cari Secara Manual!!!");
...
<body >
  ...
  <table style="width: 100%">
    <tr> 
      <td colspan="4" style="height: 18px; background-color:#0000cc;"> <strong>&nbsp;<span style="color: #ffffff">PENGISYTIHARAN 
        <%=namaJenisUrusan.ToUpper() %></span></strong></td>
    </tr>
    <tr> 
      <td> </td>
      <td> </td>
    ...
    <tr> 
      <td > <strong>Agen Pengangkutan</strong></td>
      <td > <asp:TextBox ID="NamaAgen" runat="server" Width="260px" ReadOnly="True"></asp:TextBox></td>
      <td > <strong>#Barcode</strong></td>
      <td style="width: 125px" > <asp:TextBox ID="Barcodes" runat="server" Width="156px" ReadOnly="True"></asp:TextBox></td>
    </tr>
    <tr> 
      <td > <strong>Nama Pemandu</strong></td>
      <td > <asp:TextBox ID="NamaPemandu" runat="server" Width="259px"></asp:TextBox></td>
      <td > <strong>Jenis Urusan</strong></td>
      <td style="width: 125px" > <asp:DropDownList ID="JenisUrusan" runat="server" DataSourceID="Urusan" DataTextField="Nama_Urusan"
                        DataValueField="Kod_Urusan"> </asp:DropDownList> </td>
    </tr>
    <tr> 
      <td style="height: 23px" > <strong>No. /Nama Kapal/Penerbangan/Kenderaan</strong></td>
      <td style="height: 23px; font-weight: bold;" > <asp:TextBox ID="noKenderaan" runat="server" Width="256px" ReadOnly="True"></asp:TextBox></td>
      <td style="height: 23px; font-weight: bold;" > Cara Pengangkutan </td>
      <td style="height: 23px; font-weight: bold; width: 125px;" ><asp:DropDownList ID="cara_pengangkutan" runat="server" DataSourceID="JenisPengangkutan" DataTextField="Nama_Pengangkutan" DataValueField="Kod_Pengangkutan"> 
        </asp:DropDownList> </td>
    </tr>
    <tr> 
      <td colspan="4" style="height: 17px"> <hr /> </td>
    </tr>
  </table>
    ...
    <table style="width: 100%">
        ...
        <tr>
            ...
            <td style="height: 21px" >
                <asp:TextBox ID="searchKodImporter" runat="server" Width="266px"></asp:TextBox><br />
                <asp:HiddenField ID="Importer" runat="server" />
            </td>
            <td style="height: 21px" >
                <strong>Pengeksport</strong></td>
            <td style="height: 21px">
                <asp:TextBox ID="searchKodExporter" runat="server" Width="266px"></asp:TextBox><br />
                <asp:HiddenField ID="Exporter" runat="server" />
            </td>
        </tr>        
        <tr>
            <td colspan="4">
                <strong>Jumlah Peti Biru Kecil &nbsp;:</strong>
             <asp:TextBox ID="PetiBiruKecil" runat="server" Width="93px">0</asp:TextBox>
             &nbsp; &nbsp; &nbsp; <strong>Jumlah Peti Biru Besar &nbsp;:</strong>&nbsp;
             <asp:TextBox ID="PetiBiruBesar" runat="server" Width="93px">0</asp:TextBox>
                &nbsp; &nbsp;&nbsp; <strong>No. Kontena &nbsp;:</strong>&nbsp;
                <asp:TextBox ID="NoKontena" runat="server" Width="93px"></asp:TextBox><br /><br />
                <br />
         <input id="Button3" type="button" value="Tambah" style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1;" onclick="AddArray();refreshTableGridIkan();"  /><input id="Button4" type="button" value="Batal" style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1; width: 61px;" onclick="RemoveArray()" />&nbsp;</td>
        </tr>
    </table>
         ...
         <table id="tblGridImporter" border="0" width="100%">
             <thead>
             <tr>
                 <th style="background-color:#f1f1f1; width:4%">
                     No.</th>
                 <th style="background-color:#f1f1f1; width:20%; height:22px">
                     Pengimport</th>
                 <th style="background-color:#f1f1f1; width:16%; height:22px">
                     No. Lesen</th>
                 <th style="background-color:#f1f1f1; width:12%; height:22px">
                     Tarikh Luput</th>
                 <th style="background-color:#f1f1f1; width:17%; height:22px">
                     Pengeksport</th>
                 <th style="background-color:#f1f1f1; width:12%; height:22px">
                     Bil. Peti Biru Kecil</th>
                 <th style="background-color:#f1f1f1; width:13%; height:22px">
                     Bil. Peti Biru Besar</th>
                 <th style="background-color:#f1f1f1; width:22%; height:22px">
                     No. Kontena</th>
                 <th style="background-color:#f1f1f1; width:15%; height:22px">
                     Kod Pengimport</th>               
             </tr>
             </thead>
             <tbody>                          
           ...
           <table id="Table1" border="0" style="width: 98.7%;">
              <tr>
                  <td style="background-color:#f1f1f1; width:7%; color: #f1f1f1; height: 18px;">
                      No.</td>
                  <td style="background-color:#f1f1f1; width:22%; height:18px; color: #f1f1f1;">
                      Pengimport</td>
                  <td style="background-color:#f1f1f1; width:16%; height:18px; color: #f1f1f1;">
                      No. Lesen</td>
                  <td style="background-color:#f1f1f1; width:15%; height:18px; color: #f1f1f1;">
                      Tarikh Luput</td>
                  <td style="background-color:#f1f1f1; width:22%; height:18px; color: #f1f1f1;">
                      Pengeksport</td>
                  <td style="background-color:#f1f1f1; width:15%; height:18px; color: #f1f1f1;">
                      Bil. Peti Biru Kecil</td>
                  <td style="background-color:#f1f1f1; width:22%; height:18px; color: #f1f1f1;">
                      Bil. Peti Biru Besar</td>
                  <td style="background-color:#f1f1f1; width:22%; height:18px; color: #f1f1f1;">
                      No. Kontena</td>
                  <td style="background-color:#f1f1f1; width:15%; height:18px; color: #f1f1f1;">
                      Kod Pengimport</td>
        ...
        <table style="width: 100%; border-top-width: thin; border-left-width: thin; border-bottom-width: thin; border-right-width: thin;FONT-SIZE: 8pt; FONT-FAMILY: Arial,Verdana, Tahoma;" border="0">
            <thead >
            <tr>
                <th style="width: 55px">
  ...
  <Input style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1" id="Button2" onclick="AddFishArray();" type="button" value="Tambah" />
     ...
     <div class="scrollingdatagrid" style="width:100%;height:110px;">
        ...
        <table id="Table3" border="0" style="width: 100%;FONT-SIZE: 8pt;FONT-FAMILY: Arial,Verdana, Tahoma;">
            <thead>
                <tr>
                    <th style="height: 19px; background-color: #ffffcc">
                    </th>
                    <th style="width: 20%; height: 19px; background-color: #ffffcc">
                    </th>
                    <th style="height: 19px; background-color: #ffffcc">
                    </th>
                    <th style="width: 15%; height: 19px; background-color: #ffffcc">
                    </th>
                    <th style="border-top-style: solid; border-top-color: teal; border-bottom: teal thin solid;
                        height: 19px; background-color: #ffffcc; text-align: left">
            ...
            <tr>
                <th style="background-color:#f1f1f1; color: #f1f1f1; height: 5px;">
                    Kod BKH</th>
                <th  style="background-color:#f1f1f1;width: 20%; color: #f1f1f1; height: 5px;">
                    Nama</th>
                <th style=" background-color:#f1f1f1; height: 5px;">
                    <div style="text-align:center; color: #f1f1f1;">
                        Kod 8 Digit</div>
                </th>
                <th style="background-color:#f1f1f1;width: 15%; height: 5px;">
                    <div style="text-align:center">
                        <span style="color: #f1f1f1">Destinasi</span></div>
                </th>
                <th style="background-color:#f1f1f1; height: 5px;">
                  <span style="color: black"><strong style="color: #f1f1f1">Peti Kecil</strong></span></th>
              <th style="background-color:#f1f1f1; height: 5px;">
                  <strong style="color: #f1f1f1">Kuantiti Kecil (kg)</strong></th>
              <th style="background-color:#f1f1f1; height: 5px;">
                  <strong style="color: #f1f1f1">Peti Besar</strong></th>
              <th style="background-color:#f1f1f1; height: 5px;" >
                  <strong style="color: #f1f1f1">Kuantiti Besar(kg)</strong></th>
                <th style="background-color:#f1f1f1; height: 5px;">
                    <div style=" text-align:center; color: #f1f1f1">
                        Pek</div>
                </th>
                ...
                <th style="background-color:#f1f1f1;text-align: center; color: #f1f1f1; height: 5px;">
                    Nilai (RM)</th>
            </tr>            
            </thead>
            <tbody>
        ...
        <asp:Label ID="Label8" runat="server" Font-Bold="True" Text="0" Width="82px"></asp:Label>
         &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;<br />
        &nbsp;
        <hr /><input id="Button6" type="button" value="BARU" style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1;" onclick="newForm();"  />
        <asp:Button ID="Button8" runat="server" Text="PAPAR MASTERSHEET" style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1;" UseSubmitBehavior="False" OnClientClick="openMasterSheet();" CausesValidation="False" Enabled="False"/>
        <asp:Button ID="Button5" runat="server" Text="SIMPAN" style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1;" OnClientClick="return pastiKanData();" /><input
             id="Button10" onclick="printReport('1');" runat="server" style="border-right: #333333 1px ridge;
             ...
             type="button" value="CETAK SKPI" disabled="disabled" /><input
             id="Button9" onclick="printReport('0');" runat="server" style="border-right: #333333 1px ridge;
             padding-right: 1px; border-top: #ffffff 1px ridge; padding-left: 1px; font-size: 10px;
             padding-bottom: 1px; border-left: #ffffff 1px ridge; color: #000000; padding-top: 1px;
             border-bottom: #000000 1px ridge; font-family: MS Shell Dlg,verdana,??; background-color: #f1f1f1"
             type="button" value="PAPAR CETAKKAN" disabled="disabled" /><input
             id="Button1" onclick="showSenaraiprinter();" runat="server" style="border-right: #333333 1px ridge;
             padding-right: 1px; border-top: #ffffff 1px ridge; padding-left: 1px; font-size: 10px;
             padding-bottom: 1px; border-left: #ffffff 1px ridge; color: #000000; padding-top: 1px;
             border-bottom: #000000 1px ridge; font-family: MS Shell Dlg,verdana,??; background-color: #f1f1f1"
             type="button" value="PILIH PRINTER" disabled="disabled" />
             <asp:Button ID="Button7" runat="server" Text="ISYTIHAR KOTAK INSULASI" style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1;" Enabled="False" Visible="False"/>
        ...
        <asp:SqlDataSource ID="JenisPengangkutan" runat="server" ConnectionString="<%$ ConnectionStrings:W-ICCS_Conn %>"
            SelectCommand="SELECT RTRIM(Kod_Cara_Pengangkutan) AS Kod_Pengangkutan, Nama_Cara_Pengangkutan AS Nama_Pengangkutan FROM CARA_PENGANGKUTAN ORDER BY Nama_Cara_Pengangkutan">
        </asp:SqlDataSource>
        ...
        <asp:SqlDataSource ID="Destinasi" runat="server" ConnectionString="<%$ ConnectionStrings:W-ICCS_Conn %>"
         ...
         <asp:HiddenField ID="printerNameSetting" runat="server" />
        <asp:SqlDataSource ID="Urusan" runat="server" ConnectionString="<%$ ConnectionStrings:W-ICCS_Conn %>"
            SelectCommand="SELECT [Kod_Urusan], [Nama_Urusan] FROM [JENIS_URUSAN] WHERE [Kod_Urusan] Not In('003','017','018','019','008','020','009') order by [Nama_Urusan] asc "></asp:SqlDataSource>
...
<%
    'Dim j As Integer
    ' For j = 0 To cara_pengangkutan.Items.Count - 1
    ' If Trim(cara_pengangkutan.Items(5).Value) = "T06" Then
    ' cara_pengangkutan.SelectedValue = "T06"
    'cara_pengangkutan.Items(5).Selected = True
    'Response.Write("test")
    'End If
    'Next
%>