...
Partial Class _Default
    ...
    Private Sub ConfigureCrystalReports()
        ...
        Dim reportPath As String = Server.MapPath("rpt/crMasterSheetImport_Top.rpt")
        ...
        Dim selectFormula As String = "{PENGISYTIHARAN_I.No_Barcode} = '" & Request("barcode") & "' AND {PENGISYTIHARAN_I.Status} = 'A' and {PENGISYTIHARAN_I.No_SKPI} = '" & request("skpi") & "'"
        ...
        'crMasterSheetImport.DataDefinition.FormulaFields("SenaraiCajPetiBesar").Text = "'" & Request("cajPBI") & "'"
        'crMasterSheetImport.DataDefinition.FormulaFields("SenaraiCajPetiKecil").Text = "'" & Request("cajPK") & "'"
        'crMasterSheetImport.DataDefinition.FormulaFields("SenaraiCajKuantiti").Text = "'" & Request("cajKdrQty") & "'"
        'crMasterSheetImport.DataDefinition.FormulaFields("SenaraiCajEkor").Text = "'" & Request("cajKdrEkor") & "'"
        ...
        'crMasterSheetImport.PrintOptions.PrinterName = "\\Pc-printer\InkJet1000"
        'crMasterSheetImport.PrintOptions.PrinterName = "KONICA MINOLTA 7145/IP-432"
