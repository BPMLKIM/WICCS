        ...
        If Simpan.Page.IsPostBack Then
            If NamaPemandu.Text <> "" And arrayVal.Value <> "" And arrayFishVal.Value <> "" Then
                ...
                Else
                    ...
                    'opClass.Generate_eSKPI(arrayVal.Value, Barcodes.Text, KompleksPPI.SelectedItem.Value)
                    ...
                    If (opClass.ErrorSignal = False) Then
                        ...
                        Dim sqlText = "UPDATE SISTEM_Q Set status='Isytihar',Bil_SKPI='" & opClass.eSKPIArray.Count() & "',pegawai='" & Session("namaPegawai") & "' WHERE No_Barcode = '" & Trim(Barcodes.Text) & "'"
