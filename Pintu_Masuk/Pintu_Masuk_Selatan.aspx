<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Pintu_Masuk_Selatan.aspx.vb" Inherits="Pintu_Masuk_Pintu_Masuk_Selatan" %>
...
var str ="http://report.lkim.gov.my/pintu_masuk/slip_selatan.aspx?barcode="+ document.all.barcoded.value +"&cetak="+ strCetak+"&pname="+document.all.printer_name.value;

str ="slip_selatan.aspx?barcode="+ document.all.barcoded.value +"&cetak="+ strCetak+"&pname="+document.all.printer_name.value;
...
<body>
  ...
  <table border="0" cellpadding="0" cellspacing="0" width="938">
    <tr> 
      <td width="30%" style="height: 13px">MODUL&nbsp;MAKLUMAT PENDAFTARAN MASUK EKSPORT</td>
  ...
  <asp:Panel ID="Panel1" runat="server" Height="50px" Width="100%">
      ...
      <tr> 
        <td  colspan="2"  > 
          ...
          MASUK EKSPORT</font></span></strong></td>
            </tr>
                     <tr>
        ...
        <td  colspan="2" > 
          ...
          PENDAFTARAN MASUK
              EKSPORT BERIKUT TELAH SELAMAT DISIMPAN</font></span></strong></td>
                       </tr>
                       <tr>
            ...
            <tr>
                ...
                <td >
                    :&nbsp;<asp:Label ID="Label3" runat="server" Text="Eksport" Width="55px"></asp:Label></td>
            </tr>
                       <tr>
                           <td width="30%">
                               &nbsp;No./Nama Kapal/Penerbangan/Kenderaan</td>
                           <td>
                               :&nbsp;<asp:Label ID="Label5" runat="server" Text="Label" Width="176px"></asp:Label></td>
                       </tr>
                       <tr>
                           <td width="30%">
                               <strong>&nbsp;</strong>Jenis Kapal/Kapal Terbang/Kenderaan</td>
                           <td >
            ...
            <tr>
                <td style="height: 15px" colspan="2"><input style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; WIDTH: 72px; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1" id="Button10" type="button" value="Baru" onclick="self.location.href='pintu_masuk_utara.aspx';" /><input
