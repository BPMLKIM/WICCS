<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Pintu_Masuk_Utara.aspx.vb" Inherits="Pintu_Masuk_Pintu_Masuk_Utara" %>
...
var str ="http://report.lkim.gov.my/pintu_masuk/slip.aspx?barcode="+ document.all.barcoded.value +"&cetak="+ strCetak+"&pname="+document.all.printer_name.value;

str ="slip.aspx?barcode="+ document.all.barcoded.value +"&cetak="+ strCetak+"&pname="+document.all.printer_name.value;
...
<body>
  ...
  <table border="0" cellpadding="0" cellspacing="0" width="938">
    <tr> 
      <td width="30%" style="height: 13px">MODUL&nbsp;MAKLUMAT PENDAFTARAN MASUK IMPORT</td>
  ...
  <asp:Panel ID="Panel1" runat="server" Height="50px" Width="100%">
      ...
      <tr> 
        <td  colspan="2"  > 
          <strong><span style="color: white"><font color="#333333">MAKLUMAT PENDAFTARAN 
          MASUK IMPORT</font></span></strong></td>
            </tr>
                     <tr>
                         <td style="width: 169px">
                             <strong>&nbsp;No. Rujukan </strong>(<em>Jika ada</em>)</td>
                         <td style="width: 379px">
                             :<asp:TextBox ID="NoRujukan" runat="server"></asp:TextBox>
                           ...
                           Width="80px" CausesValidation="False" OnClick="PeriksaRujukan_Click"/></td>
                     </tr>
                     <tr>
                <td style="width: 169px" >
            ...
            <tr>
                ...
                <td style="width: 379px" >
                    :<asp:TextBox ID="noKenderaan" runat="server" MaxLength="100" Width="216px"></asp:TextBox></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="width: 379px" >
                    :<asp:DropDownList ID="JenisUrusan" runat="server" DataSourceID="Urusan" DataTextField="Nama_Urusan" DataValueField="Kod_Urusan">
                     ...
                     <tr>
                         <td style="width: 169px">
                             <strong>&nbsp;Caj Pintu Masuk </strong>
                         </td>
                         <td style="width: 379px; text-align: left">
                             :<strong>RM&nbsp; </strong><asp:TextBox ID="cajKenderaan" runat="server" Width="58px"></asp:TextBox></td>
                     </tr>
                     <tr>
                         <td colspan="2"><hr /></td>
                     </tr>
        ...
        <td  colspan="2" > 
          <strong><span style="color: #ffffff"><font color="#333333">MAKLUMAT 
          PENDAFTARAN MASUK
                ...
                <td >
                    :&nbsp;<asp:Label ID="Label3" runat="server" Text="Import" Width="55px"></asp:Label></td>
                       ...
                       <tr>
                           ...
                           <td>
                               :&nbsp;<asp:Label ID="Label5" runat="server" Text="Label" Width="232px"></asp:Label></td>
                       </tr>
                       <tr>
                           <td width="30%">
            ...
            <tr>
                ...
                <td >
                    :&nbsp;<asp:Label ID="Label4" runat="server" Text="Label" Width="100%"></asp:Label></td>
                       ...
                       <tr>
                           <td style="height: 15px" width="30%">
                               <strong>&nbsp;</strong>Caj Pintu Masuk</td>
                           <td style="height: 15px">
                               :
                               <asp:Label ID="Label6" runat="server" Text="Label" Width="57px"></asp:Label></td>
                       </tr>
                       <tr>
                           <td colspan="2" style="height: 15px">
                               </td>
            ...
            <tr>
                <td style="height: 15px" colspan="2"><input style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; WIDTH: 72px; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1" id="Button10" type="button" value="Baru" onclick="self.location.href='pintu_masuk_utara.aspx';" />
                    <input id="Button5" runat="server"  onclick="printReport('1');"
                        ...
                        background-color: #f1f1f1" type="button" value="Cetak Slip" />
                   <input
             id="Button4" onclick="showSenaraiprinter();" runat="server" style="border-right: #333333 1px ridge;
             ...
             type="button" value="Pilih Printer"  />&nbsp;
                           <asp:Button ID="Button9" runat="server" Style="border-right: #333333 1px ridge; padding-right: 1px;
                           border-top: #ffffff 1px ridge; padding-left: 1px; font-size: 10px; padding-bottom: 1px;
                           border-left: #ffffff 1px ridge; color: #000000; padding-top: 1px; border-bottom: #000000 1px ridge;
                           font-family: MS Shell Dlg,verdana,??; background-color: #f1f1f1" Text="Keluar"
