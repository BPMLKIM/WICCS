<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Pra_Pintu_Masuk_Selatan.aspx.vb" Inherits="Pra_Pintu_Masuk_Pintu_Masuk_Selatan" %>
...
var str ="http://report.lkim.gov.my/pintu_masuk/slip_pra_selatan.aspx?barcode="+ document.all.barcoded.value +"&cetak="+ strCetak+"&pname="+document.all.printer_name.value;

str ="slip_pra_selatan.aspx?barcode="+ document.all.barcoded.value +"&cetak="+ strCetak+"&pname="+document.all.printer_name.value;
                ...
                <td >
                    :&nbsp;<asp:Label ID="Label3" runat="server" Text="Eksport" Width="55px"></asp:Label></td>
                       ...
                       <tr>
                           ...
                           <td>
                               :&nbsp;<asp:Label ID="Label5" runat="server" Text="Label" Width="184px"></asp:Label></td>
                       </tr>
                       <tr>
                           <td width="30%">
            ...
            <tr>
                ...
                <td >
                    :&nbsp;<asp:Label ID="Label4" runat="server" Text="Label" Width="100%"></asp:Label></td>
                       ...
                       <tr>
                           <td style="height: 15px" width="30%">
                               <strong>&nbsp;<asp:Label ID="TextBox1" runat="server" MaxLength="10" Visible="False"></asp:Label></strong></td>
                           <td style="height: 15px">
            ...
            <tr>
                <td style="height: 15px" colspan="2"><input style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; BORDER-LEFT: #ffffff 1px ridge; WIDTH: 72px; COLOR: #000000; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1" id="Button10" type="button" value="Baru" onclick="self.location.href='pra_pintu_masuk_utara.aspx';" /><input
                        ...
                        type="button" value="Cetak Slip" /><input id="Button4" runat="server" onclick="showSenaraiprinter();"
                           ...
                           border-left: #ffffff 1px ridge; color: #000000; padding-top: 1px; border-bottom: #000000 1px ridge;
                           font-family: MS Shell Dlg,verdana,??; background-color: #f1f1f1" Text="Keluar"
                           Width="88px" OnClientClick="location.href='verifikasi_PintuMasuk.aspx';" UseSubmitBehavior="False" CausesValidation="False" />
                    </td>
            </tr>
            </table>
