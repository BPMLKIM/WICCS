...
#End Region
    ...
    Private Sub ConfigureCrystalReports()
        ...
        'Else
        ' selectFormula = "{no_siri_resit_lkim.bil_siri_resit} = '" & Trim(serial_no) & "' AND {ITEM_CAJ_KIBFG.Dicaj_Oleh} = 'LKIM' AND {ITEM_CAJ_KIBFG.Kod_Service_Caj} = 'Caj Perkhidmatan Ikan(Kotak Insulasi)'"
        selectFormula = "{no_siri_resit_lkim.bil_siri_resit} = '" & Trim(serial_no) & "' AND {ITEM_CAJ_KIBFG.Dicaj_Oleh} = 'LKIM' AND {ITEM_CAJ_KIBFG.Kod_Service_Caj}='Caj Perkhidmatan Ikan(Kotak Insulasi)' AND {ITEM_CAJ.Dicaj_Oleh} = 'LKIM' AND {ITEM_CAJ.Kod_Service_Caj}='Caj Perkhidmatan Ikan'"
        ' End If
