<%@ Page Language="VB" AutoEventWireup="false" CodeFile="salinanborang.aspx.vb" Inherits="salinanborang" %>
...
{
if (document.all.Urusan.value == 'I')
{ 
var str ="cetakResit1B.aspx?printer_name=" + document.all.printer_name.value + "&print_status=Y&Urusan=" + document.all.Urusan.value + "&barcode="+ document.all.txtRujukan.value;
//var str ="http://quest2003/reportw-iccs/pembayaran/cetakResit1B.aspx?printer_name=" + document.all.printer_name.value + "&print_status=Y&Urusan=" + document.all.Urusan.value + "&barcode="+ document.all.txtRujukan.value;
}
else
{ var str ="cetakResit1E1.aspx?printer_name=" + document.all.printer_name.value + "&print_status=Y&Urusan=" + document.all.Urusan.value + "&barcode="+ document.all.txtRujukan.value;}
...
<body style="color: #000000">
        ...
        <table style="width: 90%">
            <tr>
                ...
                <td colspan="2" style="text-align: center; width: 682px;" bgcolor="#996666"> 
                    <strong><span style="color: #ffffff">SALINAN CAJ SKPI UNTUK BAYARAN INDIVIDU</span></strong></td>
            </tr>
        </table>
        <br />
            ...
            <tr>
                ...
                <td style="width: 481px; height: 15px">
                    ...
                    <input id="Button3" runat="server" onclick="showSenaraiprinter();" style="border-right: #333333 1px ridge;
                            ...
                            padding-bottom: 1px; border-left: #ffffff 1px ridge; color: #000000; padding-top: 1px;
                            border-bottom: #000000 1px ridge; font-family: MS Shell Dlg,verdana,??; background-color: #f1f1f1"
                            type="button" value="PILIH PRINTER" /></td>
            </tr>
        </table>
        &nbsp;&nbsp;
  ...
  <table style="width: 90%">
            <tr>
                ...
                <td colspan="2" style="text-align: center; width: 682px; height: 16px;" bgcolor="#996666"> 
