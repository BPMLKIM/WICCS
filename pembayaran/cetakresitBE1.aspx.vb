...
#End Region
    ...
    Private Sub ConfigureCrystalReports()
        ...
        '    Dim sqlnew As String = "select bil_siri_resit from no_siri_resit_nekad_eksport where no_barcode='" & Trim(arrBayarCol1(0)) & "' and kod_agen = '" & Trim(Request("kod_agen")) & "'"
        ...
        Dim sqlserialno As String = "select bil_siri_resit from no_siri_resit_nekad_eksport where kod_agen = '" & Trim(Request("kod_agen")) & "' and day(edate)=day(getdate()) and month(edate)=month(getdate()) and year(edate)=year(getdate()) and siri_module='agent_receipt' and print_status='0'"
        ...
        For i = 0 To arrloop
            ...
            Dim sql10 As String = "select no_invois from no_invois_eksport where no_barcode='" & Trim(arrBayarCol(0)) & "'"
            ...
            Dim sql11 As String = "select bil_siri_resit from no_siri_resit_nekad_eksport where no_barcode='" & Trim(arrBayarCol(0)) & "' and no_invois='" & Trim(intInvois) & "'"
            ...
            If Not SQLReader.HasRows Then
                ...
                Dim gconSQL As String = "insert into no_siri_resit_nekad_eksport(no_barcode,no_invois,bil_siri_resit,siri_module,kod_agen,print_status,site_code) " _
        ...
        If Request("print_status") = "Y" Then
            ...
            For i = 0 To arrloop
                ...
                Dim gconSQL As String = "update pembayaran_caj_skpe set print_status='1' where no_barcode='" & Trim(arrBayarCol(0)) & "'"
                opClass1.InsertData(gconSQL)

                Dim gconSQL1 As String = "update no_siri_resit_nekad_eksport set print_status='1' where no_barcode='" & Trim(arrBayarCol(0)) & "'"
