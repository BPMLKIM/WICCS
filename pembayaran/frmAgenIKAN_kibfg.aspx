<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmAgenIKAN_kibfg.aspx.vb" Inherits="pembayaran_frmAgenIKAN_kibfg" %>
...
var str ="cetakResitA_kibfg.aspx?print_status=" + document.all.print_status.value + "&kod_agen=" + document.all.kod_agen.value + "&arrayValT=" + document.all.listbarcode.value + "&SalinanMs="+ escape(winTitle);
...
{
var str ="cetakResitA_kibfg.aspx?printer_name=" + document.all.printer_name.value + "&print_status=Y&kod_agen=" + document.all.kod_agen.value + "&arrayValT=" + document.all.listbarcode.value;
window.open(str,'LKIM','');
}
     ...
     for (i=0;i<document.form1.checkbox.length;i++)
	     {
	       if(document.form1.checkbox(i).checked)
	           { 
                  ...
                  { 
                  if (j>1) 
                  {alert('Cara untuk pembayaran secara CEK dan TUNAI hanya sah untuk satu barcode sahaja.');return false;}
...
if (document.form1.checkbox.length==undefined)
    {
		   ...
		   var strIkan = document.all.arrayValT.value;
           var strIkan1 = strIkan.split("~");                 
		   ...
		   var strIkanDetail  = strIkan1[i].split("`");
	        ...
	        var strSKPI = strIkan1[i].split("`")
	        //	var strTmpStr = strSKPI[4] + '`' + strSKPI[5] + '`' + strSKPI[6];
	   	    var strTmpStr = strSKPI[4] + '`' + strSKPI[5] + '`' + strSKPI[6] + '`' + strSKPI[7] + '`' + strSKPI[8] + '`' + strSKPI[9];
    ...
    //add a row to the rows collection and get a reference to the newly added row    
        ...
        for (i=0;i<strIkan1.length-1; i++)
        {
	       ...
	       var myString = strIkan1[i]+ "~";
	        ...
	        oCell = newRow.insertCell();
	        oCell.innerHTML = centPlace(strIkanDetail[3]);
	          oCell = newRow.insertCell();
	        oCell.innerHTML = centPlace(strIkanDetail[4]);
	          oCell = newRow.insertCell();
	        oCell.innerHTML = centPlace(strIkanDetail[5]);
        ...
        <table  style="width: 90%">
            <tr>
                <td colspan="2" style="height: 18px; background-color: #6600ff">
                    &nbsp;&nbsp;&nbsp;<asp:Label ID="Label1" runat="server" Text="Pembayaran CAJ Perkhidmatan Ikan Melalui Agen(Dengan Rebat)" Width="432px" Font-Bold="True" ForeColor="White"></asp:Label></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="width: 612px">
                    <asp:TextBox ID="kod_agen" runat="server"></asp:TextBox><asp:Button ID="Button1" runat="server" Style="border-right: #333333 1px ridge; padding-right: 1px;
                        ...
                        font-family: MS Shell Dlg,verdana,??; background-color: #f1f1f1" Text="Open" />
                </td>
            </tr>
...
<asp:HiddenField ID="arrayVal" runat="server" />
   ...
   <table id="Table1" style="width: 90% ;">
    <tr style="width: 100% ; background-color:#6600ff;">
        <td style="width: 220px; height: 12px">
            <input id="Checkbox" onclick="checkAll(document.form1.checkbox,this)" type="checkbox" /></td>
        <td style="width: 2991px; height: 12px;">
            <span style="color: #ffffff"><b>No Barcode</b></span></td>
        <td style="width: 2445px; height: 12px;">
            <span style="color: #ffffff"><strong>No Invois</strong></span></td>
        <td style="width: 1533px; height: 12px">
            <strong><span style="color: #ffffff">Caj Kotak Asal (RM)</span></strong></td>
        <td style="width: 1533px; height: 12px">
            <strong><span style="color: #ffffff">Caj Kotak Insulasi (RM)</span></strong></td>
        <td style="width: 1533px; height: 12px">
            <strong><span style="color: #ffffff">Rebat Caj Kotak (RM)</span></strong></td>
        <td style="width: 1533px; height: 12px">
            <strong><span style="color: #ffffff">Caj Sebenar (RM)</span></strong></td>
    </tr>
</table>
       <table style="width: 90%">
            <tr>
        ...
        <asp:HiddenField ID="arrayValT" runat="server" /><asp:HiddenField ID="bayar_semasa" runat="server" /><asp:HiddenField ID="depositid" runat="server" />
        <br />
        <table id="Table2" style="width: 90% ;">
            <tr style="width: 100% ; background-color:#6600ff;">
                <td style="width: 220px; height: 18px">
                </td>
                <td style="width: 4104px; height: 18px">
                    <strong><span style="color: #ffffff">No Barcode</span></strong></td>
                <td style="width: 4371px; height: 18px;">
                    <span style="color: #ffffff"><b>No Invois</b></span></td>
                <td style="width: 5513px; height: 18px;">
                    <span style="color: #ffffff"><strong>Caj Tunai (RM)</strong></span></td>
                <td style="width: 5147px; height: 18px;">
                    <span style="color: #ffffff"><strong>Nilai Cek (RM)</strong></span></td>
                <td style="width: 4356px; height: 18px;">
...
<asp:Button ID="cmdBayar" runat="server" Text="BAYAR" style="BORDER-RIGHT: #333333 1px ridge; PADDING-RIGHT: 1px; BORDER-TOP: #ffffff 1px ridge; PADDING-LEFT: 1px; FONT-SIZE: 10px; PADDING-BOTTOM: 1px; 
            ...
            value="TOLAK" runat="server" /><input id="cmdResit" runat="server" onclick="printReport();"
                ...
                background-color: #f1f1f1" type="button" value="PAPAR RESIT" /><input id="Button7"
                    ...
                    padding-bottom: 1px; border-left: #ffffff 1px ridge; color: #000000; padding-top: 1px;
                    border-bottom: #000000 1px ridge; font-family: MS Shell Dlg,verdana,??; background-color: #f1f1f1"
                    type="button" value="CETAK RESIT" /><input
                        id="Button3" runat="server" onclick="showSenaraiprinter();" style="border-right: #333333 1px ridge;
                        padding-right: 1px; border-top: #ffffff 1px ridge; padding-left: 1px; font-size: 10px;
                        padding-bottom: 1px; border-left: #ffffff 1px ridge; color: #000000; padding-top: 1px;
                        border-bottom: #000000 1px ridge; font-family: MS Shell Dlg,verdana,??; background-color: #f1f1f1"
                        type="button" value="PILIH PRINTER" /><input id="Button2" runat="server" onclick="self.location.href='frmAgenIkan_kibfg.aspx?type=ikan';"
            style="border-right: #333333 1px ridge; padding-right: 1px; border-top: #ffffff 1px ridge;
            padding-left: 1px; font-size: 10px; padding-bottom: 1px; border-left: #ffffff 1px ridge;
            color: #000000; padding-top: 1px; border-bottom: #000000 1px ridge; font-family: MS Shell Dlg,verdana,??;
            background-color: #f1f1f1" type="button" value="BARU" /><br />
        <br />
        <br />
