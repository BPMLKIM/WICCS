<%@ Page Language="VB" AutoEventWireup="false" CodeFile="pembayaranNewI_kibfg.aspx.vb" Inherits="pembayaran_pembayaranNewI_kibfg" %>
...
{
//var str ="http://quest2003/reportw-iccs/pembayaran/cetakResit_kibfg.aspx?printer_name=" + document.all.printer_name.value + "&print_status=Y&Urusan=" + document.all.Urusan.value + "&barcode="+ document.all.txtRujukan.value;
...
function refreshIkan1()
{
    ...
    for(i=1;i<totalRows;i++)
    {
        document.all("Table2").deleteRow(1);
          ...
          var strIkan = document.all.arrayVal1.value;    
          var strIkan1 = strIkan.split("~");
          //alert(strIkan);
    ...
    <div>
        ...
        <table id="Table1" style="width: 90% ;">
            <tr style="width: 100% ; background-color:#6600ff;">
                <td style="width: 1632px; height: 15px">
                    <strong><span style="color: #ffffff">Item</span></strong></td>
                <td style="width: 806px; height: 15px">
        ...
        <asp:HiddenField
            ID="arrayVal1" runat="server" />
        <asp:HiddenField ID="totalikan1" runat="server" />
        <table id="Table2" style="width: 90% ;">
            <tr style="width: 100% ; background-color:#6600ff;">
                <td style="width: 1632px; height: 15px">
                    <strong><span style="color: #ffffff">Item</span></strong></td>
                <td style="width: 806px; height: 15px">
                    <span style="color: #ffffff"><strong>Caj Kotak Insulasi(RM)</strong></span></td>
                <td style="width: 605px; height: 15px">
                    <span style="color: #ffffff"><strong>Rebat Caj Kotak(RM)</strong></span></td>
                <td style="width: 605px; height: 15px">
                    <span style="color: #ffffff"><strong>Caj Sebenar(RM)</strong></span></td>
                <td style="width: 595px; height: 15px">
                    <span style="color: #ffffff"><strong>DiCaj Oleh</strong></span></td>
                <td style="width: 595px; height: 15px">
                    <span style="color: #ffffff"><strong>Tempat Isytihar</strong></span></td>
