...
#End Region
    ...
    Private Sub ConfigureCrystalReports()
        ...
        Dim strSQL As String = "select h.company_name,h.company_add1,h.company_add2,h.company_add3,h.company_add4,h.gst_no " _
        ...
        'selectFormula = "{ITEM_CAJ.Kod_Service_Caj}= 'Caj Pengisytiharan (Borang SKPI) - LKIM' AND {ITEM_CAJ.Dicaj_Oleh} = 'LKIM' and {no_siri_resit_nekad.bil_siri_resit} = '" & serial_no & "'"
        ...
        iResitG2b1.DataDefinition.FormulaFields("gst_no").Text = "'" & gstno & "'"
