...
Partial Class pembayaran_frmAgenIKAN_kibfg
...
#Region "Variables Declaration"
    ...
    Dim baki_semasa_rebat As Decimal
    ...
    Public Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Page.IsPostBack Then
            ...
            If TextBox2.Text = "" Or kod_agen.Text = "" Then
                ...
                Response.Write("<script languange=javascript>alert('Sila masukkan tarikh dan kod agen');self.location.href='frmAgenIKAN_kibfg.aspx';</script>")
                Response.End()
            ...
            Dim strSQL As String = "select no_barcode,no_invois,sum(cajikansebenar) as cajikansebenar,sum(cajikan) as cajikan ,sum(totalkurangcajikan) as totalkurangcajikan " _
            ...
            If SQLReader.HasRows Then
                ...
                While SQLReader.Read()
                    ...
                    Dim jumlahcajikansebenar As Decimal

                    jumlahcajikansebenar = CDec(SQLReader("cajikansebenar")) - CDec(SQLReader("TotalKurangCajIkan"))
                    ...
                    cajIkan = cajIkan & SQLReader("no_barcode") & "`" & SQLReader("no_invois") & "`" & SQLReader("cajikansebenar") & "`" & SQLReader("cajikan") & "`" & SQLReader("totalkurangcajikan") & "`" & (jumlahcajikansebenar) & "~"
            ...
            If arrayValT.Value <> "" Then
                ...
                If cara_bayar = True Then
                    ...
                    If (CDec(txtKredit.Text) > CDec(depositid.Value)) Then
                        ...
                        Response.Write("<script languange=javascript>alert( '" & stmt & "');self.location.href='frmAgenIKAN_kibfg.aspx';</script>")
                        Response.End()
                ...
                For i = 0 To arrloop
                    ...
                    '-------------------tambahan_kibfg----------------------
                    'Dim sqlbil1 As String = "Select bil_item from item_caj_kibfg where No_Barcode= '" & Trim(arrBayarCol(4)) & "' order by bil_item desc"
                    'SQLReader = opClass.DataReader(sqlbil1)
                    ...
                    If arrBayarCol(0) = "CEK / TUNAI" Then
                        ...
                        Dim sqlTextkibfg1 As String = "INSERT INTO [W-ICCS].[dbo].[ITEM_CAJ_KIBFG]" _
                                                  ...
                                                  & " VALUES('" & Trim(arrBayarCol(4)) & "','" & bil_item & "','Caj Perkhidmatan Ikan(Kotak Insulasi)','" & CDec(arrBayarCol(7)) & "','" & Trim(cara_pembayaran.SelectedValue) & "','" & Trim(arrBayarCol(1)) & "','LKIM','PENGISYTIHARAN','" & Session("namaPegawai") & "','" & Session("id_pegawai") & "','" & Right(Trim(arrBayarCol(4)), 3) & "','CEK/TUNAI','" & CDec(arrBayarCol(8)) & "','" & arrBayarCol(9) & "')"
                    ...
                    Else
                        ...
                        Dim sqlTextkibfg1 As String = "INSERT INTO [W-ICCS].[dbo].[ITEM_CAJ_KIBFG]" _
                           & " ([No_Barcode], [Bil_Item], [Kod_Service_Caj], [Nilai_Caj],[Cara_Pembayaran],[No_Cek],[Dicaj_Oleh],[Tempat_Isytihar],[Nama_Pegawai],[No_Pegawai],site_code,cara_bayar,nilai_caj_kurang,nilai_caj_sebenar)" _
                           & " VALUES('" & Trim(arrBayarCol(4)) & "','" & bil_item & "','Caj Perkhidmatan Ikan(Kotak Insulasi)','" & CDec(arrBayarCol(7)) & "','" & Trim(cara_pembayaran.SelectedValue) & "','" & no_cek & "','LKIM','PENGISYTIHARAN','" & Session("namaPegawai") & "','" & Session("id_pegawai") & "','" & Right(Trim(arrBayarCol(4)), 3) & "','CEK ATAU TUNAI','" & CDec(arrBayarCol(8)) & "','" & arrBayarCol(9) & "')"
                        opClass1.InsertData(sqlTextkibfg1)
                    ...
                    If Not SQLReader.HasRows Then
                        ...
                        & "values('" & Trim(arrBayarCol(4)) & "','" & Trim(no_invois) & "','agent_receipt(rebat)','" & Trim(kod_agen.Text) & "','0','" & Right(Trim(arrBayarCol(4)), 3) & "')"
                    ...
                    If arrBayarCol(0) = "CEK" Or arrBayarCol(0) = "CEK / TUNAI" Then
                        ...
                        If arrBayarCol(0) = "CEK / TUNAI" Then
                            ...
                            baki_semasa_rebat = CDec(arrBayarCol(3)) - CDec(arrBayarCol(8))
                            txtTotalCajTunai = CDec(arrBayarCol(2))
                        End If

                        If arrBayarCol(0) = "CEK" Then
                            txtTotalCajKredit = CDec(arrBayarCol(6))
                            baki_semasa_rebat = CDec(arrBayarCol(6)) - CDec(arrBayarCol(8))
                        End If
                        ...
                        If Not SQLReader.HasRows Then
                            ...
                            transaksi_semasa = CDec(transaksi_semasa) + CDec(txtTotalCajKredit) - CDec(arrBayarCol(8))
                            ...
                            Baki_Semasa = Trim(CDec(Baki_Semasa)) - Trim(CDec(baki_semasa_rebat))
                ...
                Response.Write("<script languange=javascript>alert('Maklumat pembayaran CAJ telah disimpan.');self.location.href='frmAgenIKAN_kibfg.aspx?strVal=" & Trim(arrayValT.Value) & "&tarikh_send=" & Trim(TextBox2.Text) & "&Kod_Agen= " & Trim(kod_agen.Text) & "';</script>")
                Response.End()

            Else

                Response.Write("<script language = javascript>alert('Tiada pilihan dibuat untuk pembayaran.');self.location.href='frmAgenIKAN_kibfg.aspx';</script>")
                Response.End()
