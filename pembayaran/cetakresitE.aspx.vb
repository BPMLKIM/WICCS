...
#End Region
    ...
    Private Sub ConfigureCrystalReports()
        ...
        Dim rstbayar As String = "select no_barcode from pembayaran_caj_ikan_eksport where no_barcode = '" & Trim(Request("barcode")) & "'"
        ...
        If Request("print_status") = "Y" Then
            ...
            Dim gconSQL As String = "update pembayaran_caj_ikan_eksport set print_status='1' where no_barcode='" & Trim(Request("barcode")) & "'"
        ...
        'edited by kmz for caj eksport
        Dim reportPath As String = Server.MapPath("cetakrpt/eResitG1a.rpt")
        'end of edited by kmz for caj eksport
        ...
        If Request("printer_name") <> "" Then
            ...
            'edited by kmz for caj eksport
            Dim reportPath1 As String = Server.MapPath("cetakrpt/eResitG1aSalinan.rpt")
            'end of edited by kmz for caj eksport
        ...
        'selectFormula = "{no_siri_resit_lkim.bil_siri_resit} = '" & Trim(serial_no) & "' AND {ITEM_CAJ.Dicaj_Oleh} = 'LKIM' AND {ITEM_CAJ.Kod_Service_Caj} = 'Caj Perkhidmatan Ikan' AND {pembayaran_caj_ikan_eksport.siri_module}='individual_receipt'"
        'Else
