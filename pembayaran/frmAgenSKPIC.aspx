<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmAgenSKPIC.aspx.vb" Inherits="pembayaran_frmAgenSKPIC" %>
...
<head id="Head1" runat="server">
    <title>[WICCS]PEMBARAN AGEN IKAN</title>
...
{
var str ="<%=filetransfer%>?print_status=" + document.all.print_status.value + "&kod_agen=" + document.all.kod_agen.value + "&arrayValT=" + document.all.arrayVal.value + "&carabayar=kumpul";
...
{
var str ="<%=filetransfer%>?printer_name=" + document.all.printer_name.value + "&print_status=Y&kod_agen=" + document.all.kod_agen.value + "&arrayValT=" + document.all.arrayVal.value;
//var str ="http://quest2003/reportw-iccs/pembayaran/<%=filetransfer%>?printer_name=" + document.all.printer_name.value + "&print_status=" + document.all.print_status.value + "&kod_agen=" + document.all.kod_agen.value + "&arrayValT=" + document.all.arrayVal.value;
        ...
        <table  style="width: 90%">
            <tr>
                <td colspan="2" style="height: 18px; background-color: #6600ff">
                    &nbsp;&nbsp;&nbsp;<asp:Label ID="Label1" runat="server" Text="Pembayaran CAJ Borang SKPI Melalui Agen" Width="344px" Font-Bold="True" ForeColor="White"></asp:Label></td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="width: 257px; height: 24px;">
                    Tarikh</td>
                <td style="width: 612px; height: 24px;">
            ...
            <tr>
                ...
                <td style="width: 612px">
                    ...
                    #000000 1px ridge; FONT-FAMILY: MS Shell Dlg,verdana,??; BACKGROUND-COLOR: #f1f1f1;" /></td>
            </tr>
...
<asp:HiddenField ID="arrayVal" runat="server" />
        ...
        <table id="Table1" style="width: 90% ;">
            <tr style="width: 100% ; height: 18px; background-color:#6600ff;">
        ...
        <br />
        <input id="Button2" runat="server" onclick="self.location.href='verifikasi_bayar.aspx?type=ikan';"
            ...
            background-color: #f1f1f1" type="button" value="BARU" /><input id="cmdResit" runat="server"
                ...
                value="PAPAR RESIT" /><input id="Button7" runat="server" onclick="cetakReport();"
                    ...
                    padding-left: 1px; font-size: 10px; padding-bottom: 1px; border-left: #ffffff 1px ridge;
                    color: #000000; padding-top: 1px; border-bottom: #000000 1px ridge; font-family: MS Shell Dlg,verdana,??;
                    background-color: #f1f1f1" type="button" value="CETAK RESIT" /><input id="Button3" onclick="showSenaraiprinter();" style="border-right: #333333 1px ridge;
            ...
            type="button" value="PILIH PRINTER" /><br />
        <br />
        <br />
