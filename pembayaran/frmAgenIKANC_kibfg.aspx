<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmAgenIKANC_kibfg.aspx.vb" Inherits="pembayaran_frmAgenIKANC_kibfg" %>
...
<head id="Head1" runat="server">
    <title>[WICCS]PEMBAYARAN AGEN IKAN(REBAT)</title>
...
{
var str ="cetakResitA_kibfg.aspx?print_status=" + document.all.print_status.value + "&kod_agen=" + document.all.kod_agen.value + "&arrayValT=" + document.all.arrayVal.value;
...
{
var str ="cetakResitA_kibfg.aspx?printer_name=" + document.all.printer_name.value + "&print_status=Y&kod_agen=" + document.all.kod_agen.value + "&arrayValT=" + document.all.arrayVal.value;
    ...
    <div>
        ...
        <table  style="width: 90%">
            <tr>
                <td colspan="2" style="height: 18px; background-color: #6600ff">
                    &nbsp;&nbsp;&nbsp;<asp:Label ID="Label1" runat="server" Text="Cetak pembayaran CAJ Melalui Agen(REBAT) " Width="344px" Font-Bold="True" ForeColor="White"></asp:Label></td>
            </tr>
            <tr>
        ...
        <table id="Table1" style="width: 100% ;">
            <tr style="width: 100% ; background-color:#6600ff;">
                ...
                <td style="width: 4182px; height: 13px;">
                    <span style="color: #ffffff"><b>No Invois</b></span></td>
                <td style="width: 4680px; height: 13px;">
                    <span style="color: #ffffff"><strong>Caj Kotak Asal (RM)</strong></span></td>
                <td style="width: 2023px; height: 13px;">
                    <span style="color: #ffffff"><strong>Cara Pembayaran</strong></span></td>
                <td style="width: 4394px; height: 13px">
                ...
                <td style="width: 3547px; height: 13px">
