...
#End Region
    ...
    Private Sub ConfigureCrystalReports()
        ...
        For i = 0 To arrloop
            ...
            Dim sql11 As String = "select bil_siri_resit from no_siri_resit_nekad_eksport where no_barcode='" & Trim(arrBayarCol(0)) & "' and kod_agen = '" & Trim(Request("kod_agen")) & "'"
        ...
        selectFormula = "{ITEM_CAJ_EKSPORT.Kod_Service_Caj}= 'Caj Pengisytiharan (Borang SKPI) - CFC' AND {no_siri_resit_nekad_eksport.bil_siri_resit} = '" & Trim(serial_no) & "' AND {ITEM_CAJ_EKSPORT.Dicaj_Oleh} = 'CFC' AND {PEMBAYARAN_CAJ_SKPE.siri_module}='agent_receipt'"
