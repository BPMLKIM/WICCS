...
#End Region
    ...
    Private Sub ConfigureCrystalReports()
        ...
        Dim sqlserialno As String = "select bil_siri_resit from no_siri_resit_lkim where kod_agen = '" & Trim(Request("kod_agen")) & "' and day(edate)=day(getdate()) and month(edate)=month(getdate()) and year(edate)=year(getdate()) and siri_module='agent_receipt' and print_status='0'"
        ...
        selectFormula = "{no_siri_resit_lkim.bil_siri_resit} = '" & Trim(serial_no) & "' AND {ITEM_CAJ.Dicaj_Oleh} = 'LKIM' AND {ITEM_CAJ.Kod_Service_Caj}='Caj Perkhidmatan Ikan' and {no_siri_resit_lkim.siri_module} = 'agent_receipt'  "
