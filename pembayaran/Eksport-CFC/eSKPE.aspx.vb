...
Partial Class _Default
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Request("cetak") = "0" Then
            ...
            crMasterSheetEksport1.DataDefinition.FormulaFields("MS_Salinan").Text = "'SALINAN LKIM-BUKIT KAYU HITAM'"
            ...
            crMasterSheetEksport3.DataDefinition.FormulaFields("MS_Salinan").Text = "'SALINAN CFC'"
