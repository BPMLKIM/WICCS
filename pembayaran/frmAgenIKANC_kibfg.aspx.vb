...
Partial Class pembayaran_frmAgenIKANC_kibfg
    ...
    Public Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Page.IsPostBack Then
            ...
            If TextBox2.Text = "" Or kod_agen.Text = "" Then
                ...
                Response.Write("<script languange=javascript>alert('Sila masukkan tarikh dan kod agen');self.location.href='frmAgenIKANC_kibfg.aspx';</script>")
                Response.End()
            ...
            Dim strSQL1 As String = "select i.no_barcode,n.no_invois,sum(i.totalnilai) as totalnilai, j.cara_pembayaran,j.no_cek, sum(i.totalcajikan) as totalcajikan, sum(i.totalkurangcajikan) as totalkurangcajikan " _
            ...
            & " and i.status='A' and k.siri_module='agent_receipt(rebat)' and j.kod_service_caj='Caj Perkhidmatan Ikan(Kotak Insulasi)' and k.print_status=0" _
            ...
            If SQLReader.HasRows Then
                ...
                While SQLReader.Read()
                    ...
                    jumlahcajikansebenar = CDec(SQLReader("totalnilai")) - CDec(SQLReader("totalkurangcajikan"))

                    cajIkan1 = cajIkan1 & SQLReader("no_barcode") & "`" & SQLReader("no_invois") & "`" & (SQLReader("totalnilai")) & "`" & SQLReader("cara_pembayaran") & "`" & SQLReader("no_cek") & "`" & SQLReader("totalcajikan") & "`" & SQLReader("totalkurangcajikan") & "`" & (jumlahcajikansebenar) & "~"
